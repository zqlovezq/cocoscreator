...
for (var a = "function" == typeof __require && __require, n = 0; n < o.length; n++) c(o[n]);
return c;
}({
...
this.firstLayer.active = !1;
var t = cc.sys.localStorage.getItem("first");
this.canClickFristBtn = !1;
if (!t) {
cc.sys.localStorage.setItem("first", !0);
cc.Tools.showBanner();
this.scheduleOnce(function() {
e.firstLayer.scale = 0;
e.firstLayer.active = !0;
cc.tween(e.firstLayer).to(.5, {
scale: 1
}).delay(3).call(function() {
e.canClickFristBtn = !0;
}).start();
}, 1);
}
...
var i = cc.find("Canvas/Guide");
i.active = !1;
i.getChildByName("guide_0").active = !1;
i.getChildByName("guide_4").active = !1;
if ("over" !== cc.sys.localStorage.getItem("guide")) {
if (!cc.sys.localStorage.getItem("guide")) {
this.guide = !0;
i.active = !0;
i.getChildByName("guide_0").active = !0;
}
if ("4" === cc.sys.localStorage.getItem("guide")) {
this.guide = !1;
i.active = !0;
i.getChildByName("guide_4").active = !0;
}
}
this.getUserInfo();
this.sign_in_acti = 0;
...
var c = e.SignLayer.getChildByName("signBtn").getComponent(cc.Button);
e.signDay = t.data.day;
e.SignLayer.active = !0;
for (var a = 1; a <= 7; a++) {
var n = e.SignLayer.getChildByName("day_" + a), s = i[a - 1];
if (a === e.signDay) if (s.status) {
c.enableAutoGrayEffect = !0;
c.interactable = !1;
} else c.interactable = !0;
s.status ? e.completeBtn(n) : a === e.signDay ? e.selectBtn(n) : e.unSelectBtn(n);
}
});
},
...
if (cc.endCountTime) {
if (cc.endCountTime - cc.beginCountTime > 3e4) {
cc.Tools.showTableScreen();
cc.beginCountTime = cc.endCountTime;
}
} else cc.endCountTime = new Date().getTime();
cc.Tools.hideBanner();
...
var o = e.TurntableLayer.getChildByName("beginBtn").getComponent(cc.Button);
if (cc.zm.userInfo.sec < 0) {
o.enableAutoGrayEffect = !0;
o.interactable = !1;
e.countDownTime = Math.abs(cc.zm.userInfo.sec);
e.schedule(e.TurnTableCountDown, 1);
} else o.interactable = !0;
});
},
...
for (var o = t.data, c = [ "kai", "xin", "kuang", "gong" ], a = 0; a < 4; a++) {
var n = o[c[a]];
e.RedPoolLayer.getChildByName(c[a]).getComponent(cc.Label).string = "x" + n;
}
e.RedPoolLayer.getChildByName("count_1").getComponent(cc.Label).string = o.hour;
e.RedPoolLayer.getChildByName("count_2").getComponent(cc.Label).string = o.minute < 10 ? "0" + o.minute : o.minute;
});
},
...
if (e.signNumber !== o) {
for (var c = [], a = 0; a < i.length; a++) if (!i[a].status) {
e.signNumber = i[a].num;
break;
}
e.signNumber > o && (e.signNumber = o);
for (var n = 0; n < i.length; n++) e.signNumber === i[n].num && c.push(i[n]);
...
cc.Tools.dot("click", i);
var o = e.target;
o.complete ? cc.Tools.sendRequest("pit.v1.PitSvc/PullMission", "POST", {
id: o._id
}).then(function() {
...
console.log("cocos----打点数据", JSON.stringify(i));
cc.Tools.dot("cash_out", i);
...
cc.Tools.dot("click", i);
var o = t.data, c = o.gc || 0;
e.getMoneyStage = 0;
for (var a = [ .3, .5, 1, 2, 5, 10, 20 ], n = 0; n < o.items.Length; n++) if (o.items[n].times) {
e.getMoneyStage = a[n];
break;
}
...
o.parent.getChildByName("getLayer").active = !0;
}));
},
stopBGM: function(e) {
if (cc.zm.showMusic) {
...
!0 === this.SignLayer.active && this.showSignLayer();
if (!0 !== this.firstLayer.active || this.canClickFristBtn) {
...
cc.Tools.sendRequest("pit.v1.PitSvc/SignIn", "POST", t).then(function(t) {
var o = e.SignLayer.getChildByName("day_" + e.signDay);
e.completeBtn(o);
var c = t.data;
e.showPop([ "三元红包", "炸药x1", "药水x1", "500元宝", "8.88元红包", "时钟x1", "18.88元红包" ][e.signDay - 1], i["DAY_" + e.signDay], c.gc, c.card);
}).catch(function() {
...
cc.Tools.sendRequest("pit.v1.PitSvc/Lottery", "POST", o).then(function(t) {
e.endAngle = c["" + t.data.award];
...
e.showPop(c.name, c.index, o.gc, o.card);
}, 4.5);
});
}
},
...
if (i) {
n.active = !0;
n.getChildByName("lbl").getComponent(cc.Label).string = "获得元宝+" + i;
} else n.active = !1;
if (o) {
s.active = !0;
s.getChildByName("icon").getComponent(cc.Sprite).spriteFrame = this.TextFrames[o - 1];
} else s.active = !1;
},
...
return (i = 1073741824 & e) & (o = 1073741824 & t) ? 2147483648 ^ n ^ c ^ a : i | o ? 1073741824 & n ? 3221225472 ^ n ^ c ^ a : 1073741824 ^ n ^ c ^ a : n ^ c ^ a;
}
function c(e, t, i) {
return e & t | ~e & i;
}
...
e = o(e, o(o(c(t, a, n), s), l));
return o(i(e, r), t);
}
function l(e, t, c, n, s, r, l) {
e = o(e, o(o(a(t, c, n), s), l));
return o(i(e, r), t);
}
function d(e, t, c, a, s, r, l) {
e = o(e, o(o(n(t, c, a), s), l));
return o(i(e, r), t);
}
function h(e, t, c, a, n, r, l) {
e = o(e, o(o(s(t, c, a), n), l));
return o(i(e, r), t);
}
function u(e) {
for (var t, i = e.length, o = i + 8, c = 16 * ((o - o % 64) / 64 + 1), a = Array(c - 1), n = 0, s = 0; s < i; ) {
n = s % 4 * 8;
...
var i = cc.find("Canvas/Guide"), o = i.getChildByName("guide_1"), c = i.getChildByName("guide_2"), a = i.getChildByName("guide_3");
o.active = !1;
c.active = !1;
a.active = !1;
if ("2" === t) {
...
console.log("cocos---使用成功-", i[t[o].prop]);
});
}
...
e.node.addChild(c);
c.name = "tntBoom";
c.setPosition(cc.v2(o.x, o.y - 218));
i.boom = c;
}
});
if (this.levelInfo.mouse) {
var t = this.levelInfo.mouse.split(","), i = Number(t[0]);
...
var t = (this.itemArea.width - 30) / 2 * 2 * (Math.random() - .5), i = (this.itemArea.height - 30) / 2 * 2 * (Math.random() - .5), o = cc.v2(t, i), c = new cc.Rect(o.x - e.width / 2, o.y - e.height / 2, e.width, e.height);
...
if (i !== e) {
var o = e.getPosition(cc.v2()), c = new cc.Rect(o.x - 125, o.y - 125, 250, 250), a = i.getPosition(cc.v2());
if (c.contains(a)) {
i.removeFromParent();
i.destroy();
i = null;
...
for (var t = e.data.items, i = null, c = 0; c < t.length; c++) if (!t[c].status) {
i = t[c];
break;
}
o.string = "";
...
var c = i.getChildByName("award").getComponent(cc.Label);
...
cc.Tools.sendRequest("pit.v1.PitSvc/UserInfo", "GET", {}).then(function(t) {
cc.zm.userInfo = t.data;
if (cc.zm.userInfo.power > 0) cc.Tools.sendRequest("pit.v1.PitSvc/Stage", "GET", {}).then(function(t) {
cc.zm.LevelInfo = t.data;
if (cc.zm.LevelInfo.stage < 30) e.Reload(); else {
cc.Tools.hideBanner();
cc.endCountTime = new Date().getTime();
...
cc.Tools.sendRequest("pit.v1.PitSvc/Stage", "GET", {}).then(function(e) {
...
this.boomNumber--;
this.adjusBoomLayout();
var i = this.Hook.children[0].children[0], o = i.convertToWorldSpaceAR(cc.v2(0, 0)), c = cc.instantiate(this.Boom);
c.name = "boom";
this.node.addChild(c);
var a = cc.view.getVisibleSize();
c.setPosition(cc.v2(o.x - a.width / 2, o.y - a.height / 2));
c.active = !0;
...
jsb.reflection.callStaticMethod("org/cocos2dx/javascript/AppActivity", "dot", "(Ljava/lang/String;Ljava/lang/String;)V", e, JSON.stringify(t));
}
},
adCallBack: function() {
console.log("cocos----adCallBack");
console.log("cocos----getUserEcpm回调");
...
cc.Tools.sendRequest("pit.v1.PitSvc/PassAd", "POST", cc.zm.videoAd.redPack).then(function(e) {
...
} else if (cc.zm.videoAd.clickSign) {
console.log("cocos----签到接口");
cc.zm.videoAd.clickSign = !1;
} else if (cc.zm.videoAd.clickTable) {
console.log("cocos----转盘接口");
cc.zm.videoAd.clickTable = !1;
}
},
showJiliAd: function() {
...
console.log("cocos----请求ecpm参数", JOSN.stringify(t));
var i = cc.Tools.createSignData(t);
cc.Tools.sendRequest("pit.v1.PitSvc/Rc", "POST", i).then(function(e) {
...
console.log("cocos----data=", JSON.stringify(i));
...
if (cc.sys.isNative) if (cc.sys.localStorage.getItem("realName")) {
cc.beginCountTime = new Date().getTime();
cc.director.loadScene("Index");
} else this.showRealLayer(); else {
cc.beginCountTime = new Date().getTime();
cc.director.loadScene("Index");
}
}
...
cc.Tools.sendRequest("pit.v1/register", "POST", i).then(function(e) {
...
e.target;
var t = this.realNameLayer.getChildByName("edit1").getComponent(cc.EditBox).string, i = this.realNameLayer.getChildByName("edit2").getComponent(cc.EditBox).string;
console.log("cocos----真实姓名" + t + "------身份证号" + i);
if (this.regYourName(t) && this.regYourNumber(i)) {
