...
this.countDownTime > 0 || cc.Tools.showJiliAd();
},
...
ecpm: parseInt(e),
ts: new Date().getTime()
}, o = cc.Tools.createSignData(i);
cc.Tools.sendRequest("pit.v1.PitSvc/Rc", "POST", o).then(function(e) {
console.log("cocos----Ecpm成功", JSON.stringify(e.data));
cc.zm.ad = e.data.ad;
cc.zm.videoAd.redPack && (cc.zm.videoAd.redPack.ad = cc.zm.ad);
t();
});
});
}
