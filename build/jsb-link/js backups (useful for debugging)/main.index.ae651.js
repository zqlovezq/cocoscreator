...
var a = new XMLHttpRequest(), c = "https://pit.api.jiankangzhuan.com/" + e;
a.open(t, c, !0);
if (cc.sys.isNative) {
cc.log("isNative");
a.setRequestHeader("Accept-Encodeing", "gzip,deflate");
}
...
for (var o = 1; o <= 7; o++) {
var n = e.SignLayer.getChildByName("day_" + o);
i[o - 1].status ? e.completeBtn(n) : o === e.signDay ? e.selectBtn(n) : e.unSelectBtn(n);
}
});
},
...
for (var i = t.data, o = [ "kai", "xin", "kuang", "gong" ], n = 0; n < 4; n++) {
var a = i[o[n]];
e.RedPoolLayer.getChildByName(o[n]).getComponent(cc.Label).string = "x" + a;
}
...
for (var i = t.data.items, o = t.data.day, n = 0, a = [], c = 0; c < i.length; c++) if (!i[c].status) {
n = i[c].num;
break;
}
n > o && (n = o);
for (var r = 0; r < i.length; r++) n === i[r].num && a.push(i[r]);
e.SevenWorkLayer.getChildByName("title").getComponent(cc.Sprite).spriteFrame = e.SevenFrames[a[0].num - 1];
for (var s = e.SevenWorkLayer.getChildByName("layout"), d = 0; d < a.length; d++) {
var h = a[d], l = s.getChildByName("layout_" + (d + 1));
l.active = !0;
var u = l.getChildByName("getMoneyBtn");
u._id = h.id;
var m = u.getComponent(cc.Button);
if (1 === h.status) {
m.enableAutoGrayEffect = !0;
m.interactable = !1;
} else {
m.interactable = !0;
var g = !1;
h.curr_pass_stage >= h.need_pass_stage && h.curr_sign_in >= h.need_sign_in && h.curr_invite >= h.need_invite && (g = !0);
u.complete = !!g;
}
l.getChildByName("lbl1").getComponent(cc.Label).string = h.value;
l.getChildByName("lbl2").getComponent(cc.Label).string = "观看" + h.need_ad + "个视频";
l.getChildByName("progressBar").getComponent(cc.ProgressBar).progress = h.curr_ad / h.need_ad;
l.getChildByName("barLbl").getComponent(cc.Label).string = h.curr_ad + "/" + h.need_ad;
var v = l.getChildByName("layout"), f = v.getChildByName("item_0"), p = v.getChildByName("item_1"), y = v.getChildByName("item_2");
if (h.need_pass_stage) {
f.active = !0;
f.getChildByName("lbl").getComponent(cc.Label).string = "通过第" + h.need_pass_stage + "关";
f.getChildByName("icon").getChildByName("arrow").active = h.curr_pass_stage >= h.need_pass_stage;
} else f.active = !1;
if (h.need_sign_in) {
p.active = !0;
p.getChildByName("lbl").getComponent(cc.Label).string = "领取签到奖励";
p.getChildByName("icon").getChildByName("arrow").active = h.curr_sign_in >= h.need_sign_in;
} else p.active = !1;
if (h.need_invite) {
y.active = !0;
y.getChildByName("lbl").getComponent(cc.Label).string = "邀请" + h.need_invite + "个好友";
p.getChildByName("icon").getChildByName("arrow").active = h.curr_invite >= h.need_invite;
} else y.active = !1;
}
...
e.getMoneyStage = 0;
for (var n = [ .3, .5, 1, 2, 5, 10, 20 ], a = 0; a < i.items.Length; a++) if (i.items[a].times) {
e.getMoneyStage = n[a];
break;
}
...
e.completeBtn(i);
var n = t.data;
e.showPop([ "三元红包", "炸药x1", "药水x1", "500元宝", "8.88元红包", "时钟x1", "18.88元红包" ][e.signDay - 1], o["DAY_" + e.signDay], n.gc, n.card);
}).catch(function() {
e.showTips("今日奖励已领取");
});
},
...
e.showPop(n.name, n.index, i.gc, i.card);
}, 4.5);
});
}
},
...
var n = this.GetGoodLayer.getChildByName("layout"), a = this.GetGoodLayer.getChildByName("icon").getComponent(cc.Sprite);
this.GetGoodLayer.getChildByName("lbl").getComponent(cc.Label).string = "获得" + e;
a.spriteFrame = this.AwardFrames[t];
var c = n.getChildByName("layout_1"), r = n.getChildByName("layout_2");
if (i) {
c.active = !0;
...
return (i = 1073741824 & e) & (o = 1073741824 & t) ? 2147483648 ^ c ^ n ^ a : i | o ? 1073741824 & c ? 3221225472 ^ c ^ n ^ a : 1073741824 ^ c ^ n ^ a : c ^ n ^ a;
}
function n(e, t, i) {
return e & t | ~e & i;
}
...
function s(e, t, a, c, r, s, d) {
e = o(e, o(o(n(t, a, c), r), d));
return o(i(e, s), t);
}
function d(e, t, n, c, r, s, d) {
e = o(e, o(o(a(t, n, c), r), d));
return o(i(e, s), t);
}
function h(e, t, n, a, r, s, d) {
e = o(e, o(o(c(t, n, a), r), d));
return o(i(e, s), t);
}
function l(e, t, n, a, c, s, d) {
e = o(e, o(o(r(t, n, a), c), d));
return o(i(e, s), t);
}
function u(e) {
for (var t, i = e.length, o = i + 8, n = 16 * ((o - o % 64) / 64 + 1), a = Array(n - 1), c = 0, r = 0; r < i; ) {
c = r % 4 * 8;
a[t = (r - r % 4) / 4] = a[t] | e.charCodeAt(r) << c;
r++;
}
c = r % 4 * 8;
a[t = (r - r % 4) / 4] = a[t] | 128 << c;
a[n - 2] = i << 3;
a[n - 1] = i >>> 29;
return a;
}
...
var i = cc.find("Canvas/Guide"), o = i.getChildByName("guide_1"), n = i.getChildByName("guide_2"), a = i.getChildByName("guide_3");
o.active = !1;
n.active = !1;
a.active = !1;
if ("2" === t) {
...
var e = this;
a.sendRequest("pit.v1.PitSvc/Stage", "GET", {}).then(function(t) {
a.sendRequest("pit.v1.PitSvc/Prop", "POST", {
prop: 4
}).then(function() {
console.log("使用体力成功");
});
...
var n = [ 10, 11, 13 ][this.createRandm(0, 2)];
this.LotteryProp = n;
var a = this.LotteryLayer.getChildByName("icon").getComponent(cc.Sprite);
10 === n ? a.spriteFrame = this.LotteryFramse[2] : 11 === n ? a.spriteFrame = this.LotteryFramse[0] : 13 === n && (a.spriteFrame = this.LotteryFramse[1]);
}
},
...
a.sendRequest("pit.v1.PitSvc/Lottery2", "POST", t).then(function(t) {
...
a.sendRequest("pit.v1.PitSvc/Prop", "POST", n).then(function() {
...
i.setPosition(o);
if ("Tnt" === t.name) {
var n = cc.instantiate(e.Boom);
e.node.addChild(n);
n.name = "tntBoom";
n.setPosition(cc.v2(o.x, o.y - 218));
i.boom = n;
}
});
if (this.levelInfo.mouse) {
var i = this.levelInfo.mouse.split(","), o = Number(i[0]);
if (o > 0) for (var n = 0; n < o; n++) {
var a = cc.instantiate(this.Prefab.Mouse), c = (this.itemArea.width - 30) / 2 * 2 * (Math.random() - .5), r = (this.itemArea.height - 30) / 2 * 2 * (Math.random() - .5), s = cc.v2(c, r);
a.parent = this.itemArea;
a.score = 50;
a.setPosition(s);
this.moveMouse(a);
}
...
var t = (this.itemArea.width - 30) / 2 * 2 * (Math.random() - .5), i = (this.itemArea.height - 30) / 2 * 2 * (Math.random() - .5), o = cc.v2(t, i), n = new cc.Rect(o.x - e.width / 2, o.y - e.height / 2, e.width, e.height);
if (this.itemArea.children.length >= 1) {
for (var a = !1, c = 0; c < this.itemArea.children.length; c++) if (this.itemArea.children[c].getBoundingBox().intersects(n)) {
a = !0;
break;
}
return a ? this.randomXY(e) : o;
}
return o;
},
...
if (i !== e) {
var o = e.getPosition(cc.v2()), n = new cc.Rect(o.x - 125, o.y - 125, 250, 250), a = i.getPosition(cc.v2());
if (n.contains(a)) {
i.removeFromParent();
i.destroy();
i = null;
...
a.sendRequest("pit.v1.PitSvc/Missions", "GET", r).then(function(e) {
for (var t = e.data.items, i = null, n = 0; n < t.length; n++) if (!t[n].status) {
i = t[n];
break;
}
o.string = "";
...
var n = i.getChildByName("award").getComponent(cc.Label);
n.string = "奖励红包+" + this.redPack;
cc.zm.LevelInfo.ever_pass && (n.node.active = !1);
...
a.sendRequest("pit.v1.PitSvc/Pass", "POST", s).then(function(e) {
...
case 1:
a.sendRequest("pit.v1.PitSvc/UserInfo", "GET", {}).then(function(t) {
cc.zm.userInfo = t.data;
cc.zm.userInfo.power > 0 ? a.sendRequest("pit.v1.PitSvc/Stage", "GET", {}).then(function(t) {
cc.zm.LevelInfo = t.data;
...
var e = this;
console.log("看视频得奖励");
var t = cc.zm.LevelInfo.ever_pass ? 0 : this.redPack, i = {
red_pack: parseInt(100 * (t + this.extarRedPack)),
ad: cc.zm.ad
};
a.sendRequest("pit.v1.PitSvc/PassAd", "POST", i).then(function(t) {
console.log("PassAd返回信息", t);
a.sendRequest("pit.v1.PitSvc/UserInfo", "GET", {}).then(function(t) {
cc.zm.userInfo = t.data;
cc.zm.userInfo.power > 0 ? a.sendRequest("pit.v1.PitSvc/Stage", "GET", {}).then(function(t) {
cc.zm.LevelInfo = t.data;
...
var t = this, i = e.target, o = {
ad: cc.zm.ad
};
a.sendRequest("pit.v1.PitSvc/GrowPower", "POST", o).then(function() {
i.parent.active = !1;
t.Reload();
});
},
...
this.boomNumber--;
this.adjusBoomLayout();
var i = this.Hook.children[0].children[0], o = i.convertToWorldSpaceAR(cc.v2(0, 0)), n = cc.instantiate(this.Boom);
n.name = "boom";
this.node.addChild(n);
var c = cc.view.getVisibleSize();
n.setPosition(cc.v2(o.x - c.width / 2, o.y - c.height / 2));
n.active = !0;
n.getComponent(cc.Animation).play("boom");
i.destroy();
i = null;
this.speed = 10;
a.sendRequest("pit.v1.PitSvc/Prop", "POST", {
