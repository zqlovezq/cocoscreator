...
var f = l.getChildByName("layout"), v = f.getChildByName("item_0"), p = f.getChildByName("item_1"), y = f.getChildByName("item_2");
if (h.need_pass_stage) {
v.active = !0;
v.getChildByName("lbl").getComponent(cc.Label).string = "通过第" + h.need_pass_stage + "关";
v.getChildByName("icon").getChildByName("arrow").active = h.curr_pass_stage >= h.need_pass_stage;
} else v.active = !1;
if (h.need_sign_in) {
p.active = !0;
