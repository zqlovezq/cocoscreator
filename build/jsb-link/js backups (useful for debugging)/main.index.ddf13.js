...
for (var i = 0, o = t.data.items, n = 0; n < o.length; n++) {
var a = o[n];
if (a.status) {
i = a.day;
break;
...
c <= i ? e.completeBtn(r) : c === i + 1 ? e.selectBtn(r) : e.unSelectBtn(r);
}
});
},
...
for (var i = t.data.items, o = 0, n = [], a = 0; a < i.length; a++) if (!i[a].status) {
o = i[a].num;
break;
}
for (var c = 0; c < i.length; c++) o === i[c].num && n.push(i[c]);
e.SevenWorkLayer.getChildByName("title").getComponent(cc.Sprite).spriteFrame = e.SevenFrames[n[0].num - 1];
for (var r = e.SevenWorkLayer.getChildByName("layout"), s = 0; s < n.length; s++) {
var d = n[s], h = r.getChildByName("layout_" + (s + 1));
h.active = !0;
...
var g = h.getChildByName("layout");
if (d.need_pass_stage) {
var f = g.getChildByName("item_0");
f.active = !0;
f.getChildByName("lbl").getComponent(cc.Label).string = "通过第" + d.need_pass_stage + "关";
f.getChildByName("icon").getChildByName("arrow").active = d.curr_pass_stage >= d.need_pass_stage;
}
if (d.need_sign_in) {
var v = g.getChildByName("item_1");
v.active = !0;
v.getChildByName("lbl").getComponent(cc.Label).string = "领取签到奖励";
v.getChildByName("icon").getChildByName("arrow").active = d.curr_sign_in >= d.need_sign_in;
}
if (d.need_invite) {
var p = g.getChildByName("item_2");
p.active = !0;
...
a.sendRequest("pit.v1.PitSvc/Missions", "GET", c).then(function(e) {
...
var n = i.getChildByName("layout").getChildByName("extraAward").getComponent(cc.Label);
if (this.extarRedPack) {
n.node.parent.active = !0;
n.string = "+" + this.extarRedPack;
...
a.sendRequest("pit.v1.PitSvc/Pass", "POST", r).then(function(e) {
...
a.sendRequest("pit.v1.PitSvc/PassAd", "POST", t).then(function(t) {
