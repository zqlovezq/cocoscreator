...
var projectPath = path.join(__dirname,"../" +startPath)// +"/assets"
var versionPath = path.join(__dirname,channel+"/versions/"+version)

if (!fs.existsSync(projectPath + "/assets")) {
  console.log("没有资源文件 /jsb-default/assets",projectPath)
...
var dirList = ["/assets","/jsb-adapter","/src"]
...
delFile(updatePath + "/2_new/jsb-adapter/")
