(function () {
    if (typeof window.jsb === 'object') {
		//先读一次配置，如果apk内版本大于更新目录版本，在loadLocalManifest中会触发删除更新目录
		new jsb.AssetsManager("assets/project.manifest", (jsb.fileUtils ? jsb.fileUtils.getWritablePath() : '/') + "update")
		//设置搜索路径
