...
console.log("cocos user info " + e.userInfo);
...
console.log("wxLoginResultcode=" + e);
cc.wxLoginResultcode = e;
},
getUserEcpm: function(e) {
if (cc.zm) {
console.log("调用ecpm=", e);
...
console.log("Ecpm成功", e.data);
cc.zm.ad = e.data.ad;
t();
}).catch(function(e) {
console.log("Ecpm失败", e);
i(e);
});
});
}
...
console.log("http res:" + a.response);
