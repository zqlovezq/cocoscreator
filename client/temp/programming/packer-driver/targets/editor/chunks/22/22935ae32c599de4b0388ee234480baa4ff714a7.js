    ...
    execute: function () {
      ...
      _export("ItemInfoPop", ItemInfoPop = (_dec = ccclass('ItemInfoPop'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(_crd && CommonItem === void 0 ? (_reportPossibleCrUseOfCommonItem({
        ...
        onShow() {
          ...
          const count = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
        ...
        showMaterialTip() {
          ...
          if (itemData.BagType === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const boxTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        createRdmPiece(isAutoBoxDropId, isSelfSelectBox) {
          ...
          if (isAutoBoxDropId) {
            ...
            const list = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
              error: Error()
          ...
          for (let i = 0; i < heroList.length; i++) {
            const itemTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().HeroTableById.getValue(heroList[i]);
            let itemTs = null;

            if (itemTab) {
              const info = new (_crd && HeroInfo === void 0 ? (_reportPossibleCrUseOfHeroInfo({
                error: Error()
              }), HeroInfo) : HeroInfo)();
              info.itemId = heroList[i];
              info.id = 0;
              info.star = itemTab.DefaultStar;
              const itemNode = (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
                error: Error()
              }), ItemPoolMgr) : ItemPoolMgr).ins.createHeroItem(info, this.node_list_content);
              ...
              const itemNode = (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
                error: Error()
              }), ItemPoolMgr) : ItemPoolMgr).ins.createItem(info, this.node_list_content);
              itemTs = itemNode.getComponent(_crd && CommonItem === void 0 ? (_reportPossibleCrUseOfCommonItem({
                error: Error()
              }), CommonItem) : CommonItem);
            }

            if (this._isBag && itemData.Type === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).ItemType.ItemType_ChoiceBox) {
        ...
        onDisable() {
          ...
          if (this.comItems) {
            for (let key in this.comItems) {
              (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
                error: Error()
              }), ItemPoolMgr) : ItemPoolMgr).ins.putCommonItem(this.comItems[key]);
            }
          }
          ...
          if (this.bookComItems) {
            for (let key in this.bookComItems) {
              (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
                error: Error()
              }), ItemPoolMgr) : ItemPoolMgr).ins.putBookItme(this.bookComItems[key]);
            }
          }
        } // add碎片
