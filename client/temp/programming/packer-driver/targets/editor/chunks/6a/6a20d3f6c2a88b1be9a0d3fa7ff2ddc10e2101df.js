        ...
        initGroupView() {
          if (!this.groupItems) {
            ...
            groupMap.forEach(value => {
              ...
              let com = item.getComponent(_crd && RareBookGroupItem === void 0 ? (_reportPossibleCrUseOfRareBookGroupItem({
                error: Error()
          ...
          if (this.groupNode.active) {
            let redKey = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
              error: Error()
