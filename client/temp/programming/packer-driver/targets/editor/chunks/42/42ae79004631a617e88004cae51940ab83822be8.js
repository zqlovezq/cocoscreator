System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, instantiate, Label, Node, Prefab, ViewPop, RareBookSmallItem, HeroStar, RareBookData, LangMgr, RareBookStarUpItem, HeroSkillItem, tab, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _dec9, _dec10, _dec11, _dec12, _dec13, _dec14, _dec15, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _descriptor7, _descriptor8, _descriptor9, _descriptor10, _descriptor11, _descriptor12, _descriptor13, _descriptor14, _crd, ccclass, property, StarUpPop;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "6eaf1ieyE9BpLwiqNl95LNp", "RareBookStarUpPop", undefined);
      ...
      _export("StarUpPop", StarUpPop = (_dec = ccclass('StarUpPop'), _dec2 = property(Node), _dec3 = property(_crd && RareBookSmallItem === void 0 ? (_reportPossibleCrUseOfRareBookSmallItem({
        ...
        error: Error()
      }), HeroSkillItem) : HeroSkillItem), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Node), _dec15 = property(Node), _dec(_class = (_class2 = class StarUpPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        error: Error()
      }), ViewPop) : ViewPop) {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "lbl_last_level", _descriptor11, this);

          _initializerDefineProperty(this, "lbl_next_level", _descriptor12, this);

          _initializerDefineProperty(this, "node_star_up", _descriptor13, this);

          _initializerDefineProperty(this, "node_awake_up", _descriptor14, this);
        ...
        initBook() {
          ...
          let lastTab = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
          ...
          this.effectLab.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
            error: Error()
          }), LangMgr) : LangMgr).ins.getLab(lastTab.Description);
        ...
        initHero() {
          ...
          const starUpTab = this.heroInfo.heroStarUpTable;
          ...
          this.lbl_desc.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
            error: Error()
          }), LangMgr) : LangMgr).ins.getLab(starUpTab.StarDesc);
          const lastStarUpTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          this.node_awake_up.active = starUpTab.DescType === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).HeroStarDescType.HeroStarDescType_Third;
          this.node_star_up.active = starUpTab.DescType === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
      ...
      }), _descriptor11 = _applyDecoratedDescriptor(_class2.prototype, "lbl_last_level", [_dec12], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor12 = _applyDecoratedDescriptor(_class2.prototype, "lbl_next_level", [_dec13], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor13 = _applyDecoratedDescriptor(_class2.prototype, "node_star_up", [_dec14], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor14 = _applyDecoratedDescriptor(_class2.prototype, "node_awake_up", [_dec15], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=42ae79004631a617e88004cae51940ab83822be8.js.map