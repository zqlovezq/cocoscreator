  ...
  return {
    ...
    execute: function () {
      ...
      (function (_ViewSize) {
        ...
        _ViewSize.init = init;
        const frameSize = _ViewSize.frameSize = new Size(1280, 720);
        const hirdSize = _ViewSize.hirdSize = new Size(frameSize.width * 0.8, frameSize.height * 0.8);
        const halfSize = _ViewSize.halfSize = new Size(frameSize.width * 0.5, frameSize.height * 0.5);
        const halfFrameSize = _ViewSize.halfFrameSize = new Size(frameSize.width * 0.5, frameSize.height * 0.5);
