          ...
          if (table) {
            ...
            if (state == 2) {
              ...
              (_crd && createAnimation === void 0 ? (_reportPossibleCrUseOfcreateAnimation({
                error: Error()
              }), createAnimation) : createAnimation)(this.bossSp.node, tempTab.Id, 0);
              (_crd && setGraySpine === void 0 ? (_reportPossibleCrUseOfsetGraySpine({
                error: Error()
              }), setGraySpine) : setGraySpine)(this.bossSp, true);
            } else {
              this.bgSprite.grayscale = false;
              this.bossSp.setAnimation(0, tempTab.AnimationName, true);
              (_crd && setGraySpine === void 0 ? (_reportPossibleCrUseOfsetGraySpine({
                error: Error()
              }), setGraySpine) : setGraySpine)(this.bossSp, false);
            }
          } else {
            //敬请期待
