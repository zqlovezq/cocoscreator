    ...
    execute: function () {
      ...
      _export("RareBookControl", RareBookControl = (_dec = ccclass('RareBookControl'), _dec(_class = (_class2 = class RareBookControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        on_red_Tujian_Weapon_Job_Archer() {
          let table = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
        ...
        on_red_Book_Equip() {
          ...
          let allSlots = Array.from((_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
          ...
          for (let k in allSlots) {
            ...
            for (let key in slots) {
              if (!stateToChange[slots[key].bookSlotTable.Class] && !slots[key].bookInfo && slots[key].isLock) {
                let isHave = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
                  error: Error()
        ...
        on_red_Weapon_recovery() {
          ...
          let canExchangItems = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
