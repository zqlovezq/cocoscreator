      ...
      _export("ComicControl", ComicControl = (_dec = ccclass('ComicControl'), _dec(_class = (_class2 = class ComicControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        getComicCondition(stageId) {
          ...
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const comicTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        async addComic(id, parenNode, cb) {
        ...
        playAnim() {
          ...
          this.waitEnd = null;
          this.comicCanTouch = true;
          const comic_anim_node = this.comicNode.getChildByName(this.comicData.NodeName[this.comicIndex]); // 动画名字

          const comic_anim_name = this.comicData.AnimationName[this.comicIndex];
          const anim = comic_anim_node.getComponent(Animation);
