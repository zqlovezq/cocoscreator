    ...
    execute: function () {
      ...
      _export("RareBookData", RareBookData = (_dec = ccclass('RareBookData'), _dec(_class = (_class2 = class RareBookData {
        ...
        initBookData() {
          ...
          let data = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          }), RoleData) : RoleData).ins.book;
          log("武器==", data);
          this.powerScore = data.powerScore;
          let list = data.equipList;
          let maxStarMap = new Map();
          let starTabs = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          for (let key in list) {
            let info = new (_crd && RareBookInfo === void 0 ? (_reportPossibleCrUseOfRareBookInfo({
              error: Error()
          ...
          for (let value of tabs) {
            if (value.Id == value.GroupId) for (let itemId of value.BookId) {
          ...
          for (let key in seriesData) {
            let info = new (_crd && RareBookSerieInfo === void 0 ? (_reportPossibleCrUseOfRareBookSerieInfo({
              error: Error()
        ...
        initContainerMap() {
          ...
          let bookSlots = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          for (let key in bookSlots) {
            ...
            let info = new (_crd && RareBookSlotInfo === void 0 ? (_reportPossibleCrUseOfRareBookSlotInfo({
              error: Error()
          ...
          let container = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
        ...
        updateSlotInfo(bookId, slotIndex, isWear = true) {
        ...
        updateBookCollectRedPoint() {
          ...
          this.bookSerieInfoMap.forEach(value => {
            let seriesTable = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            ...
            if (seriesTable) {
              ...
              if (seriesTable.BookId.length == value.count) {
                ...
                let isRecord = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
                  error: Error()
