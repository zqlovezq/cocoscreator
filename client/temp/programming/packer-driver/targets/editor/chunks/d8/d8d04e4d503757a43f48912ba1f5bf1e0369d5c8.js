    ...
    execute: function () {
      ...
      _export("FightWeaponTeam", FightWeaponTeam = (_dec = ccclass('FightWeaponTeam'), _dec2 = property(Node), _dec(_class = (_class2 = class FightWeaponTeam extends Component {
        ...
        refresh(isTouch = false) {
          let list = (_crd && RogueControl === void 0 ? (_reportPossibleCrUseOfRogueControl({
            error: Error()
        ...
        setBooks(books, prestigeLevel) {
          ...
          let _fincaFightTeamTab = (_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
            error: Error()
        ...
        setRogueIds(rogues) {
          for (let index = 0; index < this.items.length; index++) {
            ...
            let rogueTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
