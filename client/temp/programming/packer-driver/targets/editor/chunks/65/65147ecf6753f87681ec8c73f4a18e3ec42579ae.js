    ...
    execute: function () {
      ...
      _export("RecruitView", RecruitView = (_dec = ccclass('RecruitView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(RichText), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(sp.Skeleton), _dec11 = property(sp.Skeleton), _dec12 = property(sp.Skeleton), _dec13 = property(Label), _dec14 = property(Node), _dec15 = property(Label), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Label), _dec(_class = (_class2 = class RecruitView extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        setRecruitMap() {
          ...
          const heros = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
            error: Error()
        ...
        onShow() {
          ...
          const node_toggle = this.node_toggle_type.getChildByName("Toggle" + this._curRecruitType).getComponent(Toggle);
          ...
          if (this.node_limit.active) {
            ...
            const actInfo = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
              error: Error()
        ...
        asyncView() {
          const seniorVoucher = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          }), ItemData) : ItemData).ins.getCount(51); // 英雄凭证

          const heroVoucher = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          ...
          const type_friend = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AdType.AdType_Gacha301;
          const friend_adv_cur_count = (_crd && AdMgr === void 0 ? (_reportPossibleCrUseOfAdMgr({
            error: Error()
          }), AdMgr) : AdMgr).ins.getAdCountByType(type_friend);
          const friend_adv_max_count = (_crd && AdMgr === void 0 ? (_reportPossibleCrUseOfAdMgr({
            error: Error()
          ...
          const type_senior = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AdType.AdType_Gacha101;
          const senior_adv_cur_count = (_crd && AdMgr === void 0 ? (_reportPossibleCrUseOfAdMgr({
            error: Error()
          }), AdMgr) : AdMgr).ins.getAdCountByType(type_senior);
          const senior_adv_max_count = (_crd && AdMgr === void 0 ? (_reportPossibleCrUseOfAdMgr({
            error: Error()
        ...
        sendSeniorAdvWatch() {
          const type = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AdType.AdType_Gacha101;
        ...
        sendGacha(id, isAdv = false) {
          ...
          if (!isAdv && itemCount < count) {
            let canSendMsg = (_crd && gachaReplace === void 0 ? (_reportPossibleCrUseOfgachaReplace({
              error: Error()
        ...
        unClickToggle() {
          for (let i = 1; i <= 3; i++) {
            const node_toggle = this.node_toggle_type.getChildByName("Toggle" + i).getComponent(Toggle);
