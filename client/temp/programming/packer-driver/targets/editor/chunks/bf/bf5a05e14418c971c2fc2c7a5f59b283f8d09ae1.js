    ...
    execute: function () {
      ...
      _export("FightUIView", FightUIView = (_dec = ccclass('FightUIView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec5 = property(_crd && FightBossBar === void 0 ? (_reportPossibleCrUseOfFightBossBar({
        ...
        onLoad() {
          ...
          let isCheckedAudo = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
          }), Func) : Func).getItem("isCheckedAudo"));
          let open = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
            error: Error()
          ...
          if (open) {
            let isAudoRed = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
              error: Error()
        ...
        updateTime() {
          if ((_crd && FightRootControl === void 0 ? (_reportPossibleCrUseOfFightRootControl({
            ...
            let nowTime = (_crd && WaveTimeControl === void 0 ? (_reportPossibleCrUseOfWaveTimeControl({
              error: Error()
            }), WaveTimeControl) : WaveTimeControl).ins.nowTotalTime;
            let totalTime = (_crd && WaveTimeControl === void 0 ? (_reportPossibleCrUseOfWaveTimeControl({
              error: Error()
        ...
        checkFightSpeedRedPoint() {
          let red = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
