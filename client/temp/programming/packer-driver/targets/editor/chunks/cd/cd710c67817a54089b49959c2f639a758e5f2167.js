    ...
    execute: function () {
      ...
      _export("HeroDetailView", HeroDetailView = (_dec = ccclass('HeroDetailView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Node), _dec19 = property(Node), _dec20 = property(Node), _dec21 = property(Node), _dec22 = property(Node), _dec23 = property(Node), _dec24 = property(Node), _dec25 = property(Prefab), _dec26 = property(Prefab), _dec27 = property(Prefab), _dec28 = property(Prefab), _dec29 = property(Label), _dec30 = property(Label), _dec31 = property(Label), _dec32 = property(Label), _dec33 = property(Label), _dec34 = property(Label), _dec35 = property(Label), _dec36 = property(Label), _dec37 = property(_crd && HeroSkillItem === void 0 ? (_reportPossibleCrUseOfHeroSkillItem({
        ...
        showHeroAttr() {
          ...
          let attr = [(_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          let attrTotal = [(_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          for (let i = 0; i < attr.length; i++) {
            ...
            const value = (_this$_heroAllAttr$ge = this._heroAllAttr.getAttr(attrTotal[i])) != null ? _this$_heroAllAttr$ge : this._heroAllAttr.getAttr(attr[i]); // const value = this._heroAllAttr.attr[Number(attrTotal[i])]?this._heroAllAttr.attr[Number(attrTotal[i])]:0
        ...
        showHeroUpStar() {
          ...
          if (nextStarUpTab) {
            ...
            let nextStarHeroInfo = new (_crd && HeroInfo === void 0 ? (_reportPossibleCrUseOfHeroInfo({
              error: Error()
            }), HeroInfo) : HeroInfo)();
            ...
            for (let index = 0; index < nextStarUpTab.DescType.length; index++) {
              ...
              descLab.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
                error: Error()
              }), LangMgr) : LangMgr).getLab(nextStarUpTab.StarDesc[index]);
              nameLab.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
                error: Error()
              }), LangMgr) : LangMgr).getLab(nextStarUpTab.StarName[index]);
            }
        ...
        showStarUpMaterial() {
          ...
          let starUpSteps = starTab.NeedStarSteps; // console.log(`cocos starUpSteps length=${starUpSteps.length}---完成步数=${this._heroInfo.getFinishStep()}`)
          ...
          if (starUpSteps.length > 0 && this._heroInfo.getFinishStep() < 4) {
            ...
            let itemTs = heroItem.getComponent(_crd && HeroItem === void 0 ? (_reportPossibleCrUseOfHeroItem({
              error: Error()
            }), HeroItem) : HeroItem);
          ...
          if (map.size === 0) {
            ...
            if (material.resonanceLimit) {
              ...
              let levelUpData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).getData().HeroLevelUpTableByLevel.getValue(level);
              this.node_stuff_level_layout.active = false;
        ...
        */
        ...
        checkEquipGuide() {
          ...
          if (!(_crd && GuideController === void 0 ? (_reportPossibleCrUseOfGuideController({
            ...
            const isEquipGuide = Boolean((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
            }), RoleData) : RoleData).ins.clientData.equipGuildOver);
            const isOpenEquip = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
              error: Error()
            }), OpenFunctionMgr) : OpenFunctionMgr).ins.checkFunctionIsOpen((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).OpenFunctionName.OpenFunctionName_Equipment);
            const isNewEquip = (_crd && HeroRed === void 0 ? (_reportPossibleCrUseOfHeroRed({
              error: Error()
        ...
        checkJadeGuide() {
          if (!(_crd && GuideController === void 0 ? (_reportPossibleCrUseOfGuideController({
            ...
            const isJadeGuide = Boolean((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
            }), RoleData) : RoleData).ins.clientData.jadeGuildOver);
            const isOpenJade = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
              error: Error()
            }), OpenFunctionMgr) : OpenFunctionMgr).ins.checkFunctionIsOpen((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).OpenFunctionName.OpenFunctionName_Jade);
            let list = (_crd && EquipData === void 0 ? (_reportPossibleCrUseOfEquipData({
              error: Error()
