      ...
      _export("BattlePassItem", BattlePassItem = (_dec = ccclass('BattlePassItem'), _dec2 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        refreshToggleRed() {
          if (this.node_toggle_child_content && this.node_toggle_child_content.children.length > 0) {
            for (let i = 0; i < this.node_toggle_child_content.children.length; i++) {
              ...
              const toggleItemTs = item.getComponent(_crd && BattlePassChildToggleItem === void 0 ? (_reportPossibleCrUseOfBattlePassChildToggleItem({
                error: Error()
        ...
        createToggleItem() {
          ...
          for (let i = 0; i < viewData.length; i++) {
            ...
            const toggleItemTs = toggleItem.getComponent(_crd && BattlePassChildToggleItem === void 0 ? (_reportPossibleCrUseOfBattlePassChildToggleItem({
              error: Error()
            }), BattlePassChildToggleItem) : BattlePassChildToggleItem);
        ...
        refreshView() {
          ...
          const battlePassTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        refreshProgress() {
          ...
          if (lv > 0) {
            ...
            const taskTab1 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().TaskTableById.getValue(tab1);
            const taskTab2 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            ...
            const _taskTab1 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        onClickBuyBattlePassLv() {
          ...
          if (Number(lvLbl.string) >= battlePassTab.TaskIds.length) {
            const tips = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
              error: Error()
