      ...
      _export("MallMainView", MallMainView = (_dec = ccclass('MallMainView'), _dec2 = property(Prefab), _dec3 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        createShopBaseData() {
          ...
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const mallName = mallTab.MallId; // 创建职业 遣散信息
        ...
        groupListData(type, mallName) {
          const splitCount = this._view_type === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const _mallTabData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().MallTable[i];
          ...
          const result = [];
          let listData = this.getMallItemTabByType(mallName ? mallName : mallTab.MallId); // 如果当前是每日商店 排序买了的排在后面
          ...
          for (let i = 0; i < listData.length; i += splitCount) {
            if (this._view_type === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).MallTab.MallTab_Tab5 && listData[i].ViewSpecial && !(_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
              error: Error()
        ...
        refreshExtraData() {
          ...
          if (this._view_type === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            // 上次免费刷新时间
            const freeRefreshTime = this._daily_shop_data.lastFreeRefreshTime; // 判断是否有倒计时
        ...
        getDailyCountdown() {
          ...
          const maxTime = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        clickDailyRefresh() {
          ...
          const diamond = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
        ...
        getDailyShopData() {
          // 免费刷新次数
          const freeRefreshTimes = this._daily_shop_data.freeRefreshTimes; // 付费刷新次数

          const notFreeRefreshTimes = this._daily_shop_data.notFreeRefreshTimes; // 最大免费刷新次数

          const maxFreeRefreshTimes = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().GetKeyValue_ConfigTable().DailyShopFreeRefreshCount; // 最大付费刷新次数

          const maxNoFreeRefreshTimes = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          const DailyShopBuyCostDiamonds = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        onClickBuyDailyShop() {
          ...
          for (let i = 0; i < this._daily_shop_data.slots.length; i++) {
            ...
            if (!slot.isBought) {
              ...
              const _dailyShopData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
