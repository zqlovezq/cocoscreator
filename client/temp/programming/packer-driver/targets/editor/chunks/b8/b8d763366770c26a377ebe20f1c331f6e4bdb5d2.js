    ...
    execute: function () {
      ...
      _export("HeroControl", HeroControl = class HeroControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        requestHeros() {
          ...
          // 功能开启信息
          let func_msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          let stage_msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          let bag_msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          let daily_msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          let explore_msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          const isGuildOpen = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
            error: Error()
          ...
          if (isGuildOpen) {
            let guild_msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
              error: Error()
        ...
        on_s2c_ChangedScrollPaintingPush(msg) {
          if ((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            ...
            for (let i = 0; i < (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              ...
              const painting = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                error: Error()
        ...
        SceneLoadFunc(sceneName) {
          if (!(_crd && GuideController === void 0 ? (_reportPossibleCrUseOfGuideController({
            ...
            const achieveCondition = (_crd && ComicControl === void 0 ? (_reportPossibleCrUseOfComicControl({
              error: Error()
