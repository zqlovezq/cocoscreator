    ...
    execute: function () {
      ...
      _export("RogueControl", RogueControl = (_dec = ccclass('RogueControl'), _dec(_class = (_class2 = class RogueControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        onFight_Start() {
          ...
          let ids = this.getRogueIdsByGroupId((_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
            error: Error()
          ...
          for (let index = 0; index < ids.length; index++) {
            let id = ids[index];
            let info = new (_crd && RogueInfo === void 0 ? (_reportPossibleCrUseOfRogueInfo({
              error: Error()
          ...
          for (let i = 0; i < heros.length; i++) {
            ...
            let heroStarTab = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
              error: Error()
        ...
        getList(isSelfRefresh = false) {
          let dropId = (_crd && DropControl === void 0 ? (_reportPossibleCrUseOfDropControl({
            error: Error()
          }), DropControl) : DropControl).ins.getFirstDrop();
          let dropItemTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        getHeros() {
          ...
          let heroList = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
            error: Error()
        ...
        getWeapens(isSelfRefresh = false) {
          let selt = {
          ...
          if ((_crd && GuideController === void 0 ? (_reportPossibleCrUseOfGuideController({
            ...
            if ((_crd && GuideController === void 0 ? (_reportPossibleCrUseOfGuideController({
              ...
              const ids = (_crd && guideTask === void 0 ? (_reportPossibleCrUseOfguideTask({
                error: Error()
        ...
        getRandomIndexes(total, findNum) {
          ...
          while (indexes.length < findNum) {
            const randomIndex = (_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
              error: Error()
        ...
        checkFull(dropId) {
          ...
          if ((_crd && DropControl === void 0 ? (_reportPossibleCrUseOfDropControl({
            ...
            let eggsLen = (_crd && DropControl === void 0 ? (_reportPossibleCrUseOfDropControl({
              error: Error()
            }), DropControl) : DropControl).ins.getLenByType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).VirtualItemType.VirtualItemType_Eggs);
            let heroLen = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
              error: Error()
        ...
        getRefreshRogueTotalTime() {
          let num = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
