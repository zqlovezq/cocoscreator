    ...
    execute: function () {
      ...
      _export("SearchEnemy", SearchEnemy = (_dec = ccclass('SearchEnemy'), _dec(_class = class SearchEnemy {
          ...
          switch (effectUnit) {
            case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (typeof objId == "number") {
                let absRole = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
                  error: Error()
            ...
            case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              let list = this.getAll(objId, ownerObjType, (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).EffectUnit.EffectUnit_Friend);
        ...
        static getBySearchEnemy(ownerObjId, ownerObjType, startPos, effectUnit, _type, ignore, includeNoActive) {
          ...
          let funcName = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
