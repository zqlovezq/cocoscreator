    ...
    execute: function () {
      ...
      ChannelManager = class ChannelManager {
        ...
        */
        ...
        getAppType() {
          let code = (_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
            error: Error()
        ...
        */
        ...
        getAppVersionName() {
          ...
          let v = (_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
            error: Error()
        ...
        */
        ...
        initOnLineVersion(callback) {
          ...
          let doGet = () => {
            ...
            let reqParam = `ch=${this.channelType}&ver=${(_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
              error: Error()
        ...
        exitGame(isSdk = false, param = null) {
          if (isSdk) {
            if (this.channel) {
        ...
        postEvent(eventName, params = null) {
