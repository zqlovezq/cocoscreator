      ...
      _export("AssociationGiftPop", AssociationGiftPop = (_dec = ccclass('AssociationGiftPop'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(_crd && CommonItem === void 0 ? (_reportPossibleCrUseOfCommonItem({
        ...
        asyncView() {
          ...
          for (let i = 0; i < this._giftData.bargainRecords.length; i++) {
            const record = this._giftData.bargainRecords[i];
            const item = instantiate(this.pfb_log);
            item.parent = this.node_conten;
            const itemTs = item.getComponent(_crd && AssociationGiftItem === void 0 ? (_reportPossibleCrUseOfAssociationGiftItem({
              error: Error()
          ...
          const stepNumber = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
