    ...
    execute: function () {
      ...
      _export("PvpControl", PvpControl = class PvpControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        getHerosByGroup(group) {
          let list = this.allAbsObj.get((_crd && PvpObjType === void 0 ? (_reportPossibleCrUseOfPvpObjType({
            error: Error()
          }), PvpObjType) : PvpObjType).role);
          let newList = [];
        ...
        FECreateHero(createHero) {
          let fightInfo = (_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
            error: Error()
          }), FightData) : FightData).ins.getPvpFightInfoByGroup(createHero.group);
          let hero = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
        ...
        FECreateBullet(createBullet) {
          let configTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        addBuffEffect(abs, buffId) {
          let buff = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        FEDamage(damage) {
          ...
          if (owner.abs) {
            ...
            let dd = (_crd && DamageData === void 0 ? (_reportPossibleCrUseOfDamageData({
              error: Error()
