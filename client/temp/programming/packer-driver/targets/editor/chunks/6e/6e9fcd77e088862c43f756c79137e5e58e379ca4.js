    ...
    execute: function () {
      ...
      _export("Loading", Loading = (_dec = ccclass('Loading'), _dec2 = property(Label), _dec3 = property(Label), _dec(_class = (_class2 = class Loading extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        static setProgress(p) {
          let view = (_crd && UIMgr === void 0 ? (_reportPossibleCrUseOfUIMgr({
            error: Error()
        ...
        onShow() {
          ...
          let time = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        setTips() {
          let tips = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().TipsTable;
          let index = (_crd && getRandomInt === void 0 ? (_reportPossibleCrUseOfgetRandomInt({
            error: Error()
