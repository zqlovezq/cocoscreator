        ...
        initGraphics() {
          ...
          switch (this.type) {
            case (_crd && ShapeType === void 0 ? (_reportPossibleCrUseOfShapeType({
              ...
              let rect = new Rect(this.center.x - this.size.x / 2, this.center.y - this.size.y / 2, this.size.x, this.size.y); // let rect = new Rect(this.center.x, this.center.y - this.size.y / 2, this.size.x, this.size.y)
