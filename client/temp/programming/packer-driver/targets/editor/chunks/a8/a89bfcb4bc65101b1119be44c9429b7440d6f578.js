    ...
    execute: function () {
      ...
      _export("AssociationView", AssociationView = (_dec = ccclass('AssociationView'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = class AssociationView extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        async switchView() {
          ...
          this.view_type = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          ...
          switch (this.view_type) {
            case (_crd && ASSOCIATION === void 0 ? (_reportPossibleCrUseOfASSOCIATION({
              ...
              this.assocition_apply_view.getComponent(_crd && AssociationApplyView === void 0 ? (_reportPossibleCrUseOfAssociationApplyView({
                error: Error()
            ...
            case (_crd && ASSOCIATION === void 0 ? (_reportPossibleCrUseOfASSOCIATION({
              ...
              if (this.openData) {
                this.assocition_main_view.getComponent(_crd && AssociationMainView === void 0 ? (_reportPossibleCrUseOfAssociationMainView({
                  error: Error()
                }), AssociationMainView) : AssociationMainView).onShow(this.openData);
                this.openData = null;
              } else {
                this.assocition_main_view.getComponent(_crd && AssociationMainView === void 0 ? (_reportPossibleCrUseOfAssociationMainView({
                  error: Error()
