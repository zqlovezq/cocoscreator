    ...
    execute: function () {
      ...
      _export("BagPop", BagPop = (_dec = ccclass('BagPop'), _dec2 = property(Button), _dec3 = property(Button), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Label), _dec11 = property(Label), _dec(_class = (_class2 = class BagPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initBagData() {
          ...
          let equips = (_crd && EquipData === void 0 ? (_reportPossibleCrUseOfEquipData({
            error: Error()
            ...
            if (!value.isWear) {
              if (value.itemTable.BagType == (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                this.addByBagDataMap((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
                }), tab) : tab).BagType.BagType_Equip, value);
              } else if (value.itemTable.BagType == (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).BagType.BagType_Jade) {
                this.addByBagDataMap((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
                }), tab) : tab).BagType.BagType_Jade, value);
              }
            }
          }
        ...
        addByBagDataMap(type, info, isFind = false) {
        ...
        removeBagEquipData(id) {
          let list = this.bagDataMap.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).BagType.BagType_Equip);
        ...
        on_s2c_Msg_ItemChangePush(msg) {
          ...
          for (let value of msg.updatedEquipments) {
            let info = (_crd && EquipData === void 0 ? (_reportPossibleCrUseOfEquipData({
              error: Error()
            }), EquipData) : EquipData).ins.getEquipInfoById(value.id);
