    ...
    execute: function () {
      ...
      _export("HeroBagDataControl", HeroBagDataControl = (_dec = ccclass('HeroBagDataControl'), _dec(_class = (_class2 = class HeroBagDataControl {
        ...
        initData() {
          ...
          for (let i = 0; i < sortHeros.length; i++) {
            ...
            if (!this._heroList.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              const heroListAllArr = this._heroList.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).HeroClass.HeroClass_Max);
          ...
          if (this._bookList.size === 0) {
            for (let k = 0; k < bookArr.length; k++) {
              ...
              if (!this._bookList.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                const heroListAllArr = this._bookList.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
                }), tab) : tab).HeroClass.HeroClass_Max);
        ...
        refreshTeamBagData(heroId) {
          ...
          const allList = this._heroList.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).HeroClass.HeroClass_Max);
        ...
        getOneClickList() {
          ...
          for (let i = 0; i < allList.length; i++) {
            ...
            if (heroInfo.heroTable.Aptitude === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              let materialArr = [];
              let sameIdHeros = heroInfo.getHerosByType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              ...
              let sameClassHeros = heroInfo.getHerosByType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
