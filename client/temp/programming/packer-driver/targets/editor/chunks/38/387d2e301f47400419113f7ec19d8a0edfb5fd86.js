      ...
      _export("SignInGiftPop", SignInGiftPop = (_dec = ccclass('SignInGiftPop'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(ScrollView), _dec(_class = (_class2 = class SignInGiftPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const signTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            ...
            const itemTs = item.getComponent(_crd && SignInGiftItem === void 0 ? (_reportPossibleCrUseOfSignInGiftItem({
              error: Error()
        ...
        scrollToReward() {
          const signTab = (_crd && SignInGiftData === void 0 ? (_reportPossibleCrUseOfSignInGiftData({
            error: Error()
          }), SignInGiftData) : SignInGiftData).ins.getNotGetData();

          if (signTab) {
            const maxLen = Math.ceil((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
