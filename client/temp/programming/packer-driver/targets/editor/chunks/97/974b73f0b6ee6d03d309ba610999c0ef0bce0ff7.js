      ...
      _export("TalentView", TalentView = (_dec = ccclass('TalentView'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        groupList() {
          ...
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const _geneTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        on_s2c_UpgradeGeneLevelRsp(msg) {
          ...
          if (msg.type === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            let item = content.getChildByName(String(Math.floor((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
            }), RoleData) : RoleData).ins.gene.smallGeneLevel / 3) + 1));
            let itemTs = item.getComponent(_crd && TalentItem === void 0 ? (_reportPossibleCrUseOfTalentItem({
              error: Error()
            }), TalentItem) : TalentItem);
        ...
        showBigTips(target, data) {
          let ts = this.node_big_tips.getComponent(_crd && TalentBigTipsPop === void 0 ? (_reportPossibleCrUseOfTalentBigTipsPop({
            error: Error()
        ...
        showSmallTips(target, data) {
          let ts = this.node_small_tips.getComponent(_crd && TalentMiniTipsPop === void 0 ? (_reportPossibleCrUseOfTalentMiniTipsPop({
            error: Error()
        ...
        clickMove() {
          let content = this.list_view.getContent();
          let item = content.getChildByName(String(Math.ceil((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
