  ...
  return {
    ...
    execute: function () {
      ...
      _export("HeroBookView", HeroBookView = (_dec = ccclass('HeroBookView'), _dec2 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        groupHeroList(type) {
          const result = [];
          let bookList = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
            error: Error()
          }), HeroDataControl) : HeroDataControl).ins.getBookHeroListByVocation(type, false);
          /* 将heroList 按照品质分类 */

          let bookHeroList = [[]];
          let quality = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          for (let k = 0; k < bookHeroList.length; k++) {
            ...
            let _quality = _heroTab.Aptitude;
        ...
        refreshBookByItemId(itemId) {
          ...
          let ts = layout.getComponent(_crd && HeroBagLayoutCell === void 0 ? (_reportPossibleCrUseOfHeroBagLayoutCell({
            error: Error()
          }), HeroBagLayoutCell) : HeroBagLayoutCell);
