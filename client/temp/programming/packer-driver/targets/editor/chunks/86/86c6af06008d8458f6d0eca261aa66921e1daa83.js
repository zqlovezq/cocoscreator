    ...
    execute: function () {
      ...
      _export("default", MainSceneQueueUI = (_dec = ccclass('MainSceneQueueUI'), _dec(_class = (_class2 = class MainSceneQueueUI {
        ...
        static checkOpenAll() {
          ...
          for (let index = 0; index < openView.length; index++) {
            ...
            if (v.isOpen) {
              ...
              for (let j = 0; j < conf.MutexID.length; j++) {
                let dd = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
                  error: Error()
          ...
          openView.sort((a, b) => {
            let aconf = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().PopWindowMechanismByID.getValue(a.id);
            let bconf = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
          ...
          if (data) {
            switch (data.id) {
              case PopUI_id.Sign100:
                const isGiftOpen = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
                  error: Error()
              ...
              case PopUI_id.Patrol:
                const patrolOpen = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
                  error: Error()
                }), OpenFunctionMgr) : OpenFunctionMgr).ins.checkFunctionIsOpen((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
        ...
        static checkItem10004() {
          const startPatrolData = (_crd && PatrolDataMgr === void 0 ? (_reportPossibleCrUseOfPatrolDataMgr({
            error: Error()
          }), PatrolDataMgr) : PatrolDataMgr).ins.startPatrolData;
          const InitialPatrolMaxTime = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        static checkItem10002() {
          // 还有未签到的
          const canGet = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
            error: Error()
          }), ActivityData) : ActivityData).ins.getNewPlayerSignAwards();
          const isOpen = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
            error: Error()
        ...
        static checkItem10005() {
          const actInfos = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
            error: Error()
