  ...
  return {
    ...
    execute: function () {
      ...
      _export("AssociationSkillPop", AssociationSkillPop = (_dec = ccclass('AssociationSkillPop'), _dec2 = property([Node]), _dec3 = property([SpriteFrame]), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Sprite), _dec8 = property(Sprite), _dec9 = property(Label), _dec10 = property(Node), _dec11 = property(ProgressBar), _dec12 = property(Node), _dec(_class = (_class2 = class AssociationSkillPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        resetGuildSkill() {
          const lv = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
        ...
        onClickLvUp() {
          // 是否资源充足
          const config = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          ...
          const isLevelMax = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
        ...
        setSkillInfo() {
          const heroClassTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          const tabs = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          ...
          for (let j = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).HeroClass.HeroClass_Assassin; j <= (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).HeroClass.HeroClass_Warrior; j++) {
            const toggle_lv = Math.floor((_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
              error: Error()
        ...
        setCurInfo() {
          ...
          const tabData = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          ...
          for (let i = 0; i < this.node_attr_layout.children.length; i++) {
            ...
            if (tabData.AttrTypes[i]) {
              const attrTabData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              ...
              let _tabData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).getData().HeroAttrClientTableByType.getValue(tabData.AttrTypes[i]);
