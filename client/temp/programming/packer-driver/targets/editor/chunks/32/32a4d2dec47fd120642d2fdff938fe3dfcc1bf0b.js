      ...
      _export("AbsRoleInfo", AbsRoleInfo = (_dec = ccclass('AbsRoleInfo'), _dec(_class = class AbsRoleInfo extends (_crd && AbsObjInfo === void 0 ? (_reportPossibleCrUseOfAbsObjInfo({
        ...
        onInjured(data) {
          if (data.source == (_crd && DamageSource === void 0 ? (_reportPossibleCrUseOfDamageSource({
            ...
            if (data.sourceObjId) {
              let sourceRole = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
                error: Error()
        ...
        createSkillGroup(id) {
          let skillGroup = this.skillPowers.createTypeAnyId((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        mutualExclusionBySkill(skill) {
          let mutualType = 0; //1互斥 skill丢弃，  2优先 skill放入
