    ...
    execute: function () {
      ...
      _export("HeroResetPop", HeroResetPop = (_dec = ccclass('HeroResetPop'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Prefab), _dec10 = property(Prefab), _dec11 = property(Toggle), _dec12 = property(Toggle), _dec13 = property(Button), _dec14 = property(Node), _dec15 = property(Sprite), _dec16 = property(Label), _dec(_class = (_class2 = class HeroResetPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          ...
          let itemTs = node.getComponent(_crd && HeroBagItem === void 0 ? (_reportPossibleCrUseOfHeroBagItem({
            error: Error()
        ...
        switchView(e, type) {
          ...
          let inTeam = Boolean((_crd && HeroTeamControl === void 0 ? (_reportPossibleCrUseOfHeroTeamControl({
            error: Error()
            ...
            case VIEW_TYPE.STAR:
              ...
              if (star < 6) {
                ...
                if (heroInfo.heroStarUpTable.ResetCostItem) {
                  const resetItemData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                    error: Error()
                  ...
                  const itemInfo = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
                    error: Error()
                ...
                materialStarMap.forEach((value, id) => {
                  ...
                  if (itemTab) {
                    ...
                    let commonTs = node.getComponent(_crd && CommonItem === void 0 ? (_reportPossibleCrUseOfCommonItem({
                      error: Error()
                    ...
                    let StarUpTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                      error: Error()
                    ...
                    let heroTs = item.getComponent(_crd && HeroItem === void 0 ? (_reportPossibleCrUseOfHeroItem({
                      error: Error()
                    }), HeroItem) : HeroItem);
        ...
        sendMsg() {
          if (this._view_type === VIEW_TYPE.LEVEL) {
            ...
            let starUpTab = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
              error: Error()
            ...
            let ItemTabData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            ...
            msg.heroId = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
              error: Error()
            }), HeroDataControl) : HeroDataControl).ins.heroId;
            (_crd && Net === void 0 ? (_reportPossibleCrUseOfNet({
              error: Error()
              ...
              error: Error()
            }), proto) : proto).Ptl.ResetHeroStarReq, msg);
          }
        }
