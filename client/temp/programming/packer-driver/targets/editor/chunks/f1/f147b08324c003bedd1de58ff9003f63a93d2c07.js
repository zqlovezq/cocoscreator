    ...
    execute: function () {
      ...
      _export("Bullet", Bullet = (_dec = ccclass('Bullet'), _dec(_class = class Bullet extends (_crd && AbsObj === void 0 ? (_reportPossibleCrUseOfAbsObj({
        ...
        getBulletGroup() {
          ...
          let bulletGroup = (_crd && CollisionGroup === void 0 ? (_reportPossibleCrUseOfCollisionGroup({
            error: Error()
          }), CollisionGroup) : CollisionGroup).roleBullet;
        ...
        forwardArrowOffset() {
          let offsety = this.info.getObjAttr((_crd && AbsObjInfoAttr === void 0 ? (_reportPossibleCrUseOfAbsObjInfoAttr({
            error: Error()
