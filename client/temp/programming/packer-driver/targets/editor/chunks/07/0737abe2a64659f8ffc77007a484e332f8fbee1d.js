  ...
  return {
    ...
    execute: function () {
      ...
      _export("BulletControl", BulletControl = (_dec = ccclass('BulletControl'), _dec(_class = (_class2 = class BulletControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        clickEmitBullet(bulletTab, attack, targetPos, bulletGroupId = 0) {
          if (bulletTab == null) {
            console.warn("没有子弹id");
            return;
          }
        ...
        audoEmitBullet(bulletTab, attack, bulletGroupId = 0) {
          if (bulletTab == null) {
            console.warn("没有子弹id");
            return;
          }
          ...
          let enemy = (_crd && SearchEnemy === void 0 ? (_reportPossibleCrUseOfSearchEnemy({
            error: Error()
        ...
        emitBullet(bulletTab, owner, startPos, targetRole, targetPos, bulletGroupId = 0, parentSoleId = "", havaDamageObjIds = []) {
          if (bulletTab == null) {
            console.warn("没有子弹id");
            return;
          }
          ...
          if (bulletTab.Fission.length) {
            ...
            let tmpAngle = (_crd && MathAngle === void 0 ? (_reportPossibleCrUseOfMathAngle({
              error: Error()
        ...
        checkForwardArrow(bulletTab, owner, startPos, targetType, targetObj, bulletGroupId = 0, parentSoleId = "", havaDamageObjIds = []) {
          let objAttr = {
          ...
          if (bulletTab.ForwardArrow.length) {
            ...
            if ((_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
              ...
              let list = (_crd && MathAngle === void 0 ? (_reportPossibleCrUseOfMathAngle({
                error: Error()
        ...
        addBullet(bulletTab, owner, startPos, targetType, targetObj, objAttr, havaDamageObjIds = []) {
          ...
          let bulletParent = (_crd && FightRootControl === void 0 ? (_reportPossibleCrUseOfFightRootControl({
            error: Error()
          ...
          let bullet = (_crd && AbsObjFactory === void 0 ? (_reportPossibleCrUseOfAbsObjFactory({
            error: Error()
        ...
        bulletCreateBullet(bullet, bulletTab) {
          let owner = (_crd && AbsOwner === void 0 ? (_reportPossibleCrUseOfAbsOwner({
            error: Error()
