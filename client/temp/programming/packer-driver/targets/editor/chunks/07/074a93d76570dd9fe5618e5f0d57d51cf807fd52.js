    ...
    execute: function () {
      ...
      _export("RoleInfoDecorationsPop", RoleInfoDecorationsPop = (_dec = ccclass('RoleInfoDecorationsPop'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Sprite), _dec8 = property(Node), _dec9 = property(Sprite), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Node), _dec(_class = (_class2 = class RoleInfoDecorationsPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        showHeadIconView() {
          ...
          const headTabs = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().HeadTable;
          const headList = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          }), RoleData) : RoleData).ins.avatarInfo.headIcon ? [(_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          ...
          for (let i = 0; i < combinedArray.length; i++) {
            ...
            const itemTs = item.getComponent(_crd && RoleInfoDecorationsItem === void 0 ? (_reportPossibleCrUseOfRoleInfoDecorationsItem({
              error: Error()
        ...
        showHeadFrameView() {
          this.node_content.destroyAllChildren();
          const headFrameTabs = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().HeadFramTable;
          const headFrameList = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
            ...
            case (_crd && HEADTYPE === void 0 ? (_reportPossibleCrUseOfHEADTYPE({
              ...
              if ((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                ...
                (_crd && Net === void 0 ? (_reportPossibleCrUseOfNet({
                  ...
                  error: Error()
                }), proto) : proto).Ptl.SetHeadFrameReq, msg);
              }
        ...
        checkHeadIsHave(itemId) {
          for (let i = 0; i < (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            ...
            const id = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
        ...
        changeIconState(headItemId, headFrameId, isInit) {
          ...
          if (headFrameId) {
            ...
            const frameItemTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            ...
            if (frameTab) {
              for (let i = 0; i < frameTab.AttrTypes.length; i++) {
                ...
                const attrItemTs = attrItem.getComponent(_crd && HeroAttrItem === void 0 ? (_reportPossibleCrUseOfHeroAttrItem({
                  error: Error()
          ...
          if (headItemId) {
            ...
            const headItemTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
