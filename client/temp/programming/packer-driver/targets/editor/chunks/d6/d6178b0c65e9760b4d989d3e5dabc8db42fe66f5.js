    ...
    execute: function () {
      ...
      _export("TaskData", TaskData = class TaskData {
        ...
        getGuildActiveReward(index) {
          let mainChapter = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        getWeekActiveReward(index) {
          let tableData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        getTrialTaskInfo(taskid) {
          ...
          const costomTask = new (_crd && TaskInfo === void 0 ? (_reportPossibleCrUseOfTaskInfo({
            error: Error()
          }), TaskInfo) : TaskInfo)();
