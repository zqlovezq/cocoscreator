      ...
      _export("HeroRecommendPop", HeroRecommendPop = (_dec = ccclass('HeroRecommendPop'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(ScrollView), _dec(_class = (_class2 = class HeroRecommendPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        setView() {
          ...
          for (let i = 0; i < this._recommendTableData.length; i++) {
            ...
            let ts = item.getComponent(_crd && HeroRecommendPopItem === void 0 ? (_reportPossibleCrUseOfHeroRecommendPopItem({
              error: Error()
        ...
        getListData() {
          ...
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            let _tab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
