System.register(["__unresolved_0", "cc", "__unresolved_1", "client_protocol", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9"], function (_export, _context) {
  "use strict";

  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Label, RichText, sp, Sprite, ViewPop, proto, Net, tab, ItemData, ShowItemNotEnoughTips, UIMgr, ViewName, LangMgr, EventMgr, OpenFunctionMgr, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, RareBookGuaranteedPop;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "8013d66fPRE5YlveC7qx+FA", "RareBookGuaranteedPop", undefined);

      __checkObsolete__(['_decorator', 'Component', 'EventTouch', 'Label', 'Node', 'RichText', 'sp', 'SpringJoint2D', 'Sprite']);
      ...
      _export("RareBookGuaranteedPop", RareBookGuaranteedPop = (_dec = ccclass('RareBookGuaranteedPop'), _dec2 = property(Label), _dec3 = property(RichText), _dec4 = property(Sprite), _dec5 = property(sp.Skeleton), _dec(_class = (_class2 = class RareBookGuaranteedPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        error: Error()
      }), ViewPop) : ViewPop) {
        constructor(...args) {
          super(...args);
          ...
          _initializerDefineProperty(this, "sp_icon", _descriptor3, this);

          _initializerDefineProperty(this, "spine_draw", _descriptor4, this);
        ...
        onShow() {
          ...
          this.gachaData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().GachaTableById.getValue(1000); // 需要消耗的数量

          const needCount = this.gachaData.ItemCount; // 当前道具数量

          const curCount = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          }), ItemData) : ItemData).ins.getCount(82);
          ...
          this.rich_txt_recruit.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
            error: Error()
          }), LangMgr) : LangMgr).getCombineString("ui_rarebook_4", [needCount]);
          const itemTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().ItemTableById.getValue(82);
        ...
        clickGacha() {
          ...
          if (curCount < needCount) {
            ...
            (_crd && ShowItemNotEnoughTips === void 0 ? (_reportPossibleCrUseOfShowItemNotEnoughTips({
              error: Error()
            }), ShowItemNotEnoughTips) : ShowItemNotEnoughTips)(82);
            return;
          } // 是否解锁
        ...
        showGachaProbabilityView(event, type) {
          (_crd && UIMgr === void 0 ? (_reportPossibleCrUseOfUIMgr({
            ...
            viewName: (_crd && ViewName === void 0 ? (_reportPossibleCrUseOfViewName({
              error: Error()
            }), ViewName) : ViewName).RareBookSrProbabilityPop
          }); // UIMgr.ins.show({
      ...
      }), _descriptor3 = _applyDecoratedDescriptor(_class2.prototype, "sp_icon", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
      ...
      }), _descriptor4 = _applyDecoratedDescriptor(_class2.prototype, "spine_draw", [_dec5], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=afbaeaf88d8345a5f62582ebf63ec6078e9b9424.js.map