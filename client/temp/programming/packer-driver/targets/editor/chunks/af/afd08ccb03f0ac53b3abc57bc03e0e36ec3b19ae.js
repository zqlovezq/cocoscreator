      ...
      _export("GameplayViewItem", GameplayViewItem = (_dec = ccclass('GameplayViewItem'), _dec2 = property(Label), _dec3 = property(Sprite), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec(_class = (_class2 = class GameplayViewItem extends Component {
        ...
        setData(data) {
          ...
          for (let i = 0; i < data.ShowItemId.length; i++) {
            const itemInfo = new (_crd && ItemInfo === void 0 ? (_reportPossibleCrUseOfItemInfo({
              error: Error()
            }), ItemInfo) : ItemInfo)();
        ...
        addRedEvent(id) {
          if (id === 1) {
            const redCompTs = this.addComponent(_crd && RedComp === void 0 ? (_reportPossibleCrUseOfRedComp({
              error: Error()
            }), RedComp) : RedComp);
            redCompTs.redNode = this.node_red;
            const type1 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            ...
            const type2 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            }), RedEventComp) : RedEventComp)();
            ...
            redCompTs.redNode = this.node_red; // const type1: RedEventComp = new RedEventComp();
            ...
            const type3 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            }), RedEventComp) : RedEventComp)();
            type3.event = (_crd && RedDotType === void 0 ? (_reportPossibleCrUseOfRedDotType({
              error: Error()
            }), RedDotType) : RedDotType).ClimbingTowerStageReward;
            const type4 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            }), RedEventComp) : RedEventComp)();
