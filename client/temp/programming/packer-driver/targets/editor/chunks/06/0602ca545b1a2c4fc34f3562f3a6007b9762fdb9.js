    ...
    execute: function () {
      ...
      _export("RareBookInfo", RareBookInfo = (_dec = ccclass('RareBookInfo'), _dec(_class = class RareBookInfo extends (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
        ...
        merge(bookInfo) {
          ...
          this.isLock = true;
          let value = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
          ...
          let value2 = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
        ...
        getAttrMapByLevelRatio(ratio, types = null, values = null) {
          let map = new Map();
