System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Label, Node, ItemPoolMgr, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, TopWarRankRewardItem;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "afc33fEuuNG07+UXRoDUNWs", "TopWarRankRewardItem", undefined);
      ...
      _export("TopWarRankRewardItem", TopWarRankRewardItem = (_dec = ccclass('TopWarRankRewardItem'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec(_class = (_class2 = class TopWarRankRewardItem extends Component {
        constructor(...args) {
          super(...args);
...
//# sourceMappingURL=43b3d3f4b019160bcbfc45e3edf3e0a8af418529.js.map