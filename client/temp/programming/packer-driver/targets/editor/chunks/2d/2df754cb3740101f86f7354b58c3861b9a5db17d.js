    ...
    execute: function () {
      ...
      _export("RoleInfoDecorationsItem", RoleInfoDecorationsItem = (_dec = ccclass('RoleInfoDecorationsItem'), _dec2 = property(Sprite), _dec3 = property(Sprite), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = class RoleInfoDecorationsItem extends Component {
        ...
        initHeadData(itemId, view) {
          ...
          const itemHeadTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          const headIconRed = (_crd && RedMgr === void 0 ? (_reportPossibleCrUseOfRedMgr({
            error: Error()
          ...
          if (!headIconRed) {
            ...
            const headIconItemRed = (_crd && RedMgr === void 0 ? (_reportPossibleCrUseOfRedMgr({
              error: Error()
            }), RedMgr) : RedMgr).ins.isRed((_crd && RedDotType === void 0 ? (_reportPossibleCrUseOfRedDotType({
              error: Error()
        ...
        initFrameData(itemId, view) {
          ...
          const itemFrameTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().ItemTableById.getValue(itemId);
          ...
          const headFrameRed = (_crd && RedMgr === void 0 ? (_reportPossibleCrUseOfRedMgr({
            error: Error()
          }), RedMgr) : RedMgr).ins.isRed((_crd && RedDotType === void 0 ? (_reportPossibleCrUseOfRedDotType({
            error: Error()
          ...
          if (!headFrameRed) {
            ...
            const headFrameItemRed = (_crd && RedMgr === void 0 ? (_reportPossibleCrUseOfRedMgr({
              error: Error()
            }), RedMgr) : RedMgr).ins.isRed((_crd && RedDotType === void 0 ? (_reportPossibleCrUseOfRedDotType({
              error: Error()
