    ...
    execute: function () {
      ...
      _export("PvpTest", PvpTest = class PvpTest {
        static createHero(group) {
          ...
          let newList = (_crd && PvpControl === void 0 ? (_reportPossibleCrUseOfPvpControl({
            error: Error()
          ...
          msg.createHero.y = 50;
          let hp = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
        ...
        static updateBuff() {
          ...
          let abs = (_crd && PvpControl === void 0 ? (_reportPossibleCrUseOfPvpControl({
            error: Error()
