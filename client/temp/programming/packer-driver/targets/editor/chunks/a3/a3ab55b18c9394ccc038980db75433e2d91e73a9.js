    ...
    execute: function () {
      ...
      _export("InstanceZonesView", InstanceZonesView = (_dec = ccclass('InstanceZonesView'), _dec2 = property(Label), _dec3 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        on_s2c_FinishStageRsp(msg) {
          ...
          let _msg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
        ...
        changeDataByViewType(type) {
          ...
          const vipLevel = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
            error: Error()
        ...
        scrollToIndex() {
          const index = this.curExportInfo.clearedStageIds.indexOf((_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
        ...
        oneClickSweep() {
          ...
          let needDiamond = 0;
          const curHaveDiamond = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
