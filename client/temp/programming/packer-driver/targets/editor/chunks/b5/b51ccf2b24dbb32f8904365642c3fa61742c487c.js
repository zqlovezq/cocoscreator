  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoleState3Attack", RoleState3Attack = class RoleState3Attack extends (_crd && AbsRoleState === void 0 ? (_reportPossibleCrUseOfAbsRoleState({
        ...
        emitBullet() {
          let testBullet = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          if (testBullet) {
            let bulletTab = this.info.skillPowers.createTypeAnyId((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            ...
            if (this.isTargetPos) {
              ...
              let re = (_crd && SkillControl === void 0 ? (_reportPossibleCrUseOfSkillControl({
                error: Error()
