    ...
    execute: function () {
      ...
      _export("RareBookEquipNode", RareBookEquipNode = (_dec = ccclass('RareBookEquipNode'), _dec2 = property([_crd && RareBookItem === void 0 ? (_reportPossibleCrUseOfRareBookItem({
        ...
        initView(prefb = null) {
          ...
          let canList = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
          }), RareBookData) : RareBookData).ins.getCanBookInfosByHeroClass(this.currTag);
          let slots = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
          ...
          for (let key in canList) {
            ...
            if (!item) {
              ...
              item = node.getComponent(_crd && RareBookItem === void 0 ? (_reportPossibleCrUseOfRareBookItem({
                error: Error()
          ...
          let baseInfo = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
