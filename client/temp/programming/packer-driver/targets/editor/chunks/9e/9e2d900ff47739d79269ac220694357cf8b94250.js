      ...
      _export("BattleMainView", BattleMainView = (_dec = ccclass('BattleMainView'), _dec2 = property(Prefab), _dec3 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        setView() {
          ...
          if (this._viewLayer === (_crd && TRIALLAYER === void 0 ? (_reportPossibleCrUseOfTRIALLAYER({
            ...
            const countData = (_crd && BattleMainEliteData === void 0 ? (_reportPossibleCrUseOfBattleMainEliteData({
              error: Error()
        ...
        _onTouchEnded(e) {
          ...
          if (this._starClickIdx === this._clickIdx && !isNaN(item.name)) {
            let dataIndex = item.getComponent(_crd && BattleMainItem === void 0 ? (_reportPossibleCrUseOfBattleMainItem({
              error: Error()
        ...
        updateItemScale() {
          ...
          itemChildren.forEach(item => {
            ...
            let itemTs = item.getComponent(_crd && BattleMainItem === void 0 ? (_reportPossibleCrUseOfBattleMainItem({
              error: Error()
            }), BattleMainItem) : BattleMainItem);
        ...
        levelSelect(data) {
          ...
          let moveX = contentX - (dis - scrollViewMidX); // const time = (dis / 2000) > 0.1 ? 0.1 : (dis / 2000);
          ...
          this.scheduleOnce(() => {
            ...
            itemChildren.forEach(item => {
              const itemTs = item.getComponent(_crd && BattleMainItem === void 0 ? (_reportPossibleCrUseOfBattleMainItem({
                error: Error()
              }), BattleMainItem) : BattleMainItem);
            ...
            if (item) {
              const stageId = item.getComponent(_crd && BattleMainItem === void 0 ? (_reportPossibleCrUseOfBattleMainItem({
                error: Error()
        ...
        clickBattleBtn() {
          /* 如果体力不足 前端拦截 */
          const powerData = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
        ...
        setEliteBattleReward() {
          ...
          const rewardTabData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
