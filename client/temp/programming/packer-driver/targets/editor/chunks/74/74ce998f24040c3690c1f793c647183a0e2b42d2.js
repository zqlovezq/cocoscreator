      ...
      _export("RoleControl", RoleControl = class RoleControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        on_s2c_SyncRolePush(msg) {
          ...
          if ((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            ...
            let day = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
        ...
        */
          ...
          (_crd && Http === void 0 ? (_reportPossibleCrUseOfHttp({
            ...
            cb: responseJson => {
              ...
              if (responseJson && responseJson.length > 0) {
                ...
                let lastTimer = Number((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
                  error: Error()
        ...
        ShowErrorTips(errorCode, errMsg = "") {
          ...
          let lab = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
            error: Error()
        ...
        on_s2c_GetMainStageInfoRsp(msg) {
          ...
          if (newStageId > 0) {
            if (newStageId == 303) {
              let key = (_crd && P8PostEventName === void 0 ? (_reportPossibleCrUseOfP8PostEventName({
                error: Error()
              ...
              let isPost = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
                error: Error()
        ...
        buyStaminaRedPoint() {
          // 剩余广告买体力有次数
          const buyTimes = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          ...
          let curStaminaCount = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          }), ItemData) : ItemData).ins.getCount(6);
          let maxStaminaCount = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          const isStaminaEnough = curStaminaCount < maxStaminaCount; // 是否打开过界面

          const isCloseBuyPop = (_crd && SettingRedManager === void 0 ? (_reportPossibleCrUseOfSettingRedManager({
            error: Error()
        ...
        setVipPrivilege() {
          const vipBonusMap = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
