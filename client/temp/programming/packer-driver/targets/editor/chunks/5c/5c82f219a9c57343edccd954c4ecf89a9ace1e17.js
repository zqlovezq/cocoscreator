  ...
  return {
    ...
    execute: function () {
      ...
      _export("CongratulationItem", CongratulationItem = (_dec = ccclass('CongratulationItem'), _dec(_class = class CongratulationItem extends Component {
        ...
        createHeroItem(data, parentNode, isPiece = false) {
          ...
          const itemTs = heroItem.getComponent(_crd && HeroItem === void 0 ? (_reportPossibleCrUseOfHeroItem({
            error: Error()
          }), HeroItem) : HeroItem);
          itemTs.setTouchCallBack(() => {});
        ...
        createBookItem(data, parentNode) {
          ...
          const Weapon_Item = (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
            error: Error()
          }), ItemPoolMgr) : ItemPoolMgr).ins.createBookItem(info, parentNode);
          this.bookComItems.push(Weapon_Item);
          const itemTs = Weapon_Item.getComponent(_crd && WeaponItem === void 0 ? (_reportPossibleCrUseOfWeaponItem({
            error: Error()
        ...
        createEquipItem(data, parentNode) {
          ...
          info.itemId = data.itemId;
          const equipItem = (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
            error: Error()
          }), ItemPoolMgr) : ItemPoolMgr).ins.createEquipItem(info, parentNode, false);
          this.equipComItems.push(equipItem);
          const itemTs = equipItem.getComponent(_crd && EquipmentItem === void 0 ? (_reportPossibleCrUseOfEquipmentItem({
            error: Error()
