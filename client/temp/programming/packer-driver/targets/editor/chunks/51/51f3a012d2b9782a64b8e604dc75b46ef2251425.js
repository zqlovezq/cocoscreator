    ...
    execute: function () {
      ...
      _export("CombineAccumulatedRechargeItem", CombineAccumulatedRechargeItem = (_dec = ccclass('CombineAccumulatedRechargeItem'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(ScrollView), _dec(_class = (_class2 = class CombineAccumulatedRechargeItem extends Component {
        ...
        setView() {
          ...
          const type = (_crd && HeroRed === void 0 ? (_reportPossibleCrUseOfHeroRed({
            error: Error()
          }), HeroRed) : HeroRed).ins.getPayType();

          for (let i = 0; i < Tabs.length; i++) {
            if (Tabs[i].ShowId) {
              const _tab = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
                error: Error()
            ...
            const itemTs = item.getComponent(_crd && CombineAccumulatedRechargeCellItem === void 0 ? (_reportPossibleCrUseOfCombineAccumulatedRechargeCellItem({
              error: Error()
