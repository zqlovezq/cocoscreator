  ...
  return {
    ...
    execute: function () {
      ...
      _export("GuideController", GuideController = (_dec = ccclass('GuideController'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Mask), _dec8 = property(Node), _dec9 = property(_crd && CommonTipsPop === void 0 ? (_reportPossibleCrUseOfCommonTipsPop({
        ...
        static Release() {
          if (GuideController._ins) {
            const tri = GuideController._ins.getComponent(_crd && GuideTrigger === void 0 ? (_reportPossibleCrUseOfGuideTrigger({
              error: Error()
        ...
        */
        ...
        resetTouchMaskDebugColor() {
          let isDebug = false; // this.left.getComponent(Sprite).enabled = isDebug;
        ...
        _processCommand(cmd, args, cb) {
          this.runningCB = cb;
          let cmdFunc = (_crd && GuideCommand === void 0 ? (_reportPossibleCrUseOfGuideCommand({
            error: Error()
        ...
        fingerToNode(node, fingerActive = true, holeActive = true, isCircle, isScale) {
        ...
        focusToNode(node, isCircle, isScale) {
          //设置点击屏蔽遮罩
          let rect = this.GetBoundingBoxToWorld(node);
