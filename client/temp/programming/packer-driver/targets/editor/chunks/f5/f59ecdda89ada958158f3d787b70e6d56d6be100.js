      ...
      _export("FightTestView", FightTestView = (_dec = ccclass('FightTestView'), _dec2 = property(Node), _dec3 = property(Toggle), _dec4 = property(Toggle), _dec5 = property(Toggle), _dec6 = property(Toggle), _dec7 = property(Toggle), _dec8 = property(Toggle), _dec9 = property(Toggle), _dec10 = property(Label), _dec11 = property(EditBox), _dec12 = property(EditBox), _dec13 = property(EditBox), _dec14 = property(EditBox), _dec15 = property(EditBox), _dec16 = property(EditBox), _dec17 = property(Toggle), _dec18 = property(EditBox), _dec(_class = (_class2 = class FightTestView extends Component {
        ...
        onmonsterToggle() {
          this.scheduleOnce(() => {
            ...
            let count = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
              error: Error()
        ...
        onSkillEdit() {
          ...
          let id = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
          }), Func) : Func).checkInt(str);
          (_crd && FightRootControl === void 0 ? (_reportPossibleCrUseOfFightRootControl({
            error: Error()
        ...
        addBuff(e, cusData) {
          let leader = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
            error: Error()
          ...
          let buff = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
          }), Func) : Func).checkInt(str);
          ...
          if (cusData == "2") {
            ...
            let enemy = list[0];
            let buffTab = leader.info.skillPowers.createTypeAnyId((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).PowerType.PowerType_BuffTable, buff);
            (_crd && BuffControl === void 0 ? (_reportPossibleCrUseOfBuffControl({
              error: Error()
            }), BuffControl) : BuffControl).ins.addBuff(buffTab, leader.objId, enemy);
          } else if (cusData == "3") {
            let list = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
              error: Error()
        ...
        onUseSkill() {
          ...
          let skillTab = leader.info.skillPowers.createTypeAnyId((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        onPvpBullet() {
          ...
          let bulletTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        onCopy() {
          let dd = JSON.parse(JSON.stringify((_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
            error: Error()
