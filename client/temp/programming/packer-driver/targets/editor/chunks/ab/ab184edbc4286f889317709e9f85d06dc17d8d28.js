      ...
      _export("GuideTrigger", GuideTrigger = (_dec = ccclass('GuideTrigger'), _dec(_class = class GuideTrigger extends Component {
        ...
        checkGuide() {
          ...
          if (this.guideTrunkData === undefined) {
            let allGuideData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        runGuide(guideArray, stopOnFailed, endCallback) {
          /* 是否新手引导完毕 */
          let bGuideOver = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
        ...
        ergodicGuide(guideArray, stopOnFailed, endCallback) {
          async.eachSeries(guideArray, (guideData, next) => {
            ...
            try {
              const task = (_crd && guideTask === void 0 ? (_reportPossibleCrUseOfguideTask({
                error: Error()
        ...
        isGuidePass(guideId) {
          let guideData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
