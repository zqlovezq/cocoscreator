    ...
    execute: function () {
      ...
      _export("HeroAttrPop", HeroAttrPop = (_dec = ccclass('HeroAttrPop'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec(_class = (_class2 = class HeroAttrPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initView() {
          ...
          let heroAttr = new (_crd && HeroAttr === void 0 ? (_reportPossibleCrUseOfHeroAttr({
            error: Error()
          }), HeroAttr) : HeroAttr)();
          heroAttr.attr = this.attrMap;
          let map = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().HeroAttrClientTableByType;
          map.forEach((key, value) => {
            if (value.ShowHeroAttr) {
              let node = instantiate(this.itemPrefab);
              let com = node.getComponent(_crd && HeroAttrPopItem === void 0 ? (_reportPossibleCrUseOfHeroAttrPopItem({
                error: Error()
