    ...
    execute: function () {
      ...
      _export("RookieTaskPop", RookieTaskPop = (_dec = ccclass('RookieTaskPop'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        setOnshow() {
          ...
          let trialInfo = (_crd && RookieTaskMgr === void 0 ? (_reportPossibleCrUseOfRookieTaskMgr({
            error: Error()
        ...
        createDayToggle() {
          for (let i = 1; i <= 7; i++) {
            ...
            item.name = String(i);
            const itemTs = item.getComponent(_crd && TrialToggleBtn === void 0 ? (_reportPossibleCrUseOfTrialToggleBtn({
              error: Error()
        ...
        setBarItem() {
          for (let i = 0; i < 6; i++) {
            ...
            const itemTs = item.getComponent(_crd && RookieTaskBarItem === void 0 ? (_reportPossibleCrUseOfRookieTaskBarItem({
              error: Error()
            }), RookieTaskBarItem) : RookieTaskBarItem);
            itemTs.initData(scoreTab);
          }

          const trialData = (_crd && RookieTaskMgr === void 0 ? (_reportPossibleCrUseOfRookieTaskMgr({
            error: Error()
          }), RookieTaskMgr) : RookieTaskMgr).ins.getTrialTask(this._openName);
        ...
        refreshScore(socreId) {
          ...
          const newPlayertrial = (_crd && RookieTaskMgr === void 0 ? (_reportPossibleCrUseOfRookieTaskMgr({
            error: Error()
        ...
        getViewData() {
          ...
          if (this._view_type === (_crd && TRIALTASK === void 0 ? (_reportPossibleCrUseOfTRIALTASK({
            ...
            taskData.sort((taskId1, taskId2) => {
              const taskData1 = (_crd && TaskData === void 0 ? (_reportPossibleCrUseOfTaskData({
                error: Error()
              }), TaskData) : TaskData).ins.getTrialTaskInfo(taskId1);
              const taskData2 = (_crd && TaskData === void 0 ? (_reportPossibleCrUseOfTaskData({
                error: Error()
            ...
            const arr = (_crd && RookieTaskMgr === void 0 ? (_reportPossibleCrUseOfRookieTaskMgr({
              error: Error()
        ...
        beginCountDown() {
          ...
          const now = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
        ...
        clickShowHero() {
          if (this._layer_type === (_crd && TRIALLAYER === void 0 ? (_reportPossibleCrUseOfTRIALLAYER({
            ...
            const data = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
