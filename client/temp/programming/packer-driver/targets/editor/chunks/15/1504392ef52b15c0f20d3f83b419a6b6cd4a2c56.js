    ...
    execute: function () {
      ...
      _export("CheckRoleInfoPop", CheckRoleInfoPop = (_dec = ccclass('CheckRoleInfoPop'), _dec2 = property(Label), _dec3 = property(_crd && PlayerHeadItem === void 0 ? (_reportPossibleCrUseOfPlayerHeadItem({
        ...
        initView() {
          ...
          let pveTable = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          const isSelf = this.info.id === (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          }), RoleData) : RoleData).ins.id;
          ...
          for (let key in heros) {
            ...
            let item = (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
              error: Error()
            }), ItemPoolMgr) : ItemPoolMgr).ins.createHeroItem(heroInfo, this.itemLayout);
            ...
            if (this.rankData) {
              ...
              item.getComponent(_crd && HeroItem === void 0 ? (_reportPossibleCrUseOfHeroItem({
                error: Error()
              }), HeroItem) : HeroItem).setTouchCallBack(this.onTouchHero);
            }
          }
        }
