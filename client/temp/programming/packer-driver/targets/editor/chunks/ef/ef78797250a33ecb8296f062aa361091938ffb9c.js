      ...
      _export("PlayerControl", PlayerControl = (_dec = ccclass('PlayerControl'), _dec(_class = (_class2 = class PlayerControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        onFight_Start() {
          ...
          for (let index = 0; index < (_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
            ...
            let info = new (_crd && HeroFightInfo === void 0 ? (_reportPossibleCrUseOfHeroFightInfo({
              error: Error()
        ...
        fightSkillsToRole() {
          let skills = (_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
            error: Error()
        ...
        initRole(heroInfo) {
          let roleInfo = new (_crd && RoleInfo === void 0 ? (_reportPossibleCrUseOfRoleInfo({
            error: Error()
          }), RoleInfo) : RoleInfo)();
          ...
          roleInfo.init();
          let role = (_crd && AbsObjFactory === void 0 ? (_reportPossibleCrUseOfAbsObjFactory({
            error: Error()
        ...
        roleActive(heroInfo) {
          ...
          if (roleInfo.posIndex == (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            ...
            //添加战士额外技能
            let skill = roleInfo.skillPowers.createTypeAnyId((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        getClickNodePos() {
          if (isWorldChange) {
            isWorldChange = false;
            let nn = (_crd && FightRootControl === void 0 ? (_reportPossibleCrUseOfFightRootControl({
              error: Error()
