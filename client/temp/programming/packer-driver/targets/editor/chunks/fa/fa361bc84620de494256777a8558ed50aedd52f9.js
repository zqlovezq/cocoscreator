  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ModuleInJumpComp = (_dec = property({
        ...
        checkVisible() {
          let isVisible = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
            error: Error()
        ...
        isGuideBlockClick() {
          const isGuiding = !(_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          }), RoleData) : RoleData).ins.IsGuideFinished();
          const isBlock = (_crd && GuideController === void 0 ? (_reportPossibleCrUseOfGuideController({
            error: Error()
