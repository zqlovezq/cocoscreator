  ...
  return {
    ...
    execute: function () {
      ...
      _export("AssociationBossView", AssociationBossView = (_dec = ccclass('AssociationBossView'), _dec2 = property([Node]), _dec3 = property(_crd && TopWarPlayRankHeadiItem === void 0 ? (_reportPossibleCrUseOfTopWarPlayRankHeadiItem({
        ...
        initMyRank() {
          // error("头像功能没有做")
          const selfSimple = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          }), AssociationData) : AssociationData).ins.getSelfRoleRankInfo(); // const ranking = AssociationData.ins.getSelfRoleRankCount();

          const _ranking = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          ...
          let num = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
        ...
        buyChallenge(callBack) {
          ...
          if (num < freeCount) {
            ...
            if (num < totalNum) {
              let isPrivilege = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
                error: Error()
              }), AssociationData) : AssociationData).ins.checkFunctionIsOpen((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
        ...
        setGuildHerosSpine() {
          const membersArr = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
