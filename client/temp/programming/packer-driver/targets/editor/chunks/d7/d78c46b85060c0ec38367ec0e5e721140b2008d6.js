  ...
  return {
    ...
    execute: function () {
      ...
      _export("SkillControl", SkillControl = (_dec = ccclass('SkillControl'), _dec(_class = (_class2 = class SkillControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        useSkillAndBullet(skill, attack, targetPos = null) {
        ...
        useSkillTarget(skill, attack) {
          ...
          let enemys = (_crd && SearchEnemy === void 0 ? (_reportPossibleCrUseOfSearchEnemy({
            error: Error()
        ...
        useSkillBullet(skill, attack, targetPos = null, bulletGroupId = 0, runningShot = false) {
          if (skill.Bullet == 0) {
            return;
          }
        ...
        rogueUseSkillTarget(rogueInfo) {
          let attack = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
            error: Error()
          }), PlayerControl) : PlayerControl).ins.roles[0];
          let searchType = this.getSearchTypeByOwn(rogueInfo.rogueTab.Own);
          let ownRoles = (_crd && SearchEnemy === void 0 ? (_reportPossibleCrUseOfSearchEnemy({
            error: Error()
