System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12", "__unresolved_13"], function (_export, _context) {
  ...
  async function ShowTips(key) {
    ...
    if (!nodeTipsContainer) {
      let prefab = await (_crd && LoadResAsync === void 0 ? (_reportPossibleCrUseOfLoadResAsync({
        error: Error()
    ...
    let tipsCom = nodeTipsContainer.getComponent(_crd && BlackTips === void 0 ? (_reportPossibleCrUseOfBlackTips({
      error: Error()
    }), BlackTips) : BlackTips);
  ...
  async function ShowItemNotEnoughTips(itemId) {
    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr extends (_crd && AbsMgr === void 0 ? (_reportPossibleCrUseOfAbsMgr({
        ...
        async show(uiData) {
          ...
          if (nowView == null) {
            ...
            if (pfb) {
              ...
              let viewBase = nowView.getComponent(_crd && ViewBase === void 0 ? (_reportPossibleCrUseOfViewBase({
                error: Error()
              }), ViewBase) : ViewBase);
        ...
        getView(viewName) {
          ...
          let views = this.getViewListByViewType(viewTab.ViewType);
          let viewListData = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
        ...
        getViewScr(viewName) {
          let _view = this.getView(viewName);
        ...
        checkView() {
          let views = this.getViewListByViewType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).ViewType.ViewType_View);
          let pops = this.getViewListByViewType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).ViewType.ViewType_Pop);
          let persists = this.getViewListByViewType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).ViewType.ViewType_Persist);
        ...
        jumpLayer(module, tabId, closeFunc, opFuncName, deepArgs) {
          let moduleTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().ModuleTableByModuleType.getValue(module);
          let isOpen = false;
          let openId = -1;
          let guildOpen = false;
          let guideOpenId = -1; // 功能名称
