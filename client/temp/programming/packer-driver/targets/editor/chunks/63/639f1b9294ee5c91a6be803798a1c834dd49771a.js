    ...
    execute: function () {
      ...
      _export("ActivityMainView", ActivityMainView = (_dec = ccclass('ActivityMainView'), _dec2 = property(Node), _dec3 = property(Toggle), _dec4 = property(Toggle), _dec5 = property(Toggle), _dec6 = property(Toggle), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Prefab), _dec14 = property(Prefab), _dec15 = property(Prefab), _dec(_class = (_class2 = class ActivityMainView extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        setChapterMap() {
          ...
          const ChapterId = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
            error: Error()
          ...
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const _mallTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
          ...
          switch (this.view_type) {
            case (_crd && ACTIVITY_GIFT_VIEW === void 0 ? (_reportPossibleCrUseOfACTIVITY_GIFT_VIEW({
              ...
              if (!this.cycle_view) {
                ...
                if (_cycle_view) {
                  this.cycle_view = _cycle_view.getComponent(_crd && CycleGiftView === void 0 ? (_reportPossibleCrUseOfCycleGiftView({
                    error: Error()
            ...
            case (_crd && ACTIVITY_GIFT_VIEW === void 0 ? (_reportPossibleCrUseOfACTIVITY_GIFT_VIEW({
              ...
              if (!this.chapter_view) {
                ...
                if (_chapter_view) {
                  this.chapter_view = _chapter_view.getComponent(_crd && ChapterGiftView === void 0 ? (_reportPossibleCrUseOfChapterGiftView({
                    error: Error()
            ...
            case (_crd && ACTIVITY_GIFT_VIEW === void 0 ? (_reportPossibleCrUseOfACTIVITY_GIFT_VIEW({
              ...
              if (!this.hand_view) {
                ...
                if (_hand_view) {
                  this.hand_view = _hand_view.getComponent(_crd && NewHandGiftView === void 0 ? (_reportPossibleCrUseOfNewHandGiftView({
                    error: Error()
                  }), NewHandGiftView) : NewHandGiftView);
                  this.currNode = _hand_view;
                  this.hand_view.onShow((_crd && MALLNAME === void 0 ? (_reportPossibleCrUseOfMALLNAME({
                    error: Error()
                  }), MALLNAME) : MALLNAME).NewPlayerMall);
                }
              } else {
            ...
            case (_crd && ACTIVITY_GIFT_VIEW === void 0 ? (_reportPossibleCrUseOfACTIVITY_GIFT_VIEW({
              ...
              if (!this.hand_view2) {
                ...
                if (_hand_view2) {
                  this.hand_view2 = _hand_view2.getComponent(_crd && NewHandGiftView === void 0 ? (_reportPossibleCrUseOfNewHandGiftView({
                    error: Error()
                  }), NewHandGiftView) : NewHandGiftView);
                  this.currNode = _hand_view2;
                  this.hand_view2.onShow((_crd && MALLNAME === void 0 ? (_reportPossibleCrUseOfMALLNAME({
                    error: Error()
        ...
        refreshChapterRed() {
          ...
          this.chapterMap.forEach((val, key) => {
            const local = Boolean((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
              error: Error()
