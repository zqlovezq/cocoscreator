    ...
    execute: function () {
      ...
      _export("FincaFightData", FincaFightData = (_dec = ccclass('FincaFightData'), _dec(_class = (_class2 = class FincaFightData extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
          ...
          for (let i = 0; i < this.heroIds.length; i++) {
            if (i !== this.HeroToggleIndex - 1) {
              ...
              if (_id) {
                ...
                const replaceHeroInfo = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
                  error: Error()
        ...
        getRewards(type, needSelf) {
          ...
          if (type === 2) {
            const tableData1 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        getUnLockLevel(index, isHero) {
          for (let i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const fincaTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        setBookData() {
          ...
          for (let i = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            const arr = [];
            const dict = this.boosDicTabs.get(i);
            ...
            if (this.bookList.has((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              const newArr = this.bookList.get((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
        ...
        checkAllBooks() {
          ...
          for (let i = 0; i < this.bookIds.length; i++) {
            ...
            const bookInfo = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
              error: Error()
            ...
            if (bookArr.indexOf(bookInfo) > -1) {
              ...
              // 当前秘籍已经不存在替换
              const dict = this.boosDicTabs.get(heroClass);
