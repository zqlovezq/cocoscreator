          ...
          if (EDITOR) {
            ...
            if (this.preload) {
              ...
              if (this._spriteFrame) {
                var assetInfo = (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
                  error: Error()
              ...
              var _assetInfo = (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
                error: Error()
              ...
              this.spr.setTexture(_assetInfo['path']);
            }
          }
        }
