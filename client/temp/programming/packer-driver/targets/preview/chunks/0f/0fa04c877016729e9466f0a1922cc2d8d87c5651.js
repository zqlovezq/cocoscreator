    ...
    execute: function () {
      ...
      _export("LoginScene", LoginScene = (_dec = ccclass('LoginScene'), _dec2 = property(Label), _dec(_class = (_class2 = class LoginScene extends (_crd && SceneBase === void 0 ? (_reportPossibleCrUseOfSceneBase({
        ...
        testPb() {
          ...
          var aa = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          ...
          console.log(aa);
          var unit8 = this.PbEncode(aa);
          console.log(unit8);
          var pb = this.decode((_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Ptl.LoginReq, unit8);
        }

        PbEncode(message) {
          var writer = message.constructor.encode(message);
