  ...
  return {
    ...
    execute: function () {
      ...
      _export("RogueBaseItem", RogueBaseItem = (_dec = ccclass('RogueBaseItem'), _dec(_class = class RogueBaseItem extends Component {
        ...
        setStar(star) {
          var recommend_node = this.node.getChildByName("recommend_node");
          ...
          var layout = recommend_node.getChildByName("layout");
          var hideNode = layout.getChildByName("high_node");
          var midNode = layout.getChildByName("mid_node");
          var lowNode = layout.getChildByName("low_node");
        ...
        showChoose() {
          var anim = this.node.children[0].getComponent(Animation);

          if (anim) {
            anim.play(anim.defaultClip.name);
          } else {
            if (this.node.children[0] && this.node.children[0].children[0]) {
              var weaponAnim = this.node.children[0].children[0].children[0].getComponent(Animation);
