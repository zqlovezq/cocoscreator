      ...
      _cjsLoader.define(__cjsMetaURL, function (exports, require, module, __filename, __dirname) {
        ...
        Root.prototype.load = function load(filename, options, callback) {
          ...
          function fetch(filename, weak) {
            filename = getBundledFileName(filename) || filename; // Skip if already loaded / attempted
        ...
        function tryHandleExtension(root, field) {
          ...
          if (extendedType) {
            var sisterField = new Field(field.fullName, field.id, field.type, field.rule, undefined, field.options); //do not allow to extend same field twice to prevent the error
...
//# sourceMappingURL=7279e1da3680bb6b06cced6d819d8b9c19307972.js.map