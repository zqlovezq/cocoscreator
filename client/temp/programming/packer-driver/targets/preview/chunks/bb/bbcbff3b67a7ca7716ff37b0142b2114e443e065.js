    ...
    execute: function () {
      ...
      _export("OpenFunctionMgr", OpenFunctionMgr = class OpenFunctionMgr extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        changeOpenFunctionDataByName(openFunc) {
          var obj = this._openMap.get(openFunc);
        ...
        pushOpenFunctionData(data) {
          for (var i = 0; i < data.length; i++) {
            ...
            var opTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
          ...
          if (obj && obj.name === openFunc && extra) {
            if (obj.isOpen) {
              ...
              if (openTab.Type == (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                var act = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
                  error: Error()
        ...
        checkExtraFunctionOpen(openFunc) {
          ...
          var BattleLv = openTab.BattleLv;
          var PlayerLv = openTab.PlayerLv;
          var CreateDay = openTab.CreateDay;
        ...
        showFunctionTips(openFunc) {
          ...
          var BattleLv = pveTab ? (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
            error: Error()
          }), LangMgr) : LangMgr).getLab(pveTab.StageName) : "";
          var PlayerLv = openTab.PlayerLv;
          var CreateDay = openTab.CreateDay;
          var Privileged = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
            error: Error()
          }), LangMgr) : LangMgr).getLab((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).PrivilegedType[openTab.Privileged]);
          var VipLv = openTab.VipLv;
          var tipsArr = [BattleLv, PlayerLv, CreateDay, VipLv, Privileged];
          var tips = "";
        ...
        checkFunctionRefresh(data) {
          ...
          for (var i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            var passTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().BattlePassTable[i];
            var openFuncName = passTab.OpenFunction;
