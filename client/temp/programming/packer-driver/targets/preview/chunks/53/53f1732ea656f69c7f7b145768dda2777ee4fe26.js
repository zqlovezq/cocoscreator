  ...
  return {
    ...
    execute: function () {
      ...
      _export("RankPop", RankPop = (_dec = ccclass('RankPop'), _dec2 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        changeRank(rankId) {
          if (rankId <= 5) {
            ...
            if (rankId === (_crd && RANKING_TYPE === void 0 ? (_reportPossibleCrUseOfRANKING_TYPE({
              ...
              _msg.rankId = (_crd && RANKING_TYPE === void 0 ? (_reportPossibleCrUseOfRANKING_TYPE({
                error: Error()
              }), RANKING_TYPE) : RANKING_TYPE).Fight;
              _msg.pageIndex = 0;
              _msg.pageSize = 30;
              (_crd && Net === void 0 ? (_reportPossibleCrUseOfNet({
                ...
                error: Error()
              }), proto) : proto).Ptl.GetSimpleRankReq, _msg);
            } else {
              var _msg2 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
                error: Error()
              ...
              (_crd && Net === void 0 ? (_reportPossibleCrUseOfNet({
                ...
                error: Error()
              }), proto) : proto).Ptl.GetRankReq, _msg2);
            }
          }
        }
        ...
        createTopItem() {
          for (var i = 0; i < 3; i++) {
            var parentNode = this.node_top_items.children[i];
            var item = null;
            ...
            var itemTs = item.getComponent(_crd && RankTopItem === void 0 ? (_reportPossibleCrUseOfRankTopItem({
              error: Error()
        ...
        createToggleItem() {
          ...
          if (this.openData) {
            var ts = this.node_toggle_content.getChildByName(String(this.openData)).getComponent(_crd && RankToggleItem === void 0 ? (_reportPossibleCrUseOfRankToggleItem({
              error: Error()
            }), RankToggleItem) : RankToggleItem);
            ts.onClickCheck(null, String(this.openData));
          } else {
            var _ts = this.node_toggle_content.getChildByName(String(arr[0])).getComponent(_crd && RankToggleItem === void 0 ? (_reportPossibleCrUseOfRankToggleItem({
              error: Error()
            }), RankToggleItem) : RankToggleItem);

            _ts.onClickCheck(null, String(arr[0]));
          }
        } // 创建自己的排行
        ...
        createMyRank() {
          ...
          if (this._ranking >= 0) {
            if (this._rankId < (_crd && RANKING_TYPE === void 0 ? (_reportPossibleCrUseOfRANKING_TYPE({
              ...
              // 英雄数据
              var rankData = allRank[this._ranking];
              this.setMyRank(rankData, this._ranking);
            } else {
              if (this._rankId === (_crd && RANKING_TYPE === void 0 ? (_reportPossibleCrUseOfRANKING_TYPE({
                error: Error()
              }), RANKING_TYPE) : RANKING_TYPE).GUILD) {
                var _rankData = allRank[this._ranking];
                this.setMyRank(_rankData, this._ranking);
              } else {
                // 个人数据
                var _rankData2 = allRank[this._ranking];
                this.setMyRank(_rankData2, this._ranking);
              }
            }
          } else {
            var _rankData3 = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
              error: Error()
            }), AssociationData) : AssociationData).ins.getAssocitionSimpleInfo();

            this.setMyRank(_rankData3, -1);
          }
        }
        ...
        createDataByRankId() {
          ...
          switch (this._rankId) {
            ...
            case 5:
              ...
              var itemData = (_crd && HeroTeamControl === void 0 ? (_reportPossibleCrUseOfHeroTeamControl({
                error: Error()
            ...
            case 9:
              ...
              var stageId = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
                error: Error()
              }), BattleMainDataControl) : BattleMainDataControl).ins.getCurFightStageId();
              var time = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
                error: Error()
        ...
        onClickGuild() {
          var rankData = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          }), AssociationData) : AssociationData).ins.getAssocitionSimpleInfo();
