  ...
  return {
    ...
    execute: function () {
      ...
      _export("RoleInfoChangeNamePop", RoleInfoChangeNamePop = (_dec = ccclass('RoleInfoChangeNamePop'), _dec2 = property({
        ...
        onShow() {
          var changeNameConfig = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        onClickOk() {
          ...
          var needDiamond = changeNameConfig[(_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          }), RoleData) : RoleData).ins.changeNameTimes >= 2 ? 2 : (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          }), RoleData) : RoleData).ins.changeNameTimes];
        ...
        cutoutNameLen() {
          var name = this.r_name.string;
          var bOverLimit = name.length > 7;
