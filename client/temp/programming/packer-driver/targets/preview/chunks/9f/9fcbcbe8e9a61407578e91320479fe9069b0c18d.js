    ...
    execute: function () {
      ...
      _export("SkillGroup", SkillGroup = (_dec = ccclass('SkillGroup'), _dec(_class = class SkillGroup {
        ...
        setConfigId(id) {
          ...
          for (var index = 0; index < this.configTab.NormalAttack.length; index++) {
            var element = this.configTab.NormalAttack[index];
        ...
        addSkill(id) {
          var skill = new (_crd && Skill === void 0 ? (_reportPossibleCrUseOfSkill({
            error: Error()
          }), Skill) : Skill)();
