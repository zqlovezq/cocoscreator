      ...
      _export("BattleMainEliteData", BattleMainEliteData = (_dec = ccclass('BattleMainEliteData'), _dec(_class = (_class2 = class BattleMainEliteData extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        */
        ...
        getPassChapterId() {
          ...
          var caleStageId = stageId - 100000;
        ...
        getReceiveFirstRewardById(id) {
          for (var i = 0; i < this.eliteStageInfo.receivedFirstRewardStageIds.length; i++) {
            var stageId = this.eliteStageInfo.receivedFirstRewardStageIds[i];
        ...
        getStageIsLock(id) {
          ...
          var passNormalStage = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
            error: Error()
          }), BattleMainDataControl) : BattleMainDataControl).ins.getPassChapterId();
          var isPassAll = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
            error: Error()
        ...
        getReceiveStageId() {
          // 通关副本
          var lastId = this.getLastStageId();
          var rewardIds = this.eliteStageInfo.receivedFirstRewardStageIds;

          if (rewardIds.length === 0) {
            return 100101;
          }

          var lastRewardId = rewardIds[rewardIds.length - 1];
