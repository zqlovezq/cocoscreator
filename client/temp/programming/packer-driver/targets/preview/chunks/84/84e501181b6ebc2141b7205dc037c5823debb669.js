    ...
    execute: function () {
      ...
      _export("VipPrivilegeView", VipPrivilegeView = (_dec = ccclass('VipPrivilegeView'), _dec2 = property(Sprite), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(ScrollView), _dec7 = property(Label), _dec8 = property(Node), _dec9 = property(Sprite), _dec10 = property(Sprite), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(ScrollView), _dec16 = property(ProgressBar), _dec17 = property(Label), _dec18 = property(UITransform), _dec19 = property(Prefab), _dec20 = property(Prefab), _dec21 = property(Node), _dec22 = property(Node), _dec(_class = (_class2 = class VipPrivilegeView extends (_crd && ComponentBase === void 0 ? (_reportPossibleCrUseOfComponentBase({
        ...
        initView() {
          ...
          var vipBonus = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().VipBonusTable;

          for (var key in vipBonus) {
            var list = this.vipBonusTabMap.get(vipBonus[key].VipLv);
        ...
        initVipBtn() {
          ...
          var vipTable = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().VipTableByVipLv.getValue(this.vipLevel);
          var showLevel = vipTable.ShowVipLv;
          ...
          for (var i = len; i >= 0; i--) {
            if (tables[i].VipLv <= showLevel) {
              var node = instantiate(this.vipBtnPrefab);
        ...
        setScrollPos() {
          var pos = this.currBtnItem.node.getPosition();
          var w = this.vipBtnScrollview.getComponent(UITransform).contentSize.width;
        ...
        initCurrVipView() {
          ...
          var currTable = this.currBtnItem.vipTable;
          ...
          for (var key in currTable.VipRewardIds) {
          ...
          for (var _key in this.privilegeItems) {
            this.privilegeItems[_key].node.active = false;
          }
          ...
          var currBonus = this.vipBonusTabMap.get(currTable.VipLv);

          var _loop = function _loop() {
            var item = _this.creatorPrivilegeItem(Number(_key2));

            item.node.active = true;
            var bouns = currBonus[_key2];
            var tips = "";
            ...
            if (bouns.VipBonus == (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              var value = Math.floor(bouns.AddValue / 360) / 10;
              tips = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
                error: Error()
              ...
              var _value = Math.floor(bouns.AddValue / 100);

              tips = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
                error: Error()
              }), LangMgr) : LangMgr).getCombineString((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).VipBonus[bouns.VipBonus], [_value]);
            } else {
              tips = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
                error: Error()
              }), LangMgr) : LangMgr).getCombineString((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            if (currTable.VipLv == 0) {
              ...
              var findTab = lastBonus.find(a => a.VipBonus == bouns.VipBonus);
        ...
        updateBuyState() {
          ...
          if (currTable.VipLv > this.vipLevel) {
            ...
            var isBuy = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
              error: Error()
        ...
        initProgress() {
          ...
          var lastVipTable = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().VipTableByVipLv.getValue(this.vipLevel - 1);
          var lastVipExp = lastVipTable ? lastVipTable.VipExp : 0;
          var VipExp = vipTable.VipExp - lastVipExp;
          ...
          if (this.vipLevel >= this.maxVipLevel) {
            ...
            var currScore = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
              error: Error()
            }), ItemData) : ItemData).ins.getCount((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).CurrencyType.CurrencyType_VipExp);
            var score = vipTable.VipExp - currScore;
            var score2 = currScore - lastVipExp;
            this.tipsLab.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
              error: Error()
        ...
        creatorPrivilegeItem(index) {
          ...
          if (!this.privilegeItems[index]) {
            var item = instantiate(this.privilegePrefab);
            item.parent = this.privilegeScrollView.content;
            var com = item.getComponent(_crd && VipPrivilegeItem === void 0 ? (_reportPossibleCrUseOfVipPrivilegeItem({
              error: Error()
        ...
        onClickBuyBtn() {
          if (this.isCanBuy) {
            ...
            if (currTable) {
              var id = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
                error: Error()
