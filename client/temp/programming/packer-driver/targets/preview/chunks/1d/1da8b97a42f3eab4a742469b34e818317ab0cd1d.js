  ...
  return {
    ...
    execute: function () {
      ...
      _export("FincaFightStageViewBook", FincaFightStageViewBook = (_dec = ccclass('FincaFightStageViewBook'), _dec2 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        initData() {
          for (var i = 0; i < this.teamToggleArray.length; i++) {
            var v = this.teamToggleArray[i];
          ...
          var _toggle = this.vocationToggleNode.getChildByName("Toggle" + this._vocationType).getComponent(Toggle);
        ...
        groupBookList() {
          var result = [];
          var bookList = (_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
            error: Error()
          }), FincaFightData) : FincaFightData).ins.getBookList().get(this._vocationType);

          for (var i = 0; i < bookList.length; i += this._lineHeroCount) {
