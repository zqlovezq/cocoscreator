      ...
      _export("CongratulationPop", CongratulationPop = (_dec = ccclass('CongratulationPop'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(ScrollView), _dec(_class = (_class2 = class CongratulationPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initData() {
          ...
          return _asyncToGenerator(function* () {
            _this._awardrMap.clear();

            _this.node_content.destroyAllChildren();

            var num = _this._list.length;
            _this._itemCount = 0;

            _this.createItem(_this._itemCount);

            if (num > 1) {
              _this.schedule(_this.popAnim, 1.5, num - 2);
            }
          })();
        }
        ...
        popAnim() {
          this._itemCount++;
          var posY = this.node_content.getPosition().y;
        ...
        createItem(count) {
          ...
          var itemTs = item.getComponent(_crd && CongratulationItem === void 0 ? (_reportPossibleCrUseOfCongratulationItem({
            error: Error()
        ...
        getRewardList() {
          ...
          for (var i = 0; i < this._rewards.length; i += this._lineHeroCount) {
