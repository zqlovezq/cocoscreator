  ...
  return {
    ...
    execute: function () {
      ...
      _export("CommonItem", CommonItem = (_dec = ccclass('CommonItem'), _dec2 = property(Button), _dec3 = property(Sprite), _dec4 = property(Sprite), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Node), _dec13 = property(Sprite), _dec14 = property(Sprite), _dec15 = property(Sprite), _dec(_class = (_class2 = class CommonItem extends Component {
        ...
        initData(data, isTouch, isConsume) {
          if (isTouch === void 0) {
            isTouch = true;
          }
        ...
        initView() {
          ...
          if (this.isConsume) {
            ...
            this.haveLab.string = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
              error: Error()
            }), GameUtil) : GameUtil).convertNumber(_itemData.num) + "";
            this.needLab.string = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
              error: Error()
            }), GameUtil) : GameUtil).convertNumber(_itemData.needNum, true) + "";

            if (Number(_itemData.num) >= Number(_itemData.needNum)) {
        ...
        onTouchItem() {
          ...
          if (this.touchCallBack) {
            ...
            if (type == (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              var isHero = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
        ...
        setPiece() {
          var _isBag = this.judgeIsBagView();

          var itemInfo = this.data;
          var quality = itemInfo.itemTable.Quality;
          var num = Number(itemInfo.num);
          this.pieceNode.active = true;
          var max = quality <= (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).ItemQuality.ItemQuality_Purple ? 30 : 50;
          var bar = this.pieceNode.getChildByName("piece_bar").getComponent(ProgressBar);
          bar.node.active = _isBag;
          bar.progress = num / max;
          var num_txt = bar.node.getChildByName("num_txt").getComponent(Label);
        ...
        setExtraPic() {
          var itemTab = this.data.itemTable;
          var LT = itemTab.MarkTopLeft;
          var LB = itemTab.MarkBottomLeft;
          var RT = itemTab.MarkTopRight;
