    ...
    execute: function () {
      ...
      _export("EquipMasterPop", EquipMasterPop = (_dec = ccclass('EquipMasterPop'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(Label), _dec15 = property(Node), _dec16 = property(Prefab), _dec17 = property(Toggle), _dec18 = property(Toggle), _dec19 = property(Toggle), _dec(_class = (_class2 = class EquipMasterPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initQualityView() {
          ...
          var level = this.currMasterInfo.qualityMasterLevel;
          this.levelLab.string = this.currMasterInfo.qualityMasterLevel + "";
          var nextHeroMasterTab = (_crd && EquipData === void 0 ? (_reportPossibleCrUseOfEquipData({
            error: Error()
          ...
          var minLevel = this.getMinLevel(1);
          ...
          if (nextHeroMasterTab) {
            ...
            var _level = nextHeroMasterTab.Level;
            this.qualityLvLab.string = (_crd && LangMgr === void 0 ? (_reportPossibleCrUseOfLangMgr({
              error: Error()
            }), LangMgr) : LangMgr).getLab("heromaster_desc_1000" + _level); // this.qualityMasterLab.string=nextHeroMasterTab.Level+"";
        ...
        initRefineView() {
          ...
          var level = this.currMasterInfo.refineMasterLevel;
          ...
          var minLevel = this.getMinLevel(3);
        ...
        initEnhanceView() {
          ...
          var level = this.currMasterInfo.enhanceMasterLevel;
          this.levelLab.string = level + "";
          var nextHeroMasterTab = (_crd && EquipData === void 0 ? (_reportPossibleCrUseOfEquipData({
            error: Error()
          }), EquipData) : EquipData).ins.getHeroMasterTableByTypeAndLevel((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
          ...
          var minLevel = this.getMinLevel(2);
        ...
        updateAtts(currMasterInfo, nextMasterInfo) {
          ...
          if (nextMasterInfo) {
            var _atts = nextMasterInfo.AttrList;

            for (var _key in _atts) {
              var _item = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).getData().EquipAttrTableById.getValue(_atts[_key]);

              var _info = attrMaps.get(_item.AttrType);

              if (_info) {
                _info.next += _item.Base;
              } else {
                _info = {
                  "value": 0,
                  "next": _item.Base
                };
                attrMaps.set(_item.AttrType, _info);
              }
            }
          }

          for (var _key2 in this.attrItemComs) {
            this.attrItemComs[_key2].node.active = false;
          }
