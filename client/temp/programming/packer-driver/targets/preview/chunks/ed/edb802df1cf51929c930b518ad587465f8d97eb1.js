    ...
    execute: function () {
      ...
      _export("RogueBookItem", RogueBookItem = (_dec = ccclass('RogueBookItem'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Node), _dec(_class = (_class2 = class RogueBookItem extends (_crd && RogueBaseItem === void 0 ? (_reportPossibleCrUseOfRogueBaseItem({
        ...
        setData(info) {
          ...
          if (info.heroItemId) {
            var nn = instantiate(this.heroPfb);
            ...
            var _nn = instantiate(this.RogueFullPfb);

            this.parentNode.addChild(_nn);
          } else {
            var _nn2 = instantiate(this.weaponPfb);

            this.parentNode.addChild(_nn2);
            ...
            _nn2.getComponent(_crd && WeaponInfoItem === void 0 ? (_reportPossibleCrUseOfWeaponInfoItem({
              error: Error()
