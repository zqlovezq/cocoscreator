        ...
        setConfigId(id) {
          ...
          for (var index = 0; index < this.Effect.length; index++) {
            if (this.skillPowers) {
              ...
              var data = (_crd && PowerTabFactory === void 0 ? (_reportPossibleCrUseOfPowerTabFactory({
                error: Error()
          ...
          if (this.Addbuff) {
            ...
            for (var _index = 1; _index < this.Addbuff.length; _index++) {
              var v = this.Addbuff[_index];
              ...
              if (this.skillPowers) {
                ...
                var _data = (_crd && PowerTabFactory === void 0 ? (_reportPossibleCrUseOfPowerTabFactory({
                  error: Error()
                }), PowerTabFactory) : PowerTabFactory).createType((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
                }), tab) : tab).PowerType.PowerType_BuffTable);

                _data.setConfigId(id);

                this.addBuffTabs.push(_data);
              }
            }
          }
        }
