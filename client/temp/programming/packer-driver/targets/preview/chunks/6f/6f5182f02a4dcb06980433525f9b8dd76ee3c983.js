    ...
    execute: function () {
      ...
      _export("BattleMainRewardPop", BattleMainRewardPop = (_dec = ccclass('BattleMainRewardPop'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Label), _dec(_class = (_class2 = class BattleMainRewardPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          ...
          var _chapterData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().MainChapterTableById.getValue(this.openData.chapterId);

          var idx = 0;

          for (var i = 0; i < _chapterData.StageIds.length; i++) {
          ...
          for (var _i = 0; _i < this._rewardTabData.Time.length; _i++) {
            this.createItem(_i);
          }
        }
        ...
        createItem(index) {
          var item = this.node_content.children[index];
          ...
          var itemTs = item.getComponent(_crd && BattleMainRewardItem === void 0 ? (_reportPossibleCrUseOfBattleMainRewardItem({
            error: Error()
