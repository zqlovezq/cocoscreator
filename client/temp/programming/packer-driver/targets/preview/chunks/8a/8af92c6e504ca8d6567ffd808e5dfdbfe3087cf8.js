      ...
      _export("GameplayControl", GameplayControl = (_dec = ccclass('GameplayControl'), _dec(_class = (_class2 = class GameplayControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        */
        ...
        on_red_EveryDayChallengeBoxReward() {
          ...
          var level = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
          ...
          var currScore = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
          }), GameplayViewDataMgr) : GameplayViewDataMgr).ins.dailyChallengeDataMsg.score;
          var requires = table.Require;
        ...
        on_red_TopWarChallengeFreeNum() {
          ...
          var num = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
