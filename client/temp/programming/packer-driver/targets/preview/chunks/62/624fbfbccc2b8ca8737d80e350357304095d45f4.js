System.register(["cc"], function (_export, _context) {
  ...
  function findChildNodeByName(pNode, strName, needActive) {
    if (needActive === void 0) {
      needActive = false;
    }
    ...
    for (var child of pNode.children) {
      var pChildFind = findChildNodeByName(child, strName, needActive);
