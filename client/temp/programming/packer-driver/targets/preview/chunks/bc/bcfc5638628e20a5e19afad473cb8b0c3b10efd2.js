  ...
  return {
    ...
    execute: function () {
      ...
      _export("BattleMainRewardItem", BattleMainRewardItem = (_dec = ccclass('BattleMainRewardItem'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property(Node), _dec(_class = (_class2 = class BattleMainRewardItem extends Component {
        ...
        setState() {
          this.node_content.destroyAllChildren();
          var rewardId = this._rewardTabData["RewardItemIds" + (this._idx + 1)];
          var rewardNum = this._rewardTabData["RewardItemNum" + (this._idx + 1)];
          var gotRewards = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
            error: Error()
          ...
          if (this._rewardTabData.Id > this._curStageId) {
            ...
            // 获取当前的时间
            var maxTime = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
              error: Error()
