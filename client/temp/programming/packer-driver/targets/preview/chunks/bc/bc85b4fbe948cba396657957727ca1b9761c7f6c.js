      ...
      _export("Func", Func = class Func {
        ...
        */
        ...
        static drawArc(r, angle, heading, parent, color, layer, newctx) {
          ...
          ctx.moveTo(0, 0);
          var v3 = (_crd && MathAngle === void 0 ? (_reportPossibleCrUseOfMathAngle({
            error: Error()
        ...
        static createSpine(path) {
          var nn = new Node("spine");
          var spineComp = nn.addComponent(sp.Skeleton);
          var spData = (_crd && ResMgr === void 0 ? (_reportPossibleCrUseOfResMgr({
            error: Error()
