  ...
  return {
    ...
    execute: function () {
      ...
      _export("EquipmentView", EquipmentView = (_dec = ccclass('EquipmentView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Sprite), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(_crd && ResourceItem === void 0 ? (_reportPossibleCrUseOfResourceItem({
        ...
        initView() {
          ...
          if (this.openData) {
            ...
            if (this.openData["equipInfo"]) {
              var equip = this.openData["equipInfo"];
        ...
        initHeroInfo() {
          var node = instantiate(this.heroPaintingPrefab);
          node.parent = this.heroNode;
          var com = node.getComponent(_crd && HeroBagPainting === void 0 ? (_reportPossibleCrUseOfHeroBagPainting({
            error: Error()
        ...
        updateStrengthCost() {
          var moneys = this.currWearEquipInfo.enhanceUpgradeTable.Moneys;
          var materials = this.currWearEquipInfo.enhanceUpgradeTable.Materials;
          var moneysCount = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          }), ItemData) : ItemData).ins.getCount(moneys[0]);
          var materialCount = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
        ...
        updateForgeCost() {
          ...
          var moneys = this.currWearEquipInfo.refineUpgradeTable.Moneys;
          var materials = this.currWearEquipInfo.refineUpgradeTable.Materials;
        ...
        updateBagEquipByType() {
          ...
          for (var key in this.currEquipDatas) {
          ...
          for (var _key in bagInfos) {
            var node = (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
              error: Error()
            }), ItemPoolMgr) : ItemPoolMgr).ins.createEquipItem(bagInfos[_key], this.bagContentNode);
            this.bagEquipNodes.push(node);
          }
        ...
        removeBagEquipItem() {
          if (this.bagEquipNodes) {
            for (var key in this.bagEquipNodes) {
              (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
                error: Error()
        ...
        onClickOnekeyStrengthen() {
          var currEquips = [];
          var list = this.heroPainting.currWearEquipDatas;
        ...
        */
        ...
        onDisable() {
          ...
          for (var node of this.forgeCostItemNode.children) {
            (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
              error: Error()
