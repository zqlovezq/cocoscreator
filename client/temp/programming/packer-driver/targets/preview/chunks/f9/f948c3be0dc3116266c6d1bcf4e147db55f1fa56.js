  ...
  return {
    ...
    execute: function () {
      ...
      _export("RookieTaskMgr", RookieTaskMgr = (_dec = ccclass('RookieTaskMgr'), _dec(_class = (_class2 = class RookieTaskMgr extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        initTask(msg) {
          var taskMap = msg.newPlayerTrialMap;
          ...
          for (var i = 0; i < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            ...
            var mallId = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        handleTask(ID, view, day, layer) {
          var opName1 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).OpenFunctionName.OpenFunctionName_ActivityNewPlayerTask;
          var opName2 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).OpenFunctionName.OpenFunctionName_ActivityNewPlayerTask2;
          var trialInfo1 = RookieTaskMgr.ins.getTrialTask(opName1);
          var trialInfo2 = RookieTaskMgr.ins.getTrialTask(opName2);
          var cur_day = -1;
          ...
          if (view < (_crd && TRIALTASK === void 0 ? (_reportPossibleCrUseOfTRIALTASK({
            ...
            var taskArr = newPlayerData['TaskIds' + view];
            ...
            var arr = this._mallMap.get(newPlayerData.MallId);

            var mallItemId = arr[0].Id;
            var maxCount = arr[0].LimitCount;
        ...
        checkIsRed(layer, day, view) {
          ...
          var data = (_this$stateToChange$l = this.stateToChange[layer]) != null ? _this$stateToChange$l : {};
          var isRed = false;
        ...
        red_score_red(type) {
          ...
          var data = RookieTaskMgr.ins.getTrialTask(openName);
          ...
          for (var i = 0; i < 6; i++) {
            ...
            var newPlayertrial = this.getTrialTask(newPlayerTaskTab.Group);
            var socre = newPlayertrial.score;
            var receiveIds = newPlayertrial.receivedScoreIds;
            var isGot = receiveIds.indexOf(scoreTab.Id) > -1;
