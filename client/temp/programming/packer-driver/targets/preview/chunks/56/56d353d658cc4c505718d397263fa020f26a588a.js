  ...
  return {
    ...
    execute: function () {
      ...
      _export("MonthlyCardView", MonthlyCardView = (_dec = ccclass('MonthlyCardView'), _dec2 = property(_crd && MonthlyCardItem === void 0 ? (_reportPossibleCrUseOfMonthlyCardItem({
        ...
        initView() {
          var table1 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var table2 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().MonthlyPassTableByType.getValue((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).PrivilegedType.PrivilegedType_PremiumMonthlyPass);
          this.cardItem2.initView(table2);
          var rewards = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().GetKeyValue_ConfigTable().MonthlyPassBothRewardItemIds;
          var nums = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        updateView() {
          ...
          var isMonthlyPass = false;

          if (msg.PrivilegeMap && msg.PrivilegeMap[(_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).PrivilegedType.PrivilegedType_MonthlyPass]) {
            var privileged = msg.PrivilegeMap[(_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).PrivilegedType.PrivilegedType_MonthlyPass];
            ...
            if ((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              ...
              var stage = privileged.isDailyReceived ? 2 : 1;
          ...
          var isPremiumMonthlyPass = false;

          if (msg.PrivilegeMap && msg.PrivilegeMap[(_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).PrivilegedType.PrivilegedType_PremiumMonthlyPass]) {
            var _privileged = msg.PrivilegeMap[(_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).PrivilegedType.PrivilegedType_PremiumMonthlyPass];

            if ((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
            }), RoleData) : RoleData).ins.getServerUtcTime() < _privileged.expireTime) {
              var _stage = _privileged.isDailyReceived ? 2 : 1;

              this.cardItem2.updateView(_stage, _privileged.expireTime);
