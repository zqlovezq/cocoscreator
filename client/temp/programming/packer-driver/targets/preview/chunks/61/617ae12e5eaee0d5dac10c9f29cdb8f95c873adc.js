  ...
  return {
    ...
    execute: function () {
      ...
      _export("CheckRoleInfoHeroPop", CheckRoleInfoHeroPop = (_dec = ccclass('CheckRoleInfoHeroPop'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Sprite), _dec6 = property(Sprite), _dec7 = property(Sprite), _dec8 = property(Label), _dec9 = property(Node), _dec10 = property(Prefab), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(sp.Skeleton), _dec15 = property(Node), _dec16 = property(Node), _dec17 = property(Node), _dec18 = property(Prefab), _dec(_class = (_class2 = class CheckRoleInfoHeroPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        showAttrData() {
          var itemId = this.heroData.itemId;
        ...
        showAttrSkill() {
          ...
          var skillMap = heroInfo.getHeroSkillMap();
        ...
        showAttrSimple() {
          ...
          for (var i = 0; i < this.heroData.attrList.length; i++) {
            var attr = this.heroData.attrList[i];
        ...
        updateEquipSlot() {
          ...
          this.equipComItems = [];
          var equals = this.heroData.equipList;

          for (var _key in equals) {
            if (equals[_key]) {
              var equal = equals[_key];

              var _EquipInfo = new (_crd && EquipInfo === void 0 ? (_reportPossibleCrUseOfEquipInfo({
                error: Error()
              }), EquipInfo) : EquipInfo)();
              ...
              var itemTs = node.getComponent(_crd && EquipmentItem === void 0 ? (_reportPossibleCrUseOfEquipmentItem({
                error: Error()
        ...
        updateBook() {
          ...
          var _loop = function _loop() {
            var bookData = _this.heroData.bookList[i];
            var bookInfo = new (_crd && RareBookInfo === void 0 ? (_reportPossibleCrUseOfRareBookInfo({
              error: Error()
            ...
            var item = instantiate(_this.pfb_small_book);
            item.parent = _this.node_book_content;
            var itemTs = item.getComponent(_crd && RareBookSmallItem === void 0 ? (_reportPossibleCrUseOfRareBookSmallItem({
              error: Error()
          ...
          for (var i = 0; i < this.heroData.bookList.length; i++) {
            _loop();
          }
        }
        /* 点击显示所有属性 */
