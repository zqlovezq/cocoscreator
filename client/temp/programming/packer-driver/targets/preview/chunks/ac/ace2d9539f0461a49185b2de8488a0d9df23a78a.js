    ...
    execute: function () {
      ...
      _export("WorldBossControll", WorldBossControll = class WorldBossControll extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        init() {
          ...
          if ((_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
            ...
            for (var index = 0; index < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (v.StageId == (_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
                ...
                var tempTab = new (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
            ...
            for (var _index = 0; _index < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().GuildBossPointTable.length; _index++) {
              var _v = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).getData().GuildBossPointTable[_index];

              if (_v.StageId == (_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
                error: Error()
              }), FightData) : FightData).ins.stageId) {
                this.tabs.push(_v);
              }
          ...
          for (var _index2 = 0; _index2 < (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().WorldBossDamTable.length; _index2++) {
            var _v2 = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().WorldBossDamTable[_index2];

            if (_v2.StageId == (_crd && FightData === void 0 ? (_reportPossibleCrUseOfFightData({
              error: Error()
            }), FightData) : FightData).ins.stageId) {
              this.buffTabs.push(_v2);
            }
          }
        ...
        checkLv() {
          ...
          for (var index = this.nowLv; index < this.tabs.length; index++) {
            var v = this.tabs[index];
        ...
        checkBuffLv() {
          ...
          for (var index = this.nowBuffLv; index < this.buffTabs.length; index++) {
            var v = this.buffTabs[index];
        ...
        addEffect(effectIds) {
          for (var index = 0; index < effectIds.length; index++) {
            var effectId = effectIds[index];
            var eff = (_crd && PowerTabFactory === void 0 ? (_reportPossibleCrUseOfPowerTabFactory({
              error: Error()
