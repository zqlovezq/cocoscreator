  ...
  return {
    ...
    execute: function () {
      ...
      _export("RareBookGroupPop", RareBookGroupPop = (_dec = ccclass('RareBookGroupPop'), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec(_class = (_class2 = class RareBookGroupPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initView() {
          var stab = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
            error: Error()
          ...
          if (stab) {
            ...
            for (var _key in stab.BookId) {
              var info = (_crd && RareBookData === void 0 ? (_reportPossibleCrUseOfRareBookData({
                error: Error()
              }), RareBookData) : RareBookData).ins.getBookInfoByItemId(stab.BookId[_key]);
              bookInfos.push(info);
              ...
              if (info.isLock) {
                for (var k2 in newgroupTabs) {
                  var starlevel = newgroupTabs[k2].Level;
            ...
            for (var _key2 in newgroupTabs) {
              var level = groupTabs[_key2].Level;
              var num = starMap.has(level) ? starMap.get(level) : 0;

              var _item = instantiate(this.titleItemPrefab);

              _item.parent = this.attrNode;
              ...
              _com.initData(newgroupTabs[_key2], num, total);
            }
          }
        }
