    ...
    execute: function () {
      ...
      _export("ServerChoosePop", ServerChoosePop = (_dec = ccclass('ServerChoosePop'), _dec2 = property(Label), _dec3 = property(ScrollView), _dec4 = property(Prefab), _dec(_class = (_class2 = class ServerChoosePop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          ...
          var reqParam = "uid=" + (_crd && LoginData === void 0 ? (_reportPossibleCrUseOfLoginData({
            error: Error()
        ...
        initView() {
          this.initServerItem();
          var myServerData = null;
          var myAreaId = (_crd && LoginData === void 0 ? (_reportPossibleCrUseOfLoginData({
            error: Error()
          }), LoginData) : LoginData).ins.default_area;

          for (var key in this.userServers) {
        ...
        initServerItem() {
          ...
          var list = this.currTag == 1 ? this.userServers : this.recommendServers;
