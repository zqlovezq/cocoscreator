      ...
      _export("HeroBagView", HeroBagView = (_dec = ccclass('HeroBagView'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        showAllHeros(isInit) {
          ...
          if (this._defaultView === VIEW_TYPE.HERO) {
            ...
            var bookTs = this.node_hero_book.getComponent(_crd && HeroBookView === void 0 ? (_reportPossibleCrUseOfHeroBookView({
              error: Error()
        ...
        groupHeroList() {
          ...
          if (heroInfo) {
            var classType = heroInfo.heroTable.Class;
            ...
            for (var i = 0; i < heroList.length; i += this._lineHeroCount) {
        ...
        showRadarData() {
          ...
          if (this._defaultView === VIEW_TYPE.HERO) {
            ...
            var itemId = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
              error: Error()
          ...
          if (tabData.RadarChart) {
            ...
            for (var i = 0; i < this.node_radar_txt.children.length; i++) {
              var txt = this.node_radar_txt.children[i].getComponent(Label);
        ...
        clickUpHeroBagCount() {
          ...
          var itemId = heroBagExpansion[0];
          var itemCount = heroBagExpansion[1];
          var bagCount = heroBagExpansion[2];
          var curHavaCount = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          ...
          if (this._defaultView === VIEW_TYPE.HERO) {
            ...
            if (this._bagVocationType === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (itemId) {
                ...
                var _heroList = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
                  error: Error()
                }), HeroDataControl) : HeroDataControl).ins.getBookHeroListByVocation(this._bagVocationType, true);

                (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
                  error: Error()
                }), HeroDataControl) : HeroDataControl).ins.refreshBookData(_heroList[0]);
              }
            } else {
              var _heroList2 = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
                error: Error()
              }), HeroDataControl) : HeroDataControl).ins.getBookHeroListByVocation(this._bagVocationType, true);

              (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
                error: Error()
              }), HeroDataControl) : HeroDataControl).ins.refreshBookData(_heroList2[0]);
            }
