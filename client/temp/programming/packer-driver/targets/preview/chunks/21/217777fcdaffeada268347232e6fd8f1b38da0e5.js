  ...
  return {
    ...
    execute: function () {
      ...
      (function (_FightMacro) {
        var MAX_CHANCE = _FightMacro.MAX_CHANCE = 10000;
        var MAX_HERO_COUNT = _FightMacro.MAX_HERO_COUNT = 5;
        var PERCENT = _FightMacro.PERCENT = 10000;
        var SECOND = _FightMacro.SECOND = 1000;

        var RolePosType = /*#__PURE__*/function (RolePosType) {
