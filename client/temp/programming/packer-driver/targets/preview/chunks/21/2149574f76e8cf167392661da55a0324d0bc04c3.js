    ...
    execute: function () {
      ...
      _export("HomeMainView", HomeMainView = (_dec = ccclass('HomeMainView'), _dec2 = property(Label), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Label), _dec7 = property(Label), _dec8 = property(Label), _dec9 = property(Label), _dec10 = property(Label), _dec11 = property(Sprite), _dec12 = property(Label), _dec13 = property(Label), _dec14 = property(ProgressBar), _dec15 = property(_crd && PlayerHeadItem === void 0 ? (_reportPossibleCrUseOfPlayerHeadItem({
        ...
        on_s2c_ItemChangePush(msg) {
          if (msg.updatedItems) {
            for (var i = 0; i < msg.updatedItems.length; i++) {
              var item = msg.updatedItems[i];
        ...
        updateExpBar() {
          ...
          var PlayerLvTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().PlayerLvTableByPlayerLv.getValue(playerLv);
          var curExpMax = PlayerLvTab.Exp;
          var ExpCount = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          ...
          if (playerLv > 1) {
            var lasExpMax = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        updateChapterData() {
          var curChapterId = (_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
            error: Error()
          }), BattleMainDataControl) : BattleMainDataControl).ins.getChapterId();
          var chapterData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        updatePrestige() {
          var taskInfo = (_crd && PrestigeData === void 0 ? (_reportPossibleCrUseOfPrestigeData({
            error: Error()
        ...
        updateChatMessage() {
          var info = (_crd && ChatData === void 0 ? (_reportPossibleCrUseOfChatData({
            error: Error()
          ...
          if (info) {
            ...
            var type = (_crd && ChatData === void 0 ? (_reportPossibleCrUseOfChatData({
              error: Error()
        ...
        updateHeroSpine(heroId) {
          if (heroId) {
            ...
            var _heroClass = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
              error: Error()
            }), HeroData) : HeroData).ins.getById(heroId).heroTable.Class;

            var _spine = this.node_spines.getChildByName("spine" + _heroClass).getComponent(sp.Skeleton);
            ...
            for (var i = 1; i <= teamInfo.length; i++) {
              var _heroId = teamInfo[i - 1].heroId;
              var heroInfo = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
                error: Error()
              }), HeroData) : HeroData).ins.getById(_heroId);
              var spine = this.node_spines.getChildByName("spine" + i).getComponent(sp.Skeleton);
              (_crd && createAnimation === void 0 ? (_reportPossibleCrUseOfcreateAnimation({
                error: Error()
        ...
        updateFirstRecharge() {
          ...
          if (this.firstRechargeBtnNode.active) {
            var table = (_crd && PayData === void 0 ? (_reportPossibleCrUseOfPayData({
              error: Error()
        ...
        on_s2c_ReceivePatrolRewardRsp(msg) {
          var startPatrolData = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
        ...
        updateTrial() {
          var allTrial = this.node_rookie_task_btn.getChildByName("common_img");
          var rookieTrial = this.node_rookie_task_btn.getChildByName("newhand_img");
          var advanceTrial = this.node_rookie_task_btn.getChildByName("advanced_img");
        ...
        updateTrialRed() {
          ...
          var red1 = (_crd && RookieTaskMgr === void 0 ? (_reportPossibleCrUseOfRookieTaskMgr({
            error: Error()
          ...
          var red2 = (_crd && RookieTaskMgr === void 0 ? (_reportPossibleCrUseOfRookieTaskMgr({
            error: Error()
          }), RookieTaskMgr) : RookieTaskMgr).ins.red_score_red((_crd && TRIALLAYER === void 0 ? (_reportPossibleCrUseOfTRIALLAYER({
            error: Error()
        ...
        jumpToChallenge() {
          if ((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            ...
            var jumpName = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
        ...
        checkOpenFuncPop() {
          var list = (_crd && OpenFunctionMgr === void 0 ? (_reportPossibleCrUseOfOpenFunctionMgr({
            error: Error()
        ...
        updateGiftBtn() {
          ...
          var nowDay = Math.floor(((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
          ...
          var heroNode = this.node_day_gift_btn.getChildByName("hero_img");
          var weaponNode = this.node_day_gift_btn.getChildByName("weapon_img");
          weaponNode.active = nowDay > 7;
          heroNode.active = !weaponNode.active;
          var Map = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
            error: Error()
        ...
        checkMainView() {
          ...
          if ((_crd && UIMgr === void 0 ? (_reportPossibleCrUseOfUIMgr({
            ...
            var openFirstRecharge = Boolean(Number((_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
              error: Error()
        ...
        on_s2c_BuyFixedShopCommodityRsp(msg) {
          ...
          var mallName = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        updateActivityRed() {
          ...
          var red_NewPlayerMall = newBoughtCount < mallItemTab.LimitCount && (_crd && MallDataMgr === void 0 ? (_reportPossibleCrUseOfMallDataMgr({
            error: Error()
          ...
          var red_NewPlayerMall2 = newBoughtCount2 < mallItemTab2.LimitCount && (_crd && MallDataMgr === void 0 ? (_reportPossibleCrUseOfMallDataMgr({
            error: Error()
          }), MallDataMgr) : MallDataMgr).ins.getFixedShopExpireTime((_crd && MALLNAME === void 0 ? (_reportPossibleCrUseOfMALLNAME({
            error: Error()
        ...
        refreshActivityGroup() {
          ...
          var content = this.node_activity_group.parent;
          ...
          var _loop = function _loop() {
            var info = groups[_i];
            var tabData = info.activityTable;
            var btnNode = null;

            if (_i === 0) {
              // 设置groupBtn
              btnNode = _this.node_activity_group;
            } else {
              btnNode = instantiate(_this.node_activity_group);
              btnNode.name = "ActivityGroup";
              content.addChild(btnNode);
            } // 增加红点


            var redDot = btnNode.getChildByName("redDot");
            var com = redDot.addComponent(_crd && RedComp === void 0 ? (_reportPossibleCrUseOfRedComp({
              error: Error()
            }), RedComp) : RedComp);
            com.redNode = redDot;
            var evet1 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            ...
            var evet2 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            }), RedEventComp) : RedEventComp)();
            ...
            var evet3 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            }), RedEventComp) : RedEventComp)();
            ...
            var evet4 = new (_crd && RedEventComp === void 0 ? (_reportPossibleCrUseOfRedEventComp({
              error: Error()
            }), RedEventComp) : RedEventComp)();
            ...
            if (info.isOpen()) {
              var _sp = btnNode.getComponent(Sprite);

              _sp.setTexture(tabData.ButtonIconUrl);
              ...
              var countDown = Number(info.endTime) - (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                error: Error()
              }), RoleData) : RoleData).ins.getServerUtcTime();
          ...
          var gachaUpData = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
            error: Error()
          }), ActivityData) : ActivityData).ins.getAllUpData();

          if (gachaUpData.length > 0) {
            var upActInfo = (_crd && ActivityData === void 0 ? (_reportPossibleCrUseOfActivityData({
              error: Error()
            }), ActivityData) : ActivityData).ins.getAllUpData()[0];
            var gachaUpTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
