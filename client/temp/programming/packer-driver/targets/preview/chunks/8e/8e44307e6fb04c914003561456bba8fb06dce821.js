    ...
    execute: function () {
      ...
      _export("FightBossBar", FightBossBar = (_dec = ccclass('FightBossBar'), _dec2 = property(_crd && FightBossBarItem === void 0 ? (_reportPossibleCrUseOfFightBossBarItem({
        ...
        onBoss_Dead_State() {
          ...
          for (var index = 0; index < this.doubleBars.length; index++) {
            var v = this.doubleBars[index];
            v.dead();
          }
        }
        ...
        updateValidBoss() {
          ...
          for (var _index = 0; _index < this.doubleBars.length; _index++) {
            var _v = this.doubleBars[_index];
          ...
          if (this.validBoss.length == 1) {
            ...
            for (var _index2 = 0; _index2 < this.doubleBars.length; _index2++) {
              var _v2 = this.doubleBars[_index2];

              _v2.setBoss(this.validBoss[_index2]);
            }
          }
        }
