  ...
  return {
    ...
    execute: function () {
      ...
      _export("FightRootControl", FightRootControl = (_dec = ccclass('FightRootControl'), _dec(_class = (_class2 = class FightRootControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        checkFightResult() {
          var roles = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
            error: Error()
        ...
        showFightResult() {
          ...
          var record = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
        ...
        update(dt) {
          ...
          if (this.isState(FightState.ing)) {
            ...
            for (var index = 0; index < this.iLen; index++) {
        ...
        exitFight() {
          ...
          this.rootView.scheduleOnce(() => {
            ...
            var uiRecycles = [_crd && DeadEffectUI === void 0 ? (_reportPossibleCrUseOfDeadEffectUI({
              error: Error()
            }), DeadEffectUI) : DeadEffectUI, _crd && EffectUI === void 0 ? (_reportPossibleCrUseOfEffectUI({
              error: Error()
            }), EffectUI) : EffectUI];

            for (var index = 0; index < uiRecycles.length; index++) {
              var v = uiRecycles[index];
              var effs = this.rootView.node.getComponentsInChildren(v.name);
              effs.forEach(v => {
        ...
        timeInMonster() {
          ...
          this.rootView.schedule(() => {
            ...
            var len = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
              error: Error()
            }), FrameControl) : FrameControl).ins.getObjList((_crd && AbsObjType === void 0 ? (_reportPossibleCrUseOfAbsObjType({
              error: Error()
