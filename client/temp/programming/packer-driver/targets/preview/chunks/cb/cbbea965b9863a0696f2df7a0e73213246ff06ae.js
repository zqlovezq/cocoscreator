  ...
  return {
    ...
    execute: function () {
      ...
      _export("CombineStarUpCellItem", CombineStarUpCellItem = (_dec = ccclass('CombineStarUpCellItem'), _dec2 = property(_crd && HeroItem === void 0 ? (_reportPossibleCrUseOfHeroItem({
        ...
        setFreeAward() {
          var _tab = this._tabData;
          var awardId = _tab.FreeRewardId;
          var awardCount = _tab.FreeRewardCount;
        ...
        setBuyAward() {
          ...
          for (var i = 0; i < _tab.RewardIds.length; i++) {
            var id = _tab.RewardIds[i];
            var count = _tab.RewardCount[i];
          ...
          var rechargeId = this._tabData.RechargeId;
        ...
        setBuyBtn() {
          // 设置剩余次数
          var buyCount = this._heroGrowData.boughtNotFreeRewardTimesMap[this._tabData.HeroStar];
          var remainTimes = this._tabData.LimitCount - buyCount;
          this.lbl_remain_times.string = String(remainTimes);
          var sp = this.btn_price.node.getComponent(Sprite);
