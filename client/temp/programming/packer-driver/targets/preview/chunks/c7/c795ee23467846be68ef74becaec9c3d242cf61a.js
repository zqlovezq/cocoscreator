    ...
    execute: function () {
      ...
      _export("HeroMaterialPop", HeroMaterialPop = (_dec = ccclass('HeroMaterialPop'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Label), _dec8 = property(Label), _dec(_class = (_class2 = class HeroMaterialPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          ...
          var mainHeroInfo = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
            error: Error()
          ...
          this.node_content.destroyAllChildren();
          var HeroMap = mainHeroInfo.getHerosByType(this.openData.type, this.openData.stepId, mainHeroInfo.getHerosMaterialMap());
          ...
          HeroMap.map.forEach((value, key) => {
            var commonTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
          ...
          if (heroArr.length > 0) {
            heroArr.sort((id1, id2) => {
              var heroInfo1 = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
                error: Error()
              }), HeroData) : HeroData).ins.getById(id1);
              var heroInfo2 = (_crd && HeroData === void 0 ? (_reportPossibleCrUseOfHeroData({
                error: Error()
              }), HeroData) : HeroData).ins.getById(id2);
              var heroTab1 = heroInfo1.heroTable;
              var heroTab2 = heroInfo2.heroTable;
              var itemTab1 = heroInfo1.itemTable;
              var itemTab2 = heroInfo2.itemTable;
          ...
          var totalArr = vocationArr.concat(AnyArr.concat(heroArr));
        ...
        createHeroItem(id) {
          ...
          var isSelect = Boolean(mainHeroInfo.getHerosMaterialById(id));
          var item = null;
          ...
          if (item) {
            ...
            ts.setTouchCallBack(() => {
              ...
              var select = ts.getSelect();

              var cb = function cb() {
                var obj = mainHeroInfo.getHerosMaterialById(id);
        ...
        createCommonItem(itemId, star, count) {
          ...
          var isSelect = Boolean(mainHeroInfo.getHerosMaterialById(itemId));
          var data = new (_crd && ItemInfo === void 0 ? (_reportPossibleCrUseOfItemInfo({
            error: Error()
          }), ItemInfo) : ItemInfo)();
          ...
          var ts = item.getComponent(_crd && CommonItem === void 0 ? (_reportPossibleCrUseOfCommonItem({
            error: Error()
          ...
          ts.setTouchCallBack(() => {
            /* 如果当前的item在别的type中已经存在 则返回 */
            var obj = mainHeroInfo.getHerosMaterialById(itemId);
