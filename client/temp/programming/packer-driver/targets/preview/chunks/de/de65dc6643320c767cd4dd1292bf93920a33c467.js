    ...
    execute: function () {
      ...
      _export("PaintingView", PaintingView = (_dec = ccclass('PaintingView'), _dec2 = property(Node), _dec3 = property(Prefab), _dec(_class = (_class2 = class PaintingView extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        on_s2c_UpgradeScrollPaintingStarRsp(msg) {
          ...
          if (msg.star > 5) {
            var addAttr = (_crd && HeroTeamControl === void 0 ? (_reportPossibleCrUseOfHeroTeamControl({
              error: Error()
        ...
        refreshListByVocation(heroClass, isActive, heroId) {
          ...
          for (var i = 0; i < list.length; i++) {
            var itemId = list[i];
            var item = this.node_content.children[i];
            ...
            item.active = true;
            var itemTs = item.getComponent(_crd && PaintingHeroItem === void 0 ? (_reportPossibleCrUseOfPaintingHeroItem({
              error: Error()
          ...
          if (this.node_content.children.length > list.length) {
            for (var j = list.length; j < this.node_content.children.length; j++) {
              var node = this.node_content.children[j];
              node.active = false;
            }
          }
        } // 点击切换页签
