    ...
    execute: function () {
      ...
      _export("HeroResolvePop", HeroResolvePop = (_dec = ccclass('HeroResolvePop'), _dec2 = property(Prefab), _dec3 = property(Prefab), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(Toggle), _dec7 = property(Node), _dec(_class = (_class2 = class HeroResolvePop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          ...
          var herosMap = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
            error: Error()
        ...
        setAllHerosSelect() {
          ...
          for (var i = 0; i < this.node_content.children.length; i++) {
            var _item = this.node_content.children[i];

            var ts = _item.getComponent(_crd && HeroItem === void 0 ? (_reportPossibleCrUseOfHeroItem({
              error: Error()
            }), HeroItem) : HeroItem);

            var heroInfo = this._ResolveHeros.get(Number(ts.heroInfo.id));
