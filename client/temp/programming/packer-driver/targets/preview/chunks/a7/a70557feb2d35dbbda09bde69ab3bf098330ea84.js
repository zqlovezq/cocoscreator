  ...
  return {
    ...
    execute: function () {
      ...
      _export("AssociationMainView", AssociationMainView = (_dec = ccclass('AssociationMainView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        setGuildSimpleInfo() {
          var guildData = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
            error: Error()
          ...
          if (guildData) {
            ...
            var memberCountInfo = (_crd && AssociationData === void 0 ? (_reportPossibleCrUseOfAssociationData({
              error: Error()
        ...
        showSmallTips(target, data) {
          ...
          var ts = this.node_small_tips.getComponent(_crd && AssociationOperatePop === void 0 ? (_reportPossibleCrUseOfAssociationOperatePop({
            error: Error()
          }), AssociationOperatePop) : AssociationOperatePop);
          ts.setData(data);
          var scrollViewMidY = this.list_view.node.getComponent(UITransform).height / 2;
          ...
          var distanceToCenter = viewPos.y + scrollViewMidY;
        ...
        setSignBtn() {
          ...
          var maxRemainSignCount = maxSignCount - signCount;
