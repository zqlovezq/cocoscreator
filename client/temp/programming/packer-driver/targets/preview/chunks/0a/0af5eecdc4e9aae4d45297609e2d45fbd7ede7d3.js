      ...
      _export("WaveTimeControl", WaveTimeControl = (_dec = ccclass('WaveTimeControl'), _dec(_class = (_class2 = class WaveTimeControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        checkNextPhase() {
          if (this.levelJson.levelPhase.phaseclearcondition == (_crd && PhaseclearType === void 0 ? (_reportPossibleCrUseOfPhaseclearType({
            ...
            //全部清除---
            var isDead = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
              error: Error()
            }), FrameControl) : FrameControl).ins.isAllDeadByObjType((_crd && AbsObjType === void 0 ? (_reportPossibleCrUseOfAbsObjType({
              error: Error()
            }), AbsObjType) : AbsObjType).enemy);
        ...
        addPhaseCount() {
          ...
          for (var index = 0; index <= this.nowPhaseIndex; index++) {
            var v = this.levelJson.phaseList[index];
        ...
        iFightUpdate(dt) {
          ...
          for (var index = this.Cycless.length - 1; index >= 0; index--) {
            var v = this.Cycless[index];
        ...
        updateSeconds() {
          ...
          var len = this.levelJson.levelPhase.times.length;

          for (var index = this.phaseTimeIndex; index < len; index++) {
            var v = this.levelJson.levelPhase.times[index];
        ...
        inLevelphaseTime(lpt) {
          ...
          if (lpt.isMonster()) {
            ...
            if (!lpt.isCyclesOver()) {
              ...
              for (var index = 1; index < lpt.count; index++) {
                this.inMonster(lpt);
              }
            }
