      ...
      _export("BuffControl", BuffControl = class BuffControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        checkSkillAddBuff(skill, attack, enemys) {
          if (skill.isHasBuff()) {
            ...
            for (var index = 0; index < skill.AddBuff.length; index++) {
        ...
        checkBulletAddBuff(bullet, owner, defanseAbs) {
          if (bullet.info.isHasAddBuff()) {
            ...
            for (var index = 0; index < bullet.info.configTab.AddBuff.length; index++) {
        ...
        buffToTrigger(buff) {
          if (buff && buff.isValid()) {
            var addRole = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
              error: Error()
            }), FrameControl) : FrameControl).ins.getObjById(buff.addOwner.objId);
            var ownerRole = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
              error: Error()
        ...
        removeBuffs(buffIds, absRole) {
          for (var index = 0; index < buffIds.length; index++) {
            var v = buffIds[index];
        ...
        addBuffEffectUI(buff, absRole) {
          if (buff.configTab.VFXID) {
            ...
            var buffUi = this.getBuffUI(absRole, buff.buffId);
        ...
        removeBuffEffectUI(buff, absRole) {
          ...
          if (buff.configTab.VFXID) {
            var list = this.getBuffUIsById(absRole);
        ...
        showTransferDamageUI() {
          var tdList = this.getTransferDamageGroup();
        ...
        onRolesBuffLayerNum(buff) {
          var absRole = buff.owner.abs;

          if (absRole.isRole()) {
            var maxNum = this.getBuffNumByObjType(absRole.objType, buff.configTab.BuffGroup);

            if (maxNum > 0) {
              var allRole = (_crd && FrameControl === void 0 ? (_reportPossibleCrUseOfFrameControl({
                error: Error()
              }), FrameControl) : FrameControl).ins.getObjList(absRole.objType);
              var tempBuff;

              for (var index = 0; index < allRole.length; index++) {
                var tmpRole = allRole[index];
                ...
                if (tempBuff && maxNum > tempBuff.ruleNumber) {
                  var diff = maxNum - tempBuff.ruleNumber;
        ...
        getBuffUIsById(abs) {
          var list = this.poolUis.get(abs.getBodyId());
        ...
        getBuffUI(abs, buffId) {
          var list = this.getBuffUIsById(abs);
        ...
        onTriggerEffect(buff) {
          ...
          var len = buff.configTab.addBuffTabs.length;

          if (len) {
            for (var index = 0; index < buff.configTab.addBuffTabs.length; index++) {
              if (buff.configTab == null) {
                break;
              }

              var v = buff.configTab.addBuffTabs[index];
          ...
          for (var _index = 0; _index < len; _index++) {
            ...
            var eff = buff.configTab.effectTabs[_index];
            ...
            switch (eff.EffectType) {
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_AttackHeal(buff, _index, eff);
                break;
              ...
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_BigHpHeal(buff, _index, eff);
                break;
              ...
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_BigHpSubHeal(buff, _index, eff);
                break;
              ...
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_NowHpSubHeal(buff, _index, eff);
                break;
              ...
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_TearEffect(buff, _index, eff);
                break;
              ...
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_AttackShield(buff, _index, eff);
                break;
              ...
              case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                (_crd && DamageCalculation === void 0 ? (_reportPossibleCrUseOfDamageCalculation({
                  error: Error()
                }), DamageCalculation) : DamageCalculation).buff_BigHpShield(buff, _index, eff);
                break;
            }
          }
        }
              ...
              if (tdList.length > 1) {
                for (var index = 0; index < tdList.length; index++) {
                  ...
                  if (absRoleInfo.abs != v && v.isActive && !v.isDead) {
                    var copyData = (_crd && DamageData === void 0 ? (_reportPossibleCrUseOfDamageData({
                      error: Error()
