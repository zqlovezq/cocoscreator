    ...
    execute: function () {
      ...
      _export("LoginControl", LoginControl = class LoginControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        login(uid, token, params) {
          ...
          var svcReviewGroup = (_crd && LoginData === void 0 ? (_reportPossibleCrUseOfLoginData({
            error: Error()
          }), LoginData) : LoginData).ins.loginServerTab.ReviewSvcGroup;
          var svcGroup = (_crd && LoginData === void 0 ? (_reportPossibleCrUseOfLoginData({
            error: Error()
          }), LoginData) : LoginData).ins.loginServerTab.SvcGroup;
          var channel = (_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
            error: Error()
          }), Global) : Global).channelType;
          var password = (_crd && LoginData === void 0 ? (_reportPossibleCrUseOfLoginData({
            error: Error()
          ...
          var reqParam = "uid=" + uid + "&token=" + token + "&platform=" + (_crd && Global === void 0 ? (_reportPossibleCrUseOfGlobal({
            error: Error()
        ...
        createRole(nickName) {
          var _prefixArr = [];
          var _suffixArr = [];
          var prefixSuffixTable = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().RandomNameTable;

          for (var i = 0; i < prefixSuffixTable.length; i++) {
            var data = prefixSuffixTable[i];
          ...
          var prefixRdm = Math.floor(Math.random() * _prefixArr.length);
          var suffixRdm = Math.floor(Math.random() * _suffixArr.length);
        ...
        on_s2c_Pong(msg) {
          var param = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
