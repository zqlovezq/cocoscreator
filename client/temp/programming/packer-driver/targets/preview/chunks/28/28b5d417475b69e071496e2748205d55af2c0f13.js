    ...
    execute: function () {
      ...
      _export("MonsterControl", MonsterControl = (_dec = ccclass('MonsterControl'), _dec(_class = (_class2 = class MonsterControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        addMonsterByLevelPhaseTime(data) {
          ...
          var monsterInfo = (_crd && AbsObjFactory === void 0 ? (_reportPossibleCrUseOfAbsObjFactory({
            error: Error()
          ...
          if (data.isRand) {
            var rand = (_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
              error: Error()
        ...
        randomPos(data, randPos, out) {
          var pos = data.position[randPos];
          var blockTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        addMonster(info, initPos) {
          var enemy = (_crd && AbsObjFactory === void 0 ? (_reportPossibleCrUseOfAbsObjFactory({
            error: Error()
