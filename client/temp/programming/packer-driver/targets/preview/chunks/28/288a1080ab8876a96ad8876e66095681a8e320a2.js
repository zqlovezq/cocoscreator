  ...
  return {
    ...
    execute: function () {
      ...
      _export("FriendPop", FriendPop = (_dec = ccclass('FriendPop'), _dec2 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        updateFriendNum() {
          var currNum = (_crd && FriendData === void 0 ? (_reportPossibleCrUseOfFriendData({
            error: Error()
        ...
        onClickGetValue() {
          ...
          if (currNum <= max) {
            var infos = (_crd && FriendData === void 0 ? (_reportPossibleCrUseOfFriendData({
              error: Error()
        ...
        onClickAllRefuse() {
          if (this.currType == (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            ...
            for (var key in this.friendItemInfos) {
        ...
        onClickRefresh() {
          var tiemr = new Date().getTime();
          var t = Math.floor((tiemr - this.lastRefreshTimer) / 1000);
