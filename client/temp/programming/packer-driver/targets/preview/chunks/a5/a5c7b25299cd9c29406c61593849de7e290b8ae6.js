    ...
    execute: function () {
      ...
      _export("RareBookLevelPreviewPop", RareBookLevelPreviewPop = (_dec = ccclass('RareBookLevelPreviewPop'), _dec2 = property(_crd && RareBookSmallItem === void 0 ? (_reportPossibleCrUseOfRareBookSmallItem({
        ...
        initView() {
          ...
          var level = this.currInfo.isLock ? this.currInfo.star : 0;

          for (var _key in allStarTabls) {
            if (allStarTabls[_key].Description && allStarTabls[_key].Description != "") {
              ...
              item.getComponent(_crd && RareBookLevelPreviewPopItem === void 0 ? (_reportPossibleCrUseOfRareBookLevelPreviewPopItem({
                error: Error()
              }), RareBookLevelPreviewPopItem) : RareBookLevelPreviewPopItem).initData(allStarTabls[_key], allStarTabls[_key].Level <= level);
            }
          }
        }
