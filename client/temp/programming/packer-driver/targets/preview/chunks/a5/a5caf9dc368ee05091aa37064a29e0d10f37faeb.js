    ...
    execute: function () {
      ...
      _export("ItemControl", ItemControl = class ItemControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        on_s2c_Msg_ItemChangePush(msg) {
          ...
          for (var index = 0; index < msg.removedItems.length; index++) {
            var v = msg.removedItems[index];
            var itemType = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
          ...
          if (msg.updatedSingleItems.length > 0) {
            for (var i = 0; i < msg.updatedSingleItems.length; i++) {
              var itemId = msg.updatedSingleItems[i].itemId;
              ...
              if (itemTab.Type === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                ...
                var clientData = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                  error: Error()
                ...
                var _clientData = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                  error: Error()
                }), RoleData) : RoleData).ins.clientData["newHeadFrame"];

                if (_clientData) {
                  if (_clientData.indexOf("" + itemId) === -1) {
                    (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                      error: Error()
                    }), RoleData) : RoleData).ins.setClientData("newHeadFrame", _clientData + "," + itemId);
                  }
                } else {
                  (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                    error: Error()
        ...
        addTestData() {
          var tests = [];
          var item = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item.itemId = 20001;
          item.num = 20;
          tests.push(item);
          var item2 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item2.itemId = 20002;
          item2.num = 20;
          tests.push(item2);
          var item3 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item3.itemId = 20003;
          item3.num = 5;
          tests.push(item3);
          var item4 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item4.itemId = 20004;
          item4.num = 1;
          tests.push(item4);
          var item5 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item5.itemId = 20009;
          item5.num = 1;
          tests.push(item5);
          var item6 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item6.itemId = 20008;
          item6.num = 1;
          tests.push(item6);
          var item7 = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            error: Error()
          }), proto) : proto).Item();
          item7.itemId = 20010;
          item7.num = 1;
        ...
        on_Red_BagCompose() {
          ...
          for (var value of itemList) {
            ...
            if (bagType == (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              var needNum = value.itemTable.DropId[0];
        ...
        red_hero_Bag() {
          ...
          for (var value of itemList) {
            var bagType = value.itemTable.BagType;
            var itemType = value.itemTable.Type;
