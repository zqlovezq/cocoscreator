    ...
    execute: function () {
      ...
      _export("AssociationLogPop", AssociationLogPop = (_dec = ccclass('AssociationLogPop'), _dec2 = property(Prefab), _dec3 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        getCellHeight(idx) {
          ...
          var len = (_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
            error: Error()
          }), Func) : Func).getStrZhLen(str);
          var wid = Math.floor(len / 22) * 45 + 45;
          return wid;
        }
        ...
        getCellView(idx, identifer) {
          var cell = instantiate(this.pfb_item).getComponent(_crd && AssociationLogItem === void 0 ? (_reportPossibleCrUseOfAssociationLogItem({
            error: Error()
