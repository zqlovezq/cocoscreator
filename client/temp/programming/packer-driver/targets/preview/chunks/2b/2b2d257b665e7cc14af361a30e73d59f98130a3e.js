  ...
  return {
    ...
    execute: function () {
      ...
      _export("EveryDayChallengeHelpPop", EveryDayChallengeHelpPop = (_dec = ccclass('EveryDayChallengeHelpPop'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Label), _dec6 = property(Label), _dec(_class = (_class2 = class EveryDayChallengeHelpPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        onShow() {
          // let 
          var currLevel = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
          ...
          for (var key in currTable.DropId) {
            var arr = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
              error: Error()
          ...
          for (var _key in rewards1) {
            (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
              error: Error()
            }), ItemPoolMgr) : ItemPoolMgr).ins.createRewadItem(rewards1[_key], this.currContent);
          }
          ...
          if (nextTable) {
            ...
            for (var _key2 in nextTable.DropId) {
              var _arr = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
                error: Error()
              }), GameUtil) : GameUtil).getRewardsByDropId(nextTable.DropId[_key2]);

              rewards2 = (_crd && GameUtil === void 0 ? (_reportPossibleCrUseOfGameUtil({
                error: Error()
              }), GameUtil) : GameUtil).itemsAddItems(rewards2, _arr);
            }

            for (var _key3 in rewards2) {
              (_crd && ItemPoolMgr === void 0 ? (_reportPossibleCrUseOfItemPoolMgr({
                error: Error()
              }), ItemPoolMgr) : ItemPoolMgr).ins.createRewadItem(rewards2[_key3], this.nextContent);
            }
          } else {
