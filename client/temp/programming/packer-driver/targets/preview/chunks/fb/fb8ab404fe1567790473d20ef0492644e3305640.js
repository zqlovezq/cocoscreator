  ...
  return {
    ...
    execute: function () {
      ...
      _export("WeaponPop", WeaponPop = (_dec = ccclass('WeaponPop'), _dec2 = property([Node]), _dec3 = property([Node]), _dec4 = property([Node]), _dec5 = property(ProgressBar), _dec6 = property(_crd && WeaponInfoItem === void 0 ? (_reportPossibleCrUseOfWeaponInfoItem({
        ...
        initView() {
          var currTab = this.boosDicTabs.get(this.currTag);
          this.updateItem(this.toggles1[0], currTab.PhaseOneBook, false);

          for (var key in currTab.PhaseTwoBook) {
            this.updateItem(this.toggles2[key], currTab.PhaseTwoBook[key], false);
          }

          var allLock = true;

          for (var _key in currTab.PhaseThreeBook) {
            var isLock = this.updateItem(this.toggles3[_key], currTab.PhaseThreeBook[_key], true, true);
        ...
        updateItem(item, bookId, isShowLock, isShowRedPoint) {
          if (isShowRedPoint === void 0) {
          ...
          var com = weaponItem.getComponent(_crd && WeaponItem === void 0 ? (_reportPossibleCrUseOfWeaponItem({
            error: Error()
          }), WeaponItem) : WeaponItem);
