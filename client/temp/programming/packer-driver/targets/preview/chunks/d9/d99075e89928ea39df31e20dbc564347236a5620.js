    ...
    execute: function () {
      ...
      _export("FightRootView", FightRootView = (_dec = ccclass('FightRootView'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Sprite), _dec5 = property(Node), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Node), _dec16 = property(Node), _dec(_class = (_class2 = class FightRootView extends (_crd && ViewScreen === void 0 ? (_reportPossibleCrUseOfViewScreen({
        ...
        onFight_Drop_Item(dropItemId, position) {
          var dropItem = (_crd && DropItem === void 0 ? (_reportPossibleCrUseOfDropItem({
            error: Error()
        ...
        onFight_Drop_Item_Anim(animId, position) {
          var nn = (_crd && EffectUI === void 0 ? (_reportPossibleCrUseOfEffectUI({
            error: Error()
        ...
        onHit_Effect_Add(hitEffect, startPos, targetPos) {
          for (var index = 0; index < hitEffect.length; index++) {
            var hitType = hitEffect[index];
            var hitAnimId = hitEffect[index + 1];
            var nn = (_crd && EffectUI === void 0 ? (_reportPossibleCrUseOfEffectUI({
              error: Error()
            }), EffectUI) : EffectUI).create();
            ...
            if (hitType == 1) {
              ...
              var lengthSqr = Vec3.distance(startPos, targetPos);
              nn.run(hitAnimId);
        ...
        onadd_DeadEffect(abs) {
          var nn = (_crd && DeadEffectUI === void 0 ? (_reportPossibleCrUseOfDeadEffectUI({
            error: Error()
        ...
        onremove_DeadEffect(abs) {
          var list = this.bulletHitEffect.getComponentsInChildren(_crd && DeadEffectUI === void 0 ? (_reportPossibleCrUseOfDeadEffectUI({
            error: Error()
        ...
        onCreate_HoldTime_Effect(abs) {
          var nn = (_crd && HoldTimeEffectUI === void 0 ? (_reportPossibleCrUseOfHoldTimeEffectUI({
            error: Error()
        ...
        onBuff_link(roles) {
          ...
          for (var i = 0; i < roles.length; i++) {
            ...
            if (next) {
              var nn = new Node("link");
              var uitrans = nn.addComponent(UITransform);
              nn.layer = Layers.Enum.DEFAULT;
              nn.parent = this.linkNode;
              uitrans.anchorX = 0;
              var spr = nn.addComponent(Sprite);
        ...
        getRendderCout() {
          ...
          for (var index = 0; index < this.rootNode.children.length; index++) {
            var v = this.rootNode.children[index];
