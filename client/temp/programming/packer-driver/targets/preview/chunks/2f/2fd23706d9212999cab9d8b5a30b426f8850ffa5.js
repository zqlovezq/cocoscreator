  ...
  return {
    ...
    execute: function () {
      ...
      _export("HeroStarSpecialPop", HeroStarSpecialPop = (_dec = ccclass('HeroStarSpecialPop'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Sprite), _dec6 = property(Label), _dec7 = property(Label), _dec(_class = (_class2 = class HeroStarSpecialPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initData() {
          ...
          if (this.node_show.active) {
            for (var i = 0; i < starTab.HeroStarUpType.length; i++) {
              ...
              var item = instantiate(this.pfb_hero_material);
              item.name = "item" + type;
              ...
              item.active = true;
              var itemTs = item.getComponent(_crd && HeroMaterialItem === void 0 ? (_reportPossibleCrUseOfHeroMaterialItem({
                error: Error()
        ...
        clickHeroStarStepUp() {
          var MaterialEnough = this._heroInfo.checkStarUpMaterialEnough(this._step);
          ...
          map.forEach((value, key) => {
            ...
            for (var _i = 0; _i < upStarCosts.length; _i++) {
              if (value.type === upStarCosts[_i].costType) {
                heroCost = upStarCosts[_i];
              }
            }
            ...
            if (value.itemId) {
              if (costItems.length > 0) {
                ...
                for (var _i2 = 0; _i2 < costItems.length; _i2++) {
                  if (costItems[_i2].itemId === value.itemId) {
                    hasItemIndex = _i2;
                  }
                }
