    ...
    execute: function () {
      ...
      _export("BattlePassItemCell", BattlePassItemCell = (_dec = ccclass('BattlePassItemCell'), _dec2 = property([_crd && CommonItem === void 0 ? (_reportPossibleCrUseOfCommonItem({
        ...
        UpdateContent(data) {
          ...
          var passBattleId = data.battleId;
          ...
          var rewards = taskTab.RewardItemIds.concat(taskTab.BattlePassRewardIds);
          var nums = taskTab.RewardItemNum.concat(taskTab.BattlePassRewardNum);
          ...
          var finishParam = taskTab.FinishParam1;
          ...
          for (var i = 0; i < this.items.length; i++) {
            ...
            item.initData(award);
            var node_can_get = item.node.parent.getChildByName("canget_node");
            ...
            if (node_can_get.active) {
              item.setTouchCallBack(() => {
                var result = (_crd && BattlePassDataMgr === void 0 ? (_reportPossibleCrUseOfBattlePassDataMgr({
                  error: Error()
