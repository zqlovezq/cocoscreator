  ...
  return {
    ...
    execute: function () {
      ...
      _export("AdMgr", AdMgr = class AdMgr {
        ...
        init() {
          var advData = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
            error: Error()
        ...
        playVideoAd(type, callBack, isSendMsg, failCallback) {
          if (isSendMsg === void 0) {
            isSendMsg = false;
          }
          ...
          //处理sdk播放逻辑 
          var maxCount = this.getAdCountMaxByType(type);
        ...
        getAdCountMaxByType(type) {
          var AdTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
