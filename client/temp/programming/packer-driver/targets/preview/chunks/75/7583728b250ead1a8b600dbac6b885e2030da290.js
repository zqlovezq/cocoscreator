    ...
    execute: function () {
      ...
      _export("CombineActivityMainView", CombineActivityMainView = (_dec = ccclass('CombineActivityMainView'), _dec2 = property(Node), _dec3 = property(Prefab), _dec4 = property(Prefab), _dec5 = property(Prefab), _dec6 = property(Prefab), _dec7 = property(Prefab), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Label), _dec12 = property(Label), _dec13 = property(Sprite), _dec14 = property(Label), _dec15 = property(Node), _dec(_class = (_class2 = class CombineActivityMainView extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
            ...
            if (_this.openData === info.TabId) {
              ...
              var timeUpdate = () => {
                ...
                if (countDown <= 0) {
                  ...
                  _this.lbl_time.string = (_crd && setTextTime === void 0 ? (_reportPossibleCrUseOfsetTextTime({
                    error: Error()
        ...
        switchView(activityId) {
          ...
          var view_type = activityInfo.Type;
          ...
          switch (view_type) {
            ...
            case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (!this["view" + activityId]) {
                var hero_grow_layer = instantiate(this.pfb_hero_grow);
            ...
            case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (!this["view" + activityId]) {
                var battleLayer = instantiate(this.pfb_battle_pass);
              ...
              var battleData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
            ...
            case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (!this["view" + activityId]) {
                var mallLayer = instantiate(this.pfb_up_mall);
              ...
              var mallData = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
            ...
            case (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              if (!this["view" + activityId]) {
                var rechargeLayer = instantiate(this.pfb_recharge);
        ...
        showHeroSpine(animationId) {
          ...
          var heroId = Number(String(animationId).slice(0, 4));
          ...
          var sp_quality_star_bg = this.node_quality.getChildByName("quality2_img").getComponent(Sprite);
          var sp_quality = this.node_quality.getChildByName("quality_icon").getComponent(Sprite);
          var sp_quality_bg = this.node_quality.getChildByName("quality1_img").getComponent(Sprite);
