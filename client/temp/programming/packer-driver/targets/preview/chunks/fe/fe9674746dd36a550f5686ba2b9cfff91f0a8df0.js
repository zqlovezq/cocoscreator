System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3", "__unresolved_4", "__unresolved_5", "__unresolved_6", "__unresolved_7", "__unresolved_8", "__unresolved_9", "__unresolved_10", "__unresolved_11", "__unresolved_12"], function (_export, _context) {
  ...
  function IsInFightScene() {
    ...
    if (scene.name != "FightScene") {
      ...
      var rookie = scene.getComponentInChildren(_crd && FightScene === void 0 ? (_reportPossibleCrUseOfFightScene({
        error: Error()
  ...
  function IsInMainScene() {
    ...
    if (scene.name != "MainScene") {
      ...
      var rookie = scene.getComponentInChildren(_crd && MainScene === void 0 ? (_reportPossibleCrUseOfMainScene({
        error: Error()
      }), MainScene) : MainScene);
  ...
  function WaitSceneLoaded(sceneName, callback) {
    var checkFunc = function checkFunc(name) {
      if (sceneName == name) {
  ...
  return {
    ...
    execute: function () {
      ...
      _export("GuideCommand", GuideCommand = (_dec = ccclass('GuideCommand'), _dec(_class = class GuideCommand {
        ...
        static ReviveHero() {
          return /*#__PURE__*/_asyncToGenerator(function* (guide, args, callback) {
        ...
        static RunComic() {
          return /*#__PURE__*/_asyncToGenerator(function* (guide, args, callback) {
            var parentNode = guide.node.getChildByName('dialogudeNode');
        ...
        static Anim() {
          return /*#__PURE__*/_asyncToGenerator(function* (guide, args, callback) {
            var parentNode = guide.node.getChildByName('dialogudeNode');
            var GuideShowNode = parentNode.getChildByName("GuideShow");

            if (!GuideShowNode) {
              var GuideShow = yield (_crd && LoadResAsync === void 0 ? (_reportPossibleCrUseOfLoadResAsync({
                error: Error()
            ...
            var anim = GuideShowNode.getComponent(Animation);
        ...
        static dialogueFunc(modal) {
          return /*#__PURE__*/_asyncToGenerator(function* (guide, args, callback) {
            var parentNode = guide.node.getChildByName('dialogudeNode');
            var dialogueNode = parentNode.getChildByName("GuideDialogue");

            if (!dialogueNode) {
              var dialoguePre = yield (_crd && LoadResAsync === void 0 ? (_reportPossibleCrUseOfLoadResAsync({
                error: Error()
            ...
            var dialogue = dialogueNode.getComponent(_crd && GuideDialogue === void 0 ? (_reportPossibleCrUseOfGuideDialogue({
              error: Error()
        ...
        static ClickAnywhere(guide, args, callback) {
          ...
          guideNode.once(Node.EventType.TOUCH_END, event => {
            if (args === "CreateBullet") {
              ...
              var bulletTab = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
                error: Error()
        ...
        static clickFunc(fingerActive, holeActive, clickAnyWhere, coercive, isCircle) {
          if (coercive === void 0) {
            coercive = true;
          }
          ...
          return function (guide, args, callback) {
            ...
            guide.find(args, (node, error) => {
              ...
              var touchNode = clickAnyWhere ? guide.node : node; // guide.setFingerNodeOffsetX(0);
              //手指动画
              ...
              touchNode.once(Node.EventType.TOUCH_END, event => {
                ...
                if (args === "FightRootView/rootNode/objects/Monster") {
                  var pos = node.getComponent(UITransform).convertToWorldSpaceAR(node.position);
