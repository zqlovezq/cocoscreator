  ...
  return {
    ...
    execute: function () {
      ...
      _export("FincaFightStageViewHero", FincaFightStageViewHero = (_dec = ccclass('FincaFightStageViewHero'), _dec2 = property(_crd && InfiniteList === void 0 ? (_reportPossibleCrUseOfInfiniteList({
        ...
        checkEmpty() {
          var _emptyIndex = (_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
            error: Error()
          ...
          if (_emptyIndex) {
            ...
            var _toggle = this.teamToggleArray[_emptyIndex - 1].node.getComponent(Toggle);
        ...
        initData() {
          ...
          for (var i = 0; i < this.teamMembersArray.length; i++) {
            var v = this.teamMembersArray[i];
            v.setData(i);
            this.teamPosArr.push(v.node.getPosition());
          }

          for (var _i = 0; _i < this.teamToggleArray.length; _i++) {
            var _v = this.teamToggleArray[_i];
        ...
        onTouchBegan(event) {
          ...
          for (var i = 0; i < this.boundingBoxArray.length; i++) {
            var v = this.boundingBoxArray[i];
            var areaId = Number(v.name);
        ...
        onTouchMoved(event) {
          ...
          var touchMovePos = this.touch_transform.convertToNodeSpaceAR((_crd && AmendmentEventLocation === void 0 ? (_reportPossibleCrUseOfAmendmentEventLocation({
            error: Error()
          }), AmendmentEventLocation) : AmendmentEventLocation)(new Vec3(event.getUILocation().x, event.getUILocation().y, 0)));
        ...
        onTouchEnded(event) {
          ...
          var endPos = this.touch_transform.convertToNodeSpaceAR((_crd && AmendmentEventLocation === void 0 ? (_reportPossibleCrUseOfAmendmentEventLocation({
            error: Error()
          ...
          var distPos = this._touchHeroPos.subtract(endPos);

          var dist = distPos.length();
        ...
        temporaryExchangeHero() {
          if (this.checkEnterArea() > 0) {
            var v = this.teamMembersArray[this.checkEnterArea() - 1].node;
            ...
            if (this._tempNode) {
              var tempNodeIndex = Number(this._tempNode.name.replace("pos_node", ""));
        ...
        exchangeTeamMember(selectIndex, changeIndex) {
          var _this = this;

          return _asyncToGenerator(function* () {
            console.log("cocos \u5F53\u524D\u9009\u62E9\u5C06=" + selectIndex + "\u548C" + changeIndex + "\u4E92\u6362");
            var temp = (_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
              error: Error()
            ...
            _this.teamMembersArray[selectIndex - 1].setData(selectIndex - 1);

            _this.teamMembersArray[changeIndex - 1].setData(changeIndex - 1);

            _this.teamMembersArray[selectIndex - 1].node.setPosition(_this.teamPosArr[selectIndex - 1]);

            _this.teamMembersArray[changeIndex - 1].node.setPosition(_this.teamPosArr[changeIndex - 1]);
          })();
        }
        ...
        groupHeroList() {
          ...
          if (heroInfo) {
            var heroList = (_crd && deepClone === void 0 ? (_reportPossibleCrUseOfdeepClone({
              error: Error()
            ...
            if (this._bagVocationType === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              ...
              for (var i = heroList.length - 1; i >= 0; i--) {
                ...
                if (_heroInfo.heroClassTable.HeroClass === (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                  error: Error()
                }), tab) : tab).HeroClass.HeroClass_Warrior) {
                  heroList.splice(i, 1);
                }
            ...
            for (var _i2 = 0; _i2 < heroList.length; _i2 += this._lineHeroCount) {
              result.push(heroList.slice(_i2, _i2 + this._lineHeroCount));
            }
          }
        ...
        switchVocation(event, vocationType) {
          ...
          var heroList = (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
            error: Error()
          }), HeroDataControl) : HeroDataControl).ins.getHeroListByVocation(this._bagVocationType, true);
          (_crd && HeroDataControl === void 0 ? (_reportPossibleCrUseOfHeroDataControl({
            error: Error()
        ...
        onClickTeamToggle(event, curIndex) {
          ...
          if ((_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
            ...
            var _toggle = this.teamToggleArray[(_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
              error: Error()
        ...
        setVocationToggle() {
          for (var i = 0; i < this.vocationToggleNode.children.length; i++) {
            var toggle = this.vocationToggleNode.children[i];
            var vocation = Number(toggle.name.slice(-1));
          ...
          var _toggle = this.vocationToggleNode.getChildByName("Toggle" + this._bagVocationType).getComponent(Toggle);
        ...
        clickWarrorBtn() {
          if ((_crd && FincaFightData === void 0 ? (_reportPossibleCrUseOfFincaFightData({
            ...
            var _toggle = this.teamToggleArray[0].node.getComponent(Toggle);
