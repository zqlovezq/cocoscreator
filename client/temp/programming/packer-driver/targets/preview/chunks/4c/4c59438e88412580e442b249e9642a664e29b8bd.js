      ...
      _export("DropControl", DropControl = (_dec = ccclass('DropControl'), _dec(_class = (_class2 = class DropControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        onFight_Monster_Dead(abs) {
          ...
          if (abs && abs.info) {
            ...
            var pro = (_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
              error: Error()
            }), Random) : Random).getInt10000();

            for (var index = 0; index < this.itemDrops.length; index++) {
              var itemDrop = this.itemDrops[index];
        ...
        addDrop(dropIds, position) {
          for (var i = 0; i < dropIds.length; i++) {
            ...
            var dropTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
              error: Error()
            }), tab) : tab).getData().PveStageDropTableByDropId.getValue(dropId);

            for (var j = 0; j < dropTab.DropItemCount.length; j++) {
              var dropItem = dropTab.DropItem[j];
              var count = dropTab.DropItemCount[j];
        ...
        getLenByType(_type) {
          ...
          for (var index = 0; index < this.rogueDrops.length; index++) {
            var v = this.rogueDrops[index];
            var bo = DropControl.isRogueEggs(v);
        ...
        checkEggsFull() {
          var heroLen = 5 - (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
            error: Error()
        ...
        checkExpUp(position) {
          for (var index = this.expLv; index < this.eggDropGroups.length; index++) {
            var v = this.eggDropGroups[index];
        ...
        fightInitialDrop() {
          ...
          var num = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
            error: Error()
          ...
          var dropIds = [];
          var id = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        initExtraDropData() {
          ...
          var count = (_crd && PlayerControl === void 0 ? (_reportPossibleCrUseOfPlayerControl({
            error: Error()
          }), PlayerControl) : PlayerControl).ins.getGlobleAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          if (count > 0) {
            ...
            if (table) {
              for (var i = 0; i < table.Times.length; i += 2) {
                var min = table.Times[i];
                var max = table.Times[i + 1];
                var r = (_crd && getRandomInt === void 0 ? (_reportPossibleCrUseOfgetRandomInt({
                  error: Error()
