    ...
    execute: function () {
      ...
      _export("DamageCalculation", DamageCalculation = class DamageCalculation {
        ...
        static bullet_damageCalculate(bullet, defanseAbs, damageAmount) {
          ...
          var bulletTab = bullet.info.configTab;
          var attack = bullet.owner.abs;
          var attackAttrData = bullet.owner.getAttrData();
          var defanseAttrData = defanseAbs.info.attrData;
          ...
          var isCritical = (_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
            error: Error()
          }), Random) : Random).isSuccess(this.calculateCritical(attackAttrData, bullet)); //是否暴击

          var isCriticalPoint = (_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
            error: Error()
          ...
          var atk = attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AttrType.AttrType_TotalAttack);
          var deduceDamage = this.calculateDeduceDamage(attackAttrData, defanseAttrData);
          var bulletDamageScale = this.calculatebulletDamageScale(attackAttrData, bullet.info);
          var baseDamage = atk * (1 - deduceDamage) * bulletDamageScale / (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
          ...
          var lossHpPer = Math.floor(baseDamage / defanseAttrData.maxHp * (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
          ...
          var damageData = (_crd && DamageData === void 0 ? (_reportPossibleCrUseOfDamageData({
            error: Error()
          ...
          if (damageAmount == 0) {
            //计算眩晕
            var isVertigo = (_crd && Random === void 0 ? (_reportPossibleCrUseOfRandom({
              error: Error()
            ...
            if (isVertigo) {
              if (attack) {
                ...
                if (this.vertigoBuffTab == null) {
                  var buffTab = (_crd && PowerTabFactory === void 0 ? (_reportPossibleCrUseOfPowerTabFactory({
                    error: Error()
        ...
        static calculatebulletDamageScale(attackAttrData, bulletInfo) {
          var num = bulletInfo.DamageScale * ((_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
          }), FightMacro) : FightMacro).PERCENT + attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        static calculateCritical(attackAttrData, bullet) {
          var num = attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AttrType.AttrType_Critical);
          var bulletAdd = 0;

          for (var index = 0; index < bullet.info.configTab.addEffectTab.length; index++) {
            var v = bullet.info.configTab.addEffectTab[index];
          ...
          var newNum = num * (attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        static calculateCriticalPointPer(attackAttrData, defanseAttrData, attack, defanseAbs) {
          ...
          var aSubb = attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var parm1 = this.x * this.y * aSubb / (this.y * aSubb + this.z) * 100 + attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        static calculateDamageadd(attackAttrData, defanseAttrData, attack, defanseAbs, bullet) {
          var damageAdd = (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
          }), FightMacro) : FightMacro).PERCENT + attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var DamageReduce = defanseAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        static calculateDamageResult(attackAttrData, defanseAttrData, attack, defanseAbs) {
          var DamageResult = attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var DamageResultReduce = defanseAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var num = (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
        ...
        static calculateHpPerDamageAdd(attackAttrData, defanseAttrData, attack, defanseAbs) {
          var targetHpDamageAdd = attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var num = defanseAttrData.hp / defanseAttrData.maxHp * targetHpDamageAdd; // DamageCalculation.print("计算生命比例伤害增加", num, "---", attackAttrData.hp, attackAttrData.maxHp, attackAttrData.getAttr(tab.AttrType.AttrType_TargetHpDamageAdd))
        ...
        static calculateDeduceDamage(attackAttrData, defanseAttrData) {
          var defanse = Math.max((defanseAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var num = defanse / (this.a + this.b * attackAttrData.level + this.c * attackAttrData.star + defanse + attackAttrData.getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
        ...
        static buff_AttackHeal(buff, index, effect) {
          var addHp = buff.addOwner.getAttrData().getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var data = (_crd && DamageData === void 0 ? (_reportPossibleCrUseOfDamageData({
            error: Error()
          }), DamageData) : DamageData).get();
        ...
        static buff_BigHpHeal(buff, index, effect) {
          var data = buff.lockParm;

          if (data == null) {
            var addHp = buff.owner.getAttrData().maxHp * effect.parm / (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
              error: Error()
        ...
        static buff_NowHpSubHeal(buff, index, effect) {
          var data = buff.lockParm;
          var abs = buff.owner.abs; // if (data == null) {

          var nowHp = abs.info.attrData.hp;
          var addHp = nowHp * effect.parm / (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
        ...
        static buff_TearEffect(buff, index, effect) {
          var atk = buff.addOwner.getAttrData().getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AttrType.AttrType_TotalAttack);
          var tearPer = buff.addOwner.getAttrData().getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          var tearAdd = (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
          }), FightMacro) : FightMacro).PERCENT + buff.addOwner.getAttrData().getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).AttrType.AttrType_TearDeep);
          var addHp = atk * tearPer / (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
            error: Error()
        ...
        static buff_BigHpShield(buff, index, effect) {
          ...
          if (data == null) {
            var addHp = buff.owner.getAttrData().maxHp * effect.Parameters[0] / (_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
              error: Error()
            }), FightMacro) : FightMacro).PERCENT * ((_crd && FightMacro === void 0 ? (_reportPossibleCrUseOfFightMacro({
              error: Error()
            }), FightMacro) : FightMacro).PERCENT + buff.owner.getAttrData().getAttr((_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
