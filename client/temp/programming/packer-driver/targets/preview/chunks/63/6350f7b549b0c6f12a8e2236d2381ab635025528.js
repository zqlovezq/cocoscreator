    ...
    execute: function () {
      ...
      _export("MonsterHunt", MonsterHunt = class MonsterHunt {
        ...
        checkAttack() {
          ...
          var lengthSqr = (_crd && Vector2 === void 0 ? (_reportPossibleCrUseOfVector({
            error: Error()
          ...
          var sqr = this.abs.info.attackRange * this.abs.info.attackRange - lengthSqr; //攻击半径
        ...
        onAttack() {
          var nowSkill = this.abs.info.getNowSkill();
