    ...
    execute: function () {
      ...
      _export("PayControl", PayControl = (_dec = ccclass('PayControl'), _dec(_class = (_class2 = class PayControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        requestPay(rechargeId, callback) {
          var voucherNum = (_crd && ItemData === void 0 ? (_reportPossibleCrUseOfItemData({
            error: Error()
          ...
          var price = rechargeTable[(_crd && ChannelMgr === void 0 ? (_reportPossibleCrUseOfChannelMgr({
            error: Error()
          ...
          if (voucherNum >= price) {
            ...
            (_crd && CommonTipsPop === void 0 ? (_reportPossibleCrUseOfCommonTipsPop({
              ...
              if (closeType == (_crd && CommonTipsPopCloseType === void 0 ? (_reportPossibleCrUseOfCommonTipsPopCloseType({
                ...
                _msg.rechargeId = rechargeId;
                (_crd && Net === void 0 ? (_reportPossibleCrUseOfNet({
                  error: Error()
                }), Net) : Net).Send((_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
                  error: Error()
                }), proto) : proto).Ptl.PayByVoucherReq, _msg);
              } else {
                console.log("cancel");
              }
            });
        ...
        on_s2c_DeliverGoodsPush(msg) {
          ...
          if (rechargeTable) {
            ...
            var money = rechargeTable.PriceDollar;
        ...
        on_s2c_StartPayRsp(msg) {
          if (!msg.error || msg.error.code == (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
            ...
            if ((_crd && ChannelMgr === void 0 ? (_reportPossibleCrUseOfChannelMgr({
              ...
              var sedMsg = new (_crd && proto === void 0 ? (_reportPossibleCrUseOfproto({
                error: Error()
              ...
              //SDK支付
              var t_obj = (_crd && RoleData === void 0 ? (_reportPossibleCrUseOfRoleData({
                error: Error()
              ...
              var rechangeTab = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
              }), tab) : tab).getData().RechargeTableById.getValue(msg.rechargeId);
