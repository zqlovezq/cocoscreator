  ...
  return {
    ...
    execute: function () {
      ...
      _export("EquipmentDetailPop", EquipmentDetailPop = (_dec = ccclass('EquipmentDetailPop'), _dec2 = property(Node), _dec3 = property(Label), _dec4 = property(Label), _dec5 = property(Label), _dec6 = property(Node), _dec7 = property(Node), _dec8 = property(Node), _dec9 = property(Label), _dec10 = property(Sprite), _dec11 = property(Node), _dec12 = property(Node), _dec13 = property(Node), _dec14 = property(Node), _dec15 = property(Prefab), _dec(_class = (_class2 = class EquipmentDetailPop extends (_crd && ViewPop === void 0 ? (_reportPossibleCrUseOfViewPop({
        ...
        initAttrItme() {
          var baseAttr = this.euqipInfo.baseAttrInfos;
          var enhanceLv = this.euqipInfo.isWear ? this.euqipInfo.enhanceLv : 0;
          var refineLv = this.euqipInfo.isWear ? this.euqipInfo.refineLv : 0; // let equipAttrInfo=this.euqipInfo.isWear?

          for (var key in baseAttr) {
            var addNum = baseAttr[key].getAddValueByLevel(enhanceLv);
            var item = this.createAttrItem(baseAttr[key], addNum);
            item.parent = this.baseAttrNode;
          }

          var addAttr = this.euqipInfo.extraAttrInfos;
          this.additionNode.active = addAttr.length > 0;

          for (var _key in addAttr) {
            var _addNum = addAttr[_key].getAddValueByLevel(refineLv);

            var _item = this.createAttrItem(addAttr[_key], _addNum);

            _item.parent = this.addAttrNode;
          }
        }

        createAttrItem(attr, addNum) {
          if (addNum === void 0) {
            addNum = 0;
          }
