  ...
  return {
    ...
    execute: function () {
      ...
      _export("EveryDayChallengeView", EveryDayChallengeView = (_dec = ccclass('EveryDayChallengeView'), _dec2 = property(Label), _dec3 = property(RichText), _dec4 = property(Label), _dec5 = property(Node), _dec6 = property(Label), _dec7 = property([Node]), _dec8 = property(Node), _dec9 = property(Node), _dec10 = property(Node), _dec11 = property(Node), _dec12 = property(Label), _dec13 = property([_crd && EveryDayChallengeBoxItem === void 0 ? (_reportPossibleCrUseOfEveryDayChallengeBoxItem({
        ...
        initBoxItem() {
          var currScore = this.totalScore;
          this.scoreLab.string = currScore + "";
          var receivedScore = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
          }), GameplayViewDataMgr) : GameplayViewDataMgr).ins.dailyChallengeDataMsg.receivedScore;
          var requires = this.table.Require;

          for (var i = 0; i < requires.length; i++) {
            var dropId = this.table.DropId[i];
        ...
        initDownBtn() {
          if (this.table.IsEasier) {
            ...
            var cd = Number((_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
              error: Error()
        ...
        updateBtnState() {
          var maxNum = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          }), tab) : tab).getData().GetKeyValue_ConfigTable().DailyChallengeCount;
          var totalNum = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
            error: Error()
          ...
          if (totalNum >= maxNum) {
            ...
            this.maxScoreNode.active = false;
            this.sweepBtnNode.active = false;
            var lastTimer = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
              error: Error()
            ...
            var maxScore = (_crd && GameplayViewDataMgr === void 0 ? (_reportPossibleCrUseOfGameplayViewDataMgr({
              error: Error()
        ...
        onClickUpBtn() {
          var nextTable = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
            error: Error()
          ...
          if (nextTable) {
            if ((_crd && BattleMainDataControl === void 0 ? (_reportPossibleCrUseOfBattleMainDataControl({
              ...
              var chapter = (_crd && tab === void 0 ? (_reportPossibleCrUseOftab({
                error: Error()
