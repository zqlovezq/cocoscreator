    ...
    execute: function () {
      ...
      _export("AbsRole", AbsRole = (_dec = ccclass('AbsRole'), _dec(_class = class AbsRole extends (_crd && AbsObj === void 0 ? (_reportPossibleCrUseOfAbsObj({
        ...
        updateFrame(dt) {
          ...
          for (var index = this.damageTicks.length - 1; index >= 0; index--) {
            var v = this.damageTicks[index];
        ...
        getAvatarSpineBonePos(boneName) {
          var bone = this.getBonePos(boneName);
        ...
        addDamageTick(bulletSoleId, time) {
          var tick = new (_crd && DamageTick === void 0 ? (_reportPossibleCrUseOfDamageTick({
            error: Error()
        ...
        checkDamageTick(bulletSoleId) {
          for (var index = 0; index < this.damageTicks.length; index++) {
            var v = this.damageTicks[index];
