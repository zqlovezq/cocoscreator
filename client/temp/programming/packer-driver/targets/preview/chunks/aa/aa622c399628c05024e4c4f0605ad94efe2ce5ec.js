    ...
    execute: function () {
      ...
      _export("FrameControl", FrameControl = (_dec = ccclass('FrameControl'), _dec(_class = (_class2 = class FrameControl extends (_crd && AbsControl === void 0 ? (_reportPossibleCrUseOfAbsControl({
        ...
        init() {
          ...
          for (var key in _crd && AbsObjType === void 0 ? (_reportPossibleCrUseOfAbsObjType({
            error: Error()
        ...
        onDeal_clear_bullet(abs) {
          //刷新下子弹来源死亡
          var objList = this.getObjList((_crd && AbsObjType === void 0 ? (_reportPossibleCrUseOfAbsObjType({
            error: Error()
        ...
        removeCollisionInterval(abs) {
          if (abs.isCollisionInterval()) {
            var objList = this.intervalColliderAbss;
            var len = objList.length;
        ...
        isAllDeadByObjType(absType) {
          var list = this.getObjList(absType);
          var len = list.length;
