System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2", "__unresolved_3"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, game, Label, native, ProgressBar, Global, Func, ChannelMgr, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, UpdateView;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'assetManager', 'BlockInputEvents', 'Button', 'Color', 'Component', 'director', 'game', 'instantiate', 'Label', 'Layers', 'native', 'Node', 'path', 'Prefab', 'ProgressBar', 'ResolutionPolicy', 'Sprite', 'tween', 'UITransform', 'Vec3', 'view']);
      ...
      _export("UpdateView", UpdateView = (_dec = ccclass('UpdateView'), _dec2 = property(ProgressBar), _dec3 = property(Label), _dec4 = property(Label), _dec(_class = (_class2 = class UpdateView extends Component {
        ...
        loadUpdate() {
          var paths = native.fileUtils.getSearchPaths();
          ...
          console.log("当前搜索路径", paths); // // Setup your own version compare handler, versionA and B is versions in string
          ...
          switch (event.getEventCode()) {
            ...
            case native.EventAssetsManager.NEW_VERSION_FOUND:
              ...
              (_crd && ChannelMgr === void 0 ? (_reportPossibleCrUseOfChannelMgr({
                error: Error()
              }), ChannelMgr) : ChannelMgr).gameHotfixStart();
              this.showBar(true);
        ...
        updateCb(event) {
          ...
          switch (event.getEventCode()) {
            ...
            case native.EventAssetsManager.UPDATE_PROGRESSION:
              // //更新中
              this.setProgress((_crd && Func === void 0 ? (_reportPossibleCrUseOfFunc({
                error: Error()
              }), Func) : Func).checkInt(event.getPercent()));
              break;
            ...
            case native.EventAssetsManager.UPDATE_FINISHED:
              ...
              (_crd && ChannelMgr === void 0 ? (_reportPossibleCrUseOfChannelMgr({
                error: Error()
              }), ChannelMgr) : ChannelMgr).gameHotfixSuccess();
              break;
...
//# sourceMappingURL=6bb1a74e6fc01854885ef698985fd4de111e0f2b.js.map